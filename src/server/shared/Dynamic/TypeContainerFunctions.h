...
namespace JadeCore
{
    ...
    // non-const insert_nearby functions
    template<class SPECIFIC_TYPE> SPECIFIC_TYPE* Insert_Nearby(ContainerMapList<SPECIFIC_TYPE> &elements, SPECIFIC_TYPE *obj)
    {
        //elements._element[hdl] = obj;
        obj->AddNearbyToGrid(elements._element);
        return obj;
    }

    template<class SPECIFIC_TYPE> SPECIFIC_TYPE* Insert_Nearby(ContainerMapList<TypeNull> &/*elements*/, SPECIFIC_TYPE * /*obj*/)
    {
        return NULL;
    }

    // this is a missed
    template<class SPECIFIC_TYPE, class T> SPECIFIC_TYPE* Insert_Nearby(ContainerMapList<T> &/*elements*/, SPECIFIC_TYPE * /*obj*/)
    {
        return NULL;                                        // a missed
    }

    // Recursion
    template<class SPECIFIC_TYPE, class H, class T> SPECIFIC_TYPE* Insert_Nearby(ContainerMapList<TypeList<H, T> >&elements, SPECIFIC_TYPE *obj)
    {
        SPECIFIC_TYPE* t = Insert_Nearby(elements._nearbyElements, obj);
        return (t != NULL ? t : Insert_Nearby(elements._TailElements, obj));
    }

    // non-const remove nearby method
    template<class SPECIFIC_TYPE> SPECIFIC_TYPE* Remove_Nearby(ContainerMapList<SPECIFIC_TYPE> & /*elements*/, SPECIFIC_TYPE *obj)
    {
        obj->RemoveNearbyFromGrid();
        return obj;
    }

    template<class SPECIFIC_TYPE> SPECIFIC_TYPE* Remove_Nearby(ContainerMapList<TypeNull> &/*elements*/, SPECIFIC_TYPE * /*obj*/)
    {
        return NULL;
    }

    // this is a missed
    template<class SPECIFIC_TYPE, class T> SPECIFIC_TYPE* Remove_Nearby(ContainerMapList<T> &/*elements*/, SPECIFIC_TYPE * /*obj*/)
    {
        return NULL;                                        // a missed
    }

    template<class SPECIFIC_TYPE, class T, class H> SPECIFIC_TYPE* Remove_Nearby(ContainerMapList<TypeList<H, T> > &elements, SPECIFIC_TYPE *obj)
    {
        // The head element is bad
        SPECIFIC_TYPE* t = Remove_Nearby(elements._nearbyElements, obj);
        return ( t != NULL ? t : Remove_Nearby(elements._TailElements, obj) );
    }
}
#endif
