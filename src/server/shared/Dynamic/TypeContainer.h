...
template<class H, class T> struct ContainerMapList<TypeList<H, T> >
{
    ...
    ContainerMapList<H> _nearbyElements;
...
class TypeMapContainer
{
    public:
        ...
        /// inserts a specific object into the container of nearby objects
        template<class SPECIFIC_TYPE> bool insert_nearby(SPECIFIC_TYPE *obj)
        {
            SPECIFIC_TYPE* t = JadeCore::Insert_Nearby(i_elements, obj);
            return (t != NULL);
        }

        template<class SPECIFIC_TYPE> bool remove_nearby(SPECIFIC_TYPE* obj)
        {
            SPECIFIC_TYPE* t = JadeCore::Remove_Nearby(i_elements, obj);
            return (t != NULL);
        }
