...
class ByteBuffer
{
    public:
        ...
        void readGUID128(Guid128& p_Guid)
        {
            if (rpos() + 1 > size())
                throw ByteBufferPositionException(false, _rpos, 1, size());
            ...
            p_Guid = Guid128(l_GuidLow, l_GuidHi);
        }
        ...
        void appendGuid128(Guid128 p_Guid)
        {
            uint32 l_StartWPos = wpos();
            ...
            uint64 l_GuidLow = p_Guid.GetLow();
            uint64 l_GuidHi = p_Guid.GetHi();
    ...
    public:
        ...
        */
        ...
        void AppendInt24(uint32 p_Value)
        {
            append(&p_Value, 3);
        }
