...
enum HighGuid
{
    ...
    HIGHGUID_EVENTOBJECT        = 0x203,
    HIGHGUID_SCENARIO           = 0x204,
...
inline char const* GetLogNameForGuid(uint64 guid)
{
    switch (GUID_HIPART(guid))
    {
        ...
        case HIGHGUID_EVENTOBJECT:  return "eventobject";
        default:
            return "<unknown>";
    }
}
...
{
    GUID_TYPE_NONE                  = 0x00,
    GUID_TYPE_UNIQUE                = 0x01, ///< source : TC
    GUID_TYPE_PLAYER                = 0x02, ///< 7.0.1 20756
    GUID_TYPE_ITEM                  = 0x03, ///< 7.0.1 20756
    GUID_TYPE_CONTAINER             = 0x03, ///< 7.0.1 20756
    GUID_TYPE_STATIC_DOOR           = 0x04, ///< 7.0.1 20756
    GUID_TYPE_WORLD_TRANSACTION     = 0x05, ///< 7.0.1 20756
    GUID_TYPE_MO_TRANSPORT          = 0x06, ///< 7.0.1 20756
    GUID_TYPE_CONVERSATION          = 0x07, ///< 7.0.1 20756
    GUID_TYPE_UNIT                  = 0x08, ///< 7.0.1 20756
    GUID_TYPE_VEHICLE               = 0x09, ///< 7.0.1 20756
    GUID_TYPE_PET                   = 0x0A, ///< 7.0.1 20756
    GUID_TYPE_GAMEOBJECT            = 0x0B, ///< 7.0.1 20756
    GUID_TYPE_DYNAMIC_OBJECT        = 0x0C, ///< 7.0.1 20756
    GUID_TYPE_AREATRIGGER           = 0x0D, ///< 7.0.1 20756
    GUID_TYPE_CORPSE                = 0x0E, ///< 7.0.1 20756
    GUID_TYPE_LOOT                  = 0x0F, ///< 7.0.1 20756
    GUID_TYPE_SCENE_OBJECT          = 0x10, ///< 7.0.1 20756
    GUID_TYPE_SCENARIO              = 0x11, ///< 7.0.1 20756
    GUID_TYPE_AI_GROUP              = 0x12, ///< 7.0.1 20756
    GUID_TYPE_DYNAMIC_DOOR          = 0x13, ///< 7.0.1 20756
    GUID_TYPE_CLIENT_ACTOR          = 0x14, ///< 7.0.1 20756
    GUID_TYPE_VIGNETTE              = 0x15, ///< 7.0.1 20756
    GUID_TYPE_CALL_FOR_HELP         = 0x16, ///< 7.0.1 20756
    GUID_TYPE_AI_RESOURCE           = 0x17, ///< 7.0.1 20756
    GUID_TYPE_AI_LOCK               = 0x18, ///< 7.0.1 20756
    GUID_TYPE_AI_LOCK_TICKET        = 0x19, ///< 7.0.1 20756
    GUID_TYPE_CHAT_CHANNEL          = 0x1A, ///< 7.0.1 20756
    GUID_TYPE_GROUP                 = 0x1B, ///< 7.0.1 20756
    GUID_TYPE_GUILD                 = 0x1C, ///< 7.0.1 20756
    GUID_TYPE_WOW_ACC               = 0x1D, ///< 7.0.1 20756
    GUID_TYPE_BNET_ACC              = 0x1E, ///< 7.0.1 20756
    GUID_TYPE_GM_TASK               = 0x1F, ///< 7.0.1 20756
    GUID_TYPE_MOBILE_SESSION        = 0x20, ///< 7.0.1 20756
    GUID_TYPE_RAID_GROUP            = 0x21, ///< 7.0.1 20756
    GUID_TYPE_SPELL                 = 0x22, ///< 7.0.1 20756
    GUID_TYPE_MAIL                  = 0x23, ///< 7.0.1 20756
    GUID_TYPE_WEB_OBJ               = 0x24, ///< 7.0.1 20756
    GUID_TYPE_LFG_OBJECT            = 0x25, ///< 7.0.1 20756
    GUID_TYPE_LFG_LIST              = 0x26, ///< 7.0.1 20756
    GUID_TYPE_USER_ROUTER           = 0x27, ///< 7.0.1 20756
    GUID_TYPE_PVP_QUEUE_GROUP       = 0x28, ///< 7.0.1 20756
    GUID_TYPE_USER_CLIENT           = 0x29, ///< 7.0.1 20756
    GUID_TYPE_PET_BATTLE            = 0x2A, ///< 7.0.1 20756
    GUID_TYPE_UNIQUE_USER_CLIENT    = 0x2B, ///< 7.0.1 20756
    GUID_TYPE_BATTLE_PET            = 0x2C, ///< 7.0.1 20756
    GUID_TYPE_COMMERCE_OBJECT       = 0x2D, ///< 7.0.1 20756
    GUID_TYPE_CLIENT_SESSION        = 0x2E, ///< 7.0.1 20756
    GUID_TYPE_CAST                  = 0x2F, ///< 7.0.1 20756
    GUID_TYPE_TRANSPORT         , ///< unk
    GUID_TYPE_BATTLEGROUND      , ///< unk
    GUID_TYPE_INSTANCE_SAVE     , ///< unk
};
