...
namespace ItemInstanceField
{
    enum
    {
        ...
        ChallengeKeystoneAffix1,
        ChallengeKeystoneAffix2,
        ChallengeKeystoneAffix3,
        ChallengeKeystoneIsCharged,
        ArtifactTier,
        Durability,
        PlayedTime,
        Text,
        ...
        BagFlags,
        AcquiredLevel,
        ModifiedAppearanceAllSpecs,
        ModifiedAppearanceSpec1,
        ModifiedAppearanceSpec2,
        ModifiedAppearanceSpec3,
        ModifiedAppearanceSpec4,
        SpellEnchantmentAllSpecs,
        SpellEnchantmentSpec1,
        SpellEnchantmentSpec2,
        SpellEnchantmentSpec3,
        SpellEnchantmentSpec4,
        GemItemId1,
        GemBonuses1,
        GemContext1,
        gemScalingLevel1,
...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_DEL_QUEST_STATUS_BY_QUEST_ID,
    CHAR_DEL_PVP_INFO,
    CHAR_SEL_PVP_INFO,
    CHAR_INS_PVP_INFO,
    ...
    CHAR_SEL_CHARACTER_ITEMS_WITHOUT_INVENTORY,
    ...
    CHAR_SEL_CHARACTER_BRACKET_DATA,
    ...
    CHAR_SEL_CHARACTER_QUESTSTATUSREW_COUNT,
    ...
    CHAR_UPD_ITEM_INSTANCE_BONUSES,
    ...
    CHAR_SEL_NOMI_RECIPES,
    CHAR_SEL_PLAYERCHOICE_RESPONSE_REWARDED,
    CHAR_INS_PLAYERCHOICE_RESPONSE_REWARDED,
    ...
    CHAR_SEL_GUILD_BANK_EVENT,
    CHAR_SEL_GUILD_BANK_TAB,
    ...
    CHAR_SEL_PLAYER_CURRENCY_CAPS,
    CHAR_REP_PLAYER_CURRENCY_CAPS,
    ...
    CHAR_INS_CHARACTER_BRACKET_DATA,
    CHAR_DEL_CHARACTER_BRACKET_DATA,
    ...
    CHAR_LOAD_ARTIFACT_POWERS,
    CHAR_INS_ARTIFACT_POWER,
    CHAR_DEL_ARTIFACT_POWERS,

    CHAR_LOAD_PVP_TALENTS,
    CHAR_DEL_PVP_TALENTS,
    ...
    CHAR_UPD_GARRISON,
    CHAR_DEL_GARRISON,
    CHAR_GARRISON_RESET_DAILY_MISSIONS,
    ...
    CHAR_INS_GARRISON_TALENT,
    CHAR_SEL_GARRISON_TALENT,
    CHAR_UPD_GARRISON_TALENT,
    CHAR_DEL_GARRISON_TALENT,
    CHAR_DEL_GARRISON_TALENTS,

    //////////////////////////////////////////////////////////////////////////

    CHAR_INS_GARRISON_DRAENOR,
    CHAR_SEL_GARRISON_DRAENOR,
    CHAR_UPD_GARRISON_DRAENOR,
    CHAR_DEL_GARRISON_DRAENOR,

    CHAR_INS_GARRISON_DRAENOR_BUILDING,
    CHAR_SEL_GARRISON_DRAENOR_BUILDING,
    CHAR_UPD_GARRISON_DRAENOR_BUILDING,
    CHAR_DEL_GARRISON_DRAENOR_BUILDING,
    CHAR_DEL_GARRISON_DRAENOR_BUILDINGS,

    CHAR_DEL_GARRISON_DRAENOR_DAILY_TAVERN_DATA,
    CHAR_DEL_GARRISON_DRAENOR_DAILY_TAVERN_DATA_CHAR,
    CHAR_SEL_GARRISON_DRAENOR_DAILY_TAVERN_DATA_CHAR,
    CHAR_ADD_GARRISON_DRAENOR_DAILY_TAVERN_DATA_CHAR,

    CHAR_DEL_GARRISON_DRAENOR_WEEKLY_TAVERN_DATA,
    CHAR_DEL_GARRISON_DRAENOR_WEEKLY_TAVERN_DATA_CHAR,
    CHAR_SEL_GARRISON_DRAENOR_WEEKLY_TAVERN_DATA_CHAR,
    CHAR_ADD_GARRISON_DRAENOR_WEEKLY_TAVERN_DATA_CHAR,

    //////////////////////////////////////////////////////////////////////////

    CHAR_INS_GARRISON_BROKEN_ISLES,
    CHAR_SEL_GARRISON_BROKEN_ISLES,
    CHAR_UPD_GARRISON_BROKEN_ISLES,
    CHAR_DEL_GARRISON_BROKEN_ISLES,
    ...
    /// Encounter logs
    //////////////////////////////////////////////////////////////////////////
    CHAR_INS_GUILD_ENCOUNTER_DATA,
    CHAR_INS_GUILD_ENCOUNTER_ROSTER,
    //////////////////////////////////////////////////////////////////////////
    ...
    CHAR_DEL_INVALID_GUILD_ACHIEVMENT,
    CHAR_SEL_CHARACTER_ACHIEVEMENTS,
    CHAR_SEL_CHARACTER_ACHIEVEMENTS_COUNT,
    ...
    CHAR_SEL_CHAR_ACHIEVEMENT_COUNT,
    CHAR_REP_CHAR_ACHIEVEMENT_COUNT,
    ...
    CHAR_DEL_PERSONAL_INSTANCE_LOCKOUTS,
    CHAR_SEL_PERSONAL_INSTANCE_LOCKOUTS,
    CHAR_INS_PERSONAL_INSTANCE_LOCKOUT,
    ...
    CHAR_INS_EASTER_EVENT,
    CHAR_SEL_EASTER_EVENT,

    //////////////////////////////////////////////////////////////////////////
    /// World Quests
    CHAR_SEL_CHARACTER_WORLD_QUEST_REWARDS,
    CHAR_DEL_CHARACTER_WORLD_QUEST_REWARDS,
    CHAR_DEL_CHARACTER_WORLD_QUEST_REWARDS_BY_QUEST_ID,

    CHAR_SEL_WORLD_QUESTS,
    ...
    CHAR_SEL_LEGENDARIES,
    CHAR_REP_LEGENDARIES,

    CHAR_REP_NOMI_RECIPES,

    CHAR_INS_OR_UPD_CHARACTER_SELL_DATA,

    CHAR_SEL_MAP_EVENTS,
    CHAR_UPD_MAP_EVENTS,

    CHAR_SEL_CONTRIBUTIONS,
    CHAR_UPD_CONTRIBUTIONS,

    CHAR_DEL_CHARACTER_REP_MODS,
    CHAR_SEL_CHARACTER_REP_MODS,
    CHAR_REP_CHARACTER_REP_MODS,

    CHAR_SEL_PVP_SEASON_REWARD_RANKING,
    CHAR_UPD_PVP_SEASON_REWARD_RANKING_REWARDED,

    CHAR_SEL_CHEST_TIMED_LOCKOUT,
    CHAR_REP_CHEST_TIMED_LOCKOUT,
    CHAR_DEL_CHEST_TIMED_LOCKOUT,

    CHAR_SEL_ELIGIBLE_CHAR_FOR_DECAY_2S,
    CHAR_SEL_ELIGIBLE_CHAR_FOR_DECAY_3S,

    CHAR_UPD_ELIGIBLE_CHAR_FOR_DECAY_2S,
    CHAR_UPD_ELIGIBLE_CHAR_FOR_DECAY_3S,

    CHAR_SEL_ITEM_RELIC_DATA,
    CHAR_REP_ITEM_RELIC_DATA,

    CHAR_SEL_CORPSE_LOCATION,

    CHAR_REP_INSTANCE_GO_LOOTED,
    CHAR_SEL_INSTANCE_GO_LOOTED,
    CHAR_DEL_INSTANCE_GO_LOOTED,

    CHAR_SEL_OBJECT_LOCKOUT,
    CHAR_REP_OBJECT_LOCKOUT,
    CHAR_DEL_OBJECT_LOCKOUT,
...
public:
    ...
    CharacterDatabaseConnection(moodycamel::ConcurrentQueue<SQLOperation*>* q, MySQLConnectionInfo& connInfo) : MySQLConnection(q, connInfo) {}
