...
public:
    ...
    HotfixDatabaseConnection(moodycamel::ConcurrentQueue<SQLOperation*>* p_Queue, MySQLConnectionInfo& p_ConnectionInfo) : MySQLConnection(p_Queue, p_ConnectionInfo) { }
