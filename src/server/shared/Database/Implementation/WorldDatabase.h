...
enum WorldDatabaseStatements
{
    ...
    */
    ...
    WORLD_SEL_CREATURE_TEMPLATE_WDB,
    ...
    WORLD_SEL_WORLD_QUEST_TEMPLATE,
    WORLD_SEL_WORLD_QUEST_LOOT,
    WORLD_SEL_WORLD_QUEST_LOOT_GROUP,

    WORLD_DEL_EVENTOBJECT,
    WORLD_INS_EVENTOBJECT,
    WORLD_SEL_EVENTOBJECT_NEAREST,

    WORLD_SEL_SPELL_SCRIPTING,
    WORLD_SEL_AURA_SCRIPTS,
    WORLD_DEL_SPELL_SCRIPTING,
    WORLD_DEL_AURA_SCRIPTS,

    WORLD_SEL_RAF_REWARDS,
    WORLD_SEL_RAF_REWARDS_LOCALE,

    WORLD_UPD_CREATURE_UPPER_LINKED_ID,
    WORLD_UPD_GAME_EVENT_CREATURE_UPPER_LINKED_ID,
    WORLD_UPD_POOL_CREATURE_UPPER_LINKED_ID,
    WORLD_UPD_CREATURE_ADDON_UPPER_LINKED_ID,
    WORLD_UPD_CREATURE_FORMATION_UPPER_LINKED_ID,
    WORLD_UPD_SMART_SCRIPT_UPPER_LINKED_ID,
...
public:
    ...
    WorldDatabaseConnection(moodycamel::ConcurrentQueue<SQLOperation*>* q, MySQLConnectionInfo& connInfo) : MySQLConnection(q, connInfo) {}
