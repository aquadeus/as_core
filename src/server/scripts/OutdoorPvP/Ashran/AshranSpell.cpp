...
class spell_ashran_earth_smash : public SpellScriptLoader
{
    public:
        ...
        class spell_ashran_earth_smash_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_ashran_earth_smash_SpellScript::CorrectTargets, EFFECT_0, TARGET_UNIT_ENEMY_BETWEEN_DEST);
            }
        };
...
class spell_ashran_ancient_artifact : public SpellScriptLoader
{
    public:
        ...
        class spell_ashran_ancient_artifact_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_ashran_ancient_artifact_AuraScript::OnRemove, EFFECT_4, SPELL_AURA_BATTLEGROUND_FLAG_2, AURA_EFFECT_HANDLE_REAL);
            }
        };
