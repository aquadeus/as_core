...
class boss_kaelthas : public CreatureScript
{
    public:
        ...
        struct boss_kaelthasAI : public ScriptedAI
        {
            ...
            bool IsTestServer = sWorld->getBoolConfig(CONFIG_IS_TEST_SERVER);
            ...
            void StartEvent()
            {
                ...
                else
                {
                    ...
                    PhaseSubphase = 0;
                    Phase_Timer = IsTestServer ? 5000 : 23000;
                    Phase = 1;
                }
            }
                ...
                switch (Phase)
                {
                        ...
                        switch (PhaseSubphase)
                        {
                            ...
                            case 0:
                                if (Phase_Timer <= diff)
                                {
                                    ...
                                    Phase_Timer = IsTestServer ? 2000 : 7000;
                                    ++PhaseSubphase;
                            ...
                            case 2:
                                ...
                                if (Advisor && (Advisor->getStandState() == UNIT_STAND_STATE_DEAD))
                                {
                                    ...
                                    Phase_Timer = IsTestServer ? 2000 : 12500;
                                    ++PhaseSubphase;
                                }
                                break;
                            ...
                            case 6:
                                ...
                                if (Advisor && (Advisor->getStandState() == UNIT_STAND_STATE_DEAD))
                                {
                                    ...
                                    Phase_Timer = IsTestServer ? 2000 : 8400;
                                    ++PhaseSubphase;
                                }
                                break;
                    ...
                    case 2:
                    {
                        ...
                        if (PhaseSubphase == 1)
                        {
                            ...
                            PhaseSubphase = 2;
                            Phase_Timer = IsTestServer ? 5000 : TIME_PHASE_2_3;
                        }
                    ...
                    case 3:
                    {
                        if (PhaseSubphase == 0)
                        {
                            ...
                            PhaseSubphase = 1;
                            Phase_Timer = IsTestServer ? 5000 : TIME_PHASE_3_4;
                        }
                        ...
                        if (Phase_Timer <= diff)
                        {
                            ...
                            Phase_Timer = IsTestServer ? 10000 : 30000;
                        }
                        else
                            Phase_Timer -= diff;
                    }
                                    ...
                                    case 1:
                                        ...
                                        for (i = me->getThreatManager().getThreatList().begin(); i != me->getThreatManager().getThreatList().end(); ++i)
                                        {
                                            if (Unit* unit = Unit::GetUnit(*me, (*i)->getUnitGuid()))
                                            {
                                                ...
                                                unit->AddDelayedEvent([_unit = unit]() -> void { _unit->SetDisableGravity(true); _unit->SetCanFly(true, true); }, 2000);
                                            }
                                        }
    ...
    public:
        ...
        struct mob_phoenix_egg_tkAI : public ScriptedAI
        {
            ...
            void JustSummoned(Creature* summoned)
            {
                ...
                {
                    summoned->AddThreat(l_Victim, 0.0f);
