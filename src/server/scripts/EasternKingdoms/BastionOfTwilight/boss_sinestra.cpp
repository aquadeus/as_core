                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_SUMMON_ORB:
                        {
                            ...
                            JadeCore::RandomResizeList<std::list<Unit*>>(targetList, 2);
...
class spell_sinestra_wrack: public SpellScriptLoader
{
    public:
        ...
        class spell_sinestra_wrack_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_sinestra_wrack_AuraScript::OnRemove, EFFECT_1, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_sinestra_twilight_extinction: public SpellScriptLoader
{
    public:
        ...
        class spell_sinestra_twilight_extinction_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_sinestra_twilight_extinction_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_MOD_DAMAGE_PERCENT_TAKEN, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_sinestra_indomitable_aura: public SpellScriptLoader
{
    public:
        ...
        class spell_sinestra_indomitable_aura_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectRemoveFn(spell_sinestra_indomitable_aura_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_MECHANIC_IMMUNITY_MASK, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove += AuraEffectRemoveFn(spell_sinestra_indomitable_aura_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_MECHANIC_IMMUNITY_MASK, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_sinestra_twilight_essence: public SpellScriptLoader
{
    public:
        ...
        class spell_sinestra_twilight_essence_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_sinestra_twilight_essence_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
