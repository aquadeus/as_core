...
class spell_terrastra_harden_skin: public SpellScriptLoader
{
    public:
        ...
        class spell_terrastra_harden_skin_AuraScript : public AuraScript
        {
            ...
            {
                dmgInfo.ModifyAmount(-(int32)(dmgInfo.GetAmount()/2));
            }
            
            void Register()
            {
                AfterEffectRemove += AuraEffectApplyFn(spell_terrastra_harden_skin_AuraScript::OnRemove, EFFECT_1, SPELL_AURA_SCHOOL_ABSORB, AURA_EFFECT_HANDLE_REAL);
...
class spell_elemental_statis: public SpellScriptLoader
{
    public:
        ...
        class spell_elemental_statis_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_elemental_statis_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
            }
        };
