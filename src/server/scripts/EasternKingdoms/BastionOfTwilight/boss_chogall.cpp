...
class npc_chogall_blood_of_the_old_god : public CreatureScript
{
    public:
        ...
        struct npc_chogall_blood_of_the_old_godAI : public ScriptedAI
        {
            ...
            void DamageDealt(Unit* victim, uint32& /*damage*/, DamageEffectType type, SpellInfo const* /*p_SpellInfo*/)
            {
    ...
    public:
        ...
        class spell_chogall_worshipping_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_chogall_worshipping_AuraScript::OnRemove, EFFECT_1, SPELL_AURA_MOD_FACTION, AURA_EFFECT_HANDLE_REAL);
