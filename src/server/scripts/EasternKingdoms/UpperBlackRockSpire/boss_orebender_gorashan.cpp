...
{
    { 164.569473f, -278.615875f, 94.607742f, float(M_PI)     },  ///< DATA_POS_NE
    { 124.726387f, -239.007599f, 94.607742f, 2 * float(M_PI) }   ///< DATA_POS_SW
};

Position const g_LightningFieldMovePos[4] =
{
    { 164.569473f, -278.615875f, 94.607742f, float(M_PI)                      },  ///< DATA_POS_NE
    { 124.726387f, -278.615875f, 94.607742f, float(M_PI) / 2.0f               },  ///< DATA_POS_SE
    { 124.726387f, -239.007599f, 94.607742f, 0.0f                             },  ///< DATA_POS_SW
    { 164.569473f, -239.007599f, 94.607742f, float(M_PI) + float(M_PI) / 2.0f }   ///< DATA_POS_NW
};
