...
static Position const g_FireStalkerMovePos = { 38.162f, -406.093f, 110.723f, float(M_PI) };
...
class mob_ragewing_whelp : public CreatureScript
{
    public:
        ...
        struct mob_ragewing_whelpAI : public ScriptedAI
        {
            ...
            void DamageDealt(Unit* /*p_Attacker*/, uint32& /*p_Damage*/, DamageEffectType /*p_DamageType*/, SpellInfo const* /*p_SpellInfo*/)
            {
                if (!m_Ground)
                {
                    m_Ground = true;
