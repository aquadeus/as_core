...
class spell_akilzon_electrical_storm: public SpellScriptLoader
{
    public:
        ...
        class spell_akilzon_electrical_storm_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_akilzon_electrical_storm_AuraScript::AfterApply, EFFECT_1, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove += AuraEffectRemoveFn(spell_akilzon_electrical_storm_AuraScript::AfterRemove, EFFECT_1, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            }
        };
