...
public:
    ...
    struct boss_grubbisAI : public BossAI
    {
        boss_grubbisAI(Creature* creature) : BossAI(creature, DATA_GRUBBIS)
        {
        ...
        {
            if (m_Instance)
                m_Instance->SetBossState(DATA_GRUBBIS, IN_PROGRESS);
        }

        void EnterEvadeMode() override
        {
            if (m_Instance)
                m_Instance->SetBossState(DATA_GRUBBIS, FAIL);
