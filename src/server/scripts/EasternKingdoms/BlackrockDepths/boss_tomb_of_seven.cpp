    ...
    struct boss_doomrelAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            if (instance)
            {
                ...
                instance->SetBossState(DATA_TOMB_OF_SEVEN, NOT_STARTED);
            }
        }
        ...
        {
            if (instance)
                instance->SetBossState(DATA_TOMB_OF_SEVEN, IN_PROGRESS);
        }
        ...
        void EnterEvadeMode()
        {
            ...
            if (instance)
            {
                ...
                instance->SetBossState(DATA_TOMB_OF_SEVEN, FAIL);
            }
        }
        ...
        void JustDied(Unit* /*killer*/)
        {
            if (instance)
            {
                ...
                instance->SetBossState(DATA_TOMB_OF_SEVEN, DONE);
            }
        }
