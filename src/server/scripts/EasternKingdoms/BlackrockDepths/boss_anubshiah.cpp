...
public:
    ...
    struct boss_anubshiahAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_ANUBSHIAH, NOT_STARTED);
        }

        void EnterCombat(Unit* /*who*/) override
        {
            if (m_Instance)
                m_Instance->SetBossState(DATA_ANUBSHIAH, IN_PROGRESS);
        }

        void EnterEvadeMode() override
        {
            if (m_Instance)
                m_Instance->SetBossState(DATA_ANUBSHIAH, FAIL);
        ...
        {
            if (m_Instance)
                m_Instance->SetBossState(DATA_ANUBSHIAH, DONE);
        }
