...
struct boss_priestess_lackey_commonAI : public ScriptedAI
{
    ...
    void Reset()
    {
        ...
        if (instance)
        {
            ...
            if (Creature* pDelrissa = Unit::GetCreature(*me, instance->GetData64(DATA_DELRISSA_GUID)))
            {
    ...
    void JustDied(Unit* /*killer*/)
    {
        ...
        Creature* pDelrissa = Unit::GetCreature(*me, instance->GetData64(DATA_DELRISSA_GUID));
    ...
    void KilledUnit(Unit* victim)
    {
        ...
        if (Creature* Delrissa = Unit::GetCreature(*me, instance->GetData64(DATA_DELRISSA_GUID)))
