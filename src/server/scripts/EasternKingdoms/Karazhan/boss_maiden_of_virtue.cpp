...
public:
    ...
    struct boss_maiden_of_virtueAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_MAIDEN_OF_VIRTUE, NOT_STARTED);
        }
        ...
        void JustDied(Unit* /*killer*/)
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_MAIDEN_OF_VIRTUE, DONE);
        }
        ...
        void EnterCombat(Unit* /*who*/)
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_MAIDEN_OF_VIRTUE, IN_PROGRESS);
        }
