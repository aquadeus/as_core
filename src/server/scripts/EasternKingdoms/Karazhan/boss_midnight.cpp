...
public:
    ...
    struct boss_attumenAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_MIDNIGHT, NOT_STARTED);
        }
        ...
        void EnterEvadeMode()
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_MIDNIGHT, FAIL);
        }

        void EnterCombat(Unit* /*who*/)
        {
            if (m_Instance)
                m_Instance->SetBossState(DATA_MIDNIGHT, IN_PROGRESS);
        }
        ...
        void JustDied(Unit* /*killer*/)
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_MIDNIGHT, DONE);
        }
