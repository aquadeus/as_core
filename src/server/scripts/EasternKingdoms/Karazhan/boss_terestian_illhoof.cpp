...
public:
    ...
    struct boss_terestianAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            if (instance)
            {
                instance->SetBossState(DATA_TERESTIAN_ILLHOOF, NOT_STARTED);
        ...
        void EnterCombat(Unit* /*who*/)
        {
            ...
            if (instance)
                instance->SetBossState(DATA_TERESTIAN_ILLHOOF, IN_PROGRESS);
        }
        ...
        void JustDied(Unit* /*killer*/)
        {
            ...
            if (instance)
            {
                instance->SetBossState(DATA_TERESTIAN_ILLHOOF, DONE);
