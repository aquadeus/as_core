    ...
    public:
        ...
        struct boss_foereaper5000AI : public BossAI
        {
                ...
                if (type == POINT_MOTION_TYPE)
                {
                    switch (id)
                    {
                        case 1001:
                            ...
                            if (Creature* l_HarvestTarget = Creature::GetCreature(*me, m_HarvestTargetGUID))
                                l_HarvestTarget->DespawnOrUnsummon();
                            break;
                    }
                }
            }
            ...
            void JustSummoned(Creature* summon)
            {
                ...
                {
                    m_HarvestTargetGUID = summon->GetGUID();
                    Talk(SAY_SPELL2);
