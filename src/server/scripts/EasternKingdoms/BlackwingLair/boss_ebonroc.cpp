...
public:
    ...
    struct boss_ebonrocAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_EBONROC, NOT_STARTED);
        }
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_EBONROC, IN_PROGRESS);
        }

        void EnterEvadeMode() override
        {
            if (m_Instance)
                m_Instance->SetBossState(DATA_EBONROC, FAIL);
        ...
        {
            if (m_Instance)
                m_Instance->SetBossState(DATA_EBONROC, DONE);
        }
