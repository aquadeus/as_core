...
public:
    ...
    struct boss_vaelAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_VAELASTRASZ, NOT_STARTED);
        }
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_VAELASTRASZ, IN_PROGRESS);
        }

        void EnterEvadeMode() override
        {
            if (m_Instance)
                m_Instance->SetBossState(DATA_VAELASTRASZ, FAIL);
        }

        void JustDied(Unit* p_Killer) override
        {
            if (m_Instance)
                m_Instance->SetBossState(DATA_VAELASTRASZ, DONE);
