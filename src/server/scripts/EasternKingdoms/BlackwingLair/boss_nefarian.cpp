...
public:
    ...
    struct boss_nefarianAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_NEFARIAN_LAIR, NOT_STARTED);
        }
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_NEFARIAN_LAIR, DONE);
        }
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            if (m_Instance)
                m_Instance->SetBossState(DATA_NEFARIAN_LAIR, IN_PROGRESS);
        }

        void EnterEvadeMode() override
        {
            if (m_Instance)
                m_Instance->SetBossState(DATA_NEFARIAN_LAIR, FAIL);
