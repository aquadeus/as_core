...
static Locations FlightPoint[MAX_FLIGHT_POS] =
{
    { 1090.870483f, 612.514648f, 1.707436f  },
    { 1117.401978f, 619.834412f, 13.614512f },
    { 1119.229858f, 639.365356f, 17.885136f },
    { 1097.532959f, 647.212891f, 13.598148f },
    { 1079.051025f, 641.184570f, 5.833526f  },
    { 1073.474121f, 629.921692f, 0.767164f  }
};

static Locations Spawn[]=
{
    { 1110.34f, 613.12f, 1.49f },       //spawn point for pumpkin shrine mob
    { 1098.48f, 612.995f, 0.117657f }     //spawn point for smoke
};
...
public:
    ...
    /*  if (soil->GetGoType() == GAMEOBJECT_TYPE_QUESTGIVER && player->getLevel() > 64)
        ...
        { */
            ...
            if (Creature* horseman = soil->SummonCreature(HH_MOUNTED, FlightPoint[0].x, FlightPoint[0].y, FlightPoint[0].z, 0, TEMPSUMMON_MANUAL_DESPAWN, 0))
            {
