...
class boss_venoxis : public CreatureScript
{
    public:
        ...
        {
            boss_venoxisAI(Creature* pCreature) : BossAI(pCreature, DATA_BOSS_VENOXIS)
            {
            ...
            void EnterCombat(Unit* /*who*/)
            {
                ...
                DoZoneInCombat();
                if (instance)
                    instance->SetBossState(DATA_BOSS_VENOXIS, IN_PROGRESS);
            }
...
class npc_venoxis_bloodvenom : public CreatureScript
{
    public:
        ...
        struct npc_venoxis_bloodvenomAI : public Scripted_NoMovementAI
        {
            ...
            {
                if (!pInstance || pInstance->GetBossState(DATA_BOSS_VENOXIS) != IN_PROGRESS)
                {
