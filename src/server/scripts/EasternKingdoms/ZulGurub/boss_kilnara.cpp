...
class boss_kilnara : public CreatureScript
{
    public:
        ...
        {
            boss_kilnaraAI(Creature* creature) : BossAI(creature, DATA_BOSS_KILNARA)
            {
            ...
            void EnterCombat(Unit* /*who*/)
            {
                ...
                if (instance)
                {
                    instance->DoResetCriteria(CRITERIA_TYPE_BE_SPELL_TARGET, CRITERIA_CONDITION_NO_SPELL_HIT, SPELL_CLEAR_ACHIEVEMENT);
                    instance->DoResetCriteria(CRITERIA_TYPE_KILL_CREATURE, CRITERIA_CONDITION_NO_SPELL_HIT, SPELL_CLEAR_ACHIEVEMENT);
                    instance->SetBossState(DATA_BOSS_KILNARA, IN_PROGRESS);
                }
            }
        ...
        class spell_kilnara_rat_lure_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex /*effIndex*/)
            {
                ...
                if (InstanceScript* pInstance = GetHitUnit()->GetInstanceScript())
                    pInstance->DoUpdateCriteria(CRITERIA_TYPE_BE_SPELL_TARGET, SPELL_CAT_FED);
            }
