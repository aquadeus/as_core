...
{
    {GO_VENOXIS_EXIT,           DATA_BOSS_VENOXIS,            DOOR_TYPE_ROOM,     BOUNDARY_NONE},
    {GO_MANDOKIR_EXIT1,         DATA_BOSS_MANDOKIR,           DOOR_TYPE_ROOM,     BOUNDARY_NONE},
    {GO_MANDOKIR_EXIT2,         DATA_BOSS_MANDOKIR,           DOOR_TYPE_ROOM,     BOUNDARY_NONE},
    {GO_MANDOKIR_EXIT3,         DATA_BOSS_MANDOKIR,           DOOR_TYPE_ROOM,     BOUNDARY_NONE},
    {GO_MANDOKIR_EXIT4,         DATA_BOSS_MANDOKIR,           DOOR_TYPE_ROOM,     BOUNDARY_NONE},
    {GO_MANDOKIR_EXIT5,         DATA_BOSS_MANDOKIR,           DOOR_TYPE_ROOM,     BOUNDARY_NONE},
    {GO_ZANZIL_EXIT,            DATA_BOSS_ZANZIL,             DOOR_TYPE_ROOM,     BOUNDARY_NONE},
    {GO_KILNARA_EXIT,           DATA_BOSS_KILNARA,            DOOR_TYPE_ROOM,     BOUNDARY_NONE},
