                        ...
                        {                         
                            ...
                            for (auto l_Itr : l_ListWolvesGuid)
                            {
                                if (Creature* l_Creature = Creature::GetCreature(*me, l_Itr))
                                {
                                    ...
                                    l_Creature->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC);
                                    if (Player* l_Player = me->FindNearestPlayer(500.0f))
                                    {
