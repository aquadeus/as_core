    ...
    public:
        ...
        struct npc_foundry_lava_stalkerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_NON_ATTACKABLE);
    ...
    public:
        ...
        struct npc_foundry_molten_torrent_stalkerAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_NON_ATTACKABLE);
...
class spell_foundry_drop_the_hammer_aura : public SpellScriptLoader
{
    public:
        ...
        class spell_foundry_drop_the_hammer_aura_AuraScript : public AuraScript
        {
            ...
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_foundry_drop_the_hammer_aura_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_foundry_molten_torrent_aura : public SpellScriptLoader
{
    public:
        ...
        class spell_foundry_molten_torrent_aura_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_foundry_molten_torrent_aura_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_foundry_allow_molten_torrent_cast : public SpellScriptLoader
{
    public:
        ...
        class spell_foundry_allow_molten_torrent_cast_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_foundry_allow_molten_torrent_cast_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_foundry_overheated : public SpellScriptLoader
{
    public:
        ...
        class spell_foundry_overheated_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_foundry_overheated_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_MOD_SCALE, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_foundry_fixate : public SpellScriptLoader
{
    public:
        ...
        class spell_foundry_fixate_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_foundry_fixate_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_foundry_firestorm_aura : public SpellScriptLoader
{
    public:
        ...
        class spell_foundry_firestorm_aura_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_foundry_firestorm_aura_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            }
        };
