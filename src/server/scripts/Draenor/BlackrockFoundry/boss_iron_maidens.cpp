    ...
    public:
        ...
        struct boss_admiral_garanAI : public BossAI
        {
            ...
            void Reset() override
            {
                ...
                me->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_UNK_29);
            ...
            void DamageTaken(Unit* p_Attacker, uint32& p_Damage, SpellInfo const* /*p_SpellInfo*/) override
            {
                ...
                else if (p_Damage >= me->GetHealth())
                {
                    ...
                    /// From retail
                    me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_UNK_29);
            ...
            void DoAction(int32 const p_Action) override
            {
                switch (p_Action)
                {
                    case eActions::SummonBombAlpha:
                    {
                        ...
                        {
                            auto l_BombID = m_AvailableBombIDs.begin();
                            ...
                            m_AvailableBombIDs.erase(l_BombID);
                        }
    ...
    public:
        ...
        class spell_foundry_sanguine_strikes_proc_AuraScript : public AuraScript
        {
            ...
            void OnProc(AuraEffect const* /*p_AurEff*/, ProcEventInfo& p_EventInfo)
            {
                ...
                {
                    int32 l_Damage = p_EventInfo.GetDamageInfo()->GetAmount();
