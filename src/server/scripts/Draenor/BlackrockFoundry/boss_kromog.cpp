    ...
    public:
        ...
        struct npc_foundry_rune_of_crushing_earthAI : public ScriptedAI
        {
            ...
            void Reset() override
            {
                ...
                me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC);
                me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS_2, eUnitFlags2::UNIT_FLAG2_DISABLE_TURN);
            ...
            void DoAction(int32 const p_Action) override
            {
                if (p_Action == eAction::ActionCrushingEarth)
                {
                    ...
                    {
                        l_Right->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
                    ...
                    {
                        l_Left->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
...
class spell_foundry_rune_of_crushing_earth : public SpellScriptLoader
{
    public:
        ...
        class spell_foundry_rune_of_crushing_earth_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_foundry_rune_of_crushing_earth_SpellScript::CorrectTargets, EFFECT_0, TARGET_UNIT_ENEMY_BETWEEN_DEST);
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_foundry_rune_of_crushing_earth_SpellScript::CorrectTargets, EFFECT_1, TARGET_UNIT_ENEMY_BETWEEN_DEST);
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_foundry_rune_of_crushing_earth_SpellScript::CorrectTargets, EFFECT_2, TARGET_UNIT_ENEMY_BETWEEN_DEST);
            }
        };
