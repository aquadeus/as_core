        ...
        public:
            ...
            struct mob_bloodmaul_croman_realAI : public FollowerAI
            {
                ...
                void Reset() override
                {
                    ...
                    me->SetByteFlag(EUnitFields::UNIT_FIELD_ANIM_TIER, UNIT_BYTES_1_OFFSET_STAND_STATE, 0);
                    ...
                    switch (p_ID)
                    {
                        ...
                        case eMoves::MoveEnd:
                        {
                            ...
                            AddTimedDelayedOperation(2 * TimeConstants::IN_MILLISECONDS, [this]() -> void
                            {
                                ...
                                me->SetByteFlag(EUnitFields::UNIT_FIELD_ANIM_TIER, UNIT_BYTES_1_OFFSET_STAND_STATE, UnitBytes1_Flags::UNIT_BYTE1_FLAG_KNEEL);
                                me->SetFlag(EUnitFields::UNIT_FIELD_NPC_FLAGS, NPCFlags::UNIT_NPC_FLAG_GOSSIP);
