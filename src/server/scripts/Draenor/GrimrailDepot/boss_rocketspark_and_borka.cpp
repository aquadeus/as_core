    ...
    struct boss_rocketsparkAI : public BossAI
    {
        ...
        void MovementInform(uint32 /*p_Type*/, uint32 p_Id) override
        {
            ...
            case eRocksparkAndBorkaMovementInformed::MovementHigherPlatform:
                ...
                me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
                break;
            default:
                break;
            }
        ...
        void DoAction(int32 const p_Action) override
        {
            ...
            case eRocksparkAndBorkaActions::ActionMadDashContact:
                ...
                me->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC);
                break;
            default:
                break;
            }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eRocketsparkEvents::Eventx2101aCancelation:
                ...
                m_x210IsActivated = false;
                me->SetReactState(ReactStates::REACT_AGGRESSIVE);
                me->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
                break;
...
public:
    ...
    struct grimrail_depot_rocketspark_mob_borkaAI : public BossAI
    {
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            {
                if (Creature* l_Creature = Creature::GetCreature(*me, m_MadDashTargetGUID))
                    me->GetMotionMaster()->MoveCharge(static_cast<Position const*>(l_Creature), eBorkaSpells::SpellMadDashCharge, eRocksparkAndBorkaMovementInformed::MovementMadDashContact);
