        ...
        void Reset() override
        {
            ...
            if (m_Instance != nullptr)
            {
                if (Creature* l_Witherbark = m_Instance->instance->GetCreature(m_Instance->GetData64(eEverbloomData::DataWitherbark)))
                {
                    ...
                    me->GetMotionMaster()->MoveJump(0, l_X, l_Y);
                }
            }
        }
...
public:
    ...
    struct the_everbloom_witherbark_mob_unchecked_growthAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_NON_ATTACKABLE);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eUncheckedGrowthEvents::EventMerge:
                ...
                me->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_NON_ATTACKABLE);
                break;
            default:
                break;
            }
...
public:
    ...
    struct the_everbloom_witherbark_mob_living_leavesAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC);
