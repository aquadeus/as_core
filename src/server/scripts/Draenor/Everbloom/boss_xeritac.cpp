...
class boss_xeritac : public CreatureScript
{
    ...
    struct boss_xeritacAI : public BossAI
    {
        ...
        void EnterCombat(Unit* /*p_Who*/) override
        {
            ...
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC | eUnitFlags::UNIT_FLAG_NON_ATTACKABLE);
            ...
            switch (p_Action)
            {
                case eEverbloomActions::ActionCounting:
                {
                    ...
                    if (m_Count >= 4 && m_Phase == 1)
                    {
                        ...
                        me->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
...
public:
    ...
    struct the_everbloom_xeritac_mob_venom_sprayerAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetCanFly(true);
            me->SetReactState(ReactStates::REACT_PASSIVE);
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
        ...
        void MovementInform(uint32 /*p_Type*/, uint32 p_Id) override
        {
            switch (p_Id)
            {
                case eXeritacMovementInformed::MovementInformedSpidersReachGround:
                    me->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
                    me->SetReactState(ReactStates::REACT_AGGRESSIVE);
