            ...
            switch (p_Action)
            {
                case eArchmageActions::ActionStopPrevent:
                {
                    ...
                    me->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS,
                        ...
                        eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
...
public:
    ...
    struct the_everbloom_archmage_sol_mob_frozen_rainAI : public Scripted_NoMovementAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC);
        }
...
public:
    ...
    struct the_everbloom_archmage_sol_mob_cold_snapAI : public Scripted_NoMovementAI
    {
        ...
        void Reset() override
        {
            ...
            me->AddUnitMovementFlag(MovementFlags::MOVEMENTFLAG_ROOT);
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE);   
        }
        ...
        void UpdateAI(const uint32 p_Diff) override
        {
            if (m_FreezeCheck <= p_Diff)
            {
                ...
                if (Player* l_Nearest = me->FindNearestPlayer(1.6f))
                {
                ...
                if (m_Bool)
                {
                    if (m_DiffDmg <= p_Time)
                    {
                        ...
                        if (l_Modifier < 20)
                            ...
                            p_AreaTrigger->SetDuration(1 * TimeConstants::IN_MILLISECONDS);
