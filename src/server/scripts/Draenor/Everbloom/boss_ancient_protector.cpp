...
public:
    ...
    struct the_everbloom_ancient_protectors_mob_bramble_patchAI : public Scripted_NoMovementAI
    {
        ...
        void Reset() override
        {
            ...
            me->AddUnitMovementFlag(MovementFlags::MOVEMENTFLAG_ROOT);
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC |eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
...
public:
    ...
    class the_everbloom_ancient_protectors_spell_rapid_tides_AuraScript : public AuraScript
    {
        ...
        void Register() override
        {
            ...
            AfterEffectRemove += AuraEffectRemoveFn(the_everbloom_ancient_protectors_spell_rapid_tides_AuraScript::OnRemove,    SpellEffIndex::EFFECT_0, AuraType::SPELL_AURA_DUMMY, AuraEffectHandleModes::AURA_EFFECT_HANDLE_REAL);
        }
    };
