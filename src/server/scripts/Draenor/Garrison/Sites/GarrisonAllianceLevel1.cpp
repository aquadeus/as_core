...
namespace MS { namespace Garrison { namespace GDraenor { namespace Sites
{
    ...
    /// @p_Owner : Garrison owner
    bool InstanceScript_GarrisonAllianceLevel1::CanUseDraenorGarrisonCache(Player* p_Owner)
    {
        /// Alliance
    ...
    uint32 InstanceScript_GarrisonAllianceLevel1::OnPrePurchaseBuilding(Player* p_Owner, uint32 p_BuildingID, uint32 p_BaseTime)
    {
        ...
        if (p_BuildingID == GDraenor::Building::ID::Barracks_Barracks_Level1 && p_Owner->HasQuest(Quests::Alliance_BuildYourBarracks))
...
{
    new MS::Garrison::GDraenor::Sites::InstanceMapScript_GarrisonAllianceLevel1();
}
#endif
