...
namespace MS { namespace Garrison { namespace GDraenor { namespace Sites
{
    ...
    /// @p_Owner : Garrison owner
    bool InstanceScript_GarrisonAllianceShipyard::CanUseDraenorGarrisonCache(Player* /*p_Owner*/)
    {
        return true;
    }
...
{
    new MS::Garrison::GDraenor::Sites::InstanceMapScript_GarrisonAllianceShipyard();
}
#endif
