                ...
                if (Creature* l_Warden = l_Instance->instance->GetCreature(l_Instance->GetData64(eAuchindounDatas::DataWarden)))
                {
                    if (l_Warden->IsAIEnabled)
                    {
                        ...
                        case 2:
                        {
                            ...
                            l_Warden->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
                        ...
                        case 3:
                        {
                            if (l_Instance != nullptr)
                            {
                                ...
                                l_Warden->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
