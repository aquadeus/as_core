...
class boss_sadana_bloodfury : public CreatureScript
{
    ...
    struct boss_sadana_bloodfuryAI : public BossAI
    {
        ...
        void Reset() override
        {
            ...
            me->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC
            ...
            if (p_Summon)
            {
                switch (p_Summon->GetEntry())
                {
                    case eSadanaCreatures::CreatureShadowRune:
                        p_Summon->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
        ...
        void DoAction(int32 const p_Action) override
        {
            ...
            case eSadanaActions::ActionActivateDefiledSpirit:
            {
                if (m_Activation)
                    ...
                    m_Activation = true;
                    me->StopMoving();
                    me->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC);
...
class shadowmoon_burial_grounds_sadana_creature_falling_dagger : public CreatureScript
{
    ...
    struct shadowmoon_burial_grounds_sadana_creature_falling_daggerAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetDisableGravity(true);
            me->SetReactState(ReactStates::REACT_PASSIVE);
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC);
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case eSadanaEvents::EventDaggerFallMovement:
                    ...
                    break;
                case eSadanaEvents::EventDaggerFall: /// Responsible for damage ticking, disabling the automatic damage from spelldb2
...
class shadowmoon_burial_grounds_sadana_creature_shadow_rune : public CreatureScript
{
    ...
    struct shadowmoon_burial_grounds_sadana_creature_shadow_runeAI : public Scripted_NoMovementAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetReactState(ReactStates::REACT_PASSIVE);
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_IMMUNE_TO_NPC);
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS_2, eUnitFlags2::UNIT_FLAG2_DISABLE_TURN);
            switch (urand(0, 2))
            {
                case 0:
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            if (!m_HasExploaded)
            {
                if (m_Diff <= p_Diff)
                {
                    if (Player* l_Player = me->FindNearestPlayer(1.2f))
                    {
                        m_HasExploaded = true;
...
/// Dark Communion - 153153  [ Responsible for making the ghost stop moving, and start following the boss ]
...
class shadowmoon_burial_grounds_sadana_spell_dark_eclipse : public SpellScriptLoader
{
    ...
    class shadowmoon_burial_grounds_sadana_spell_dark_eclipse_AuraScript : public AuraScript
    {
        ...
        void OnApply(AuraEffect const* /*p_AurEff*/, AuraEffectHandleModes /*p_Mode*/)
        {
            ...
            GetCaster()->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
        }
