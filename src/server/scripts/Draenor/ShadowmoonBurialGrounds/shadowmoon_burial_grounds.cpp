...
class shadowmoon_burial_grounds_creature_site : public CreatureScript
{
    ...
    struct shadowmoon_burial_grounds_creature_siteAI : public Scripted_NoMovementAI
    {
        ...
        void Reset() override
        {
            ...
            me->setFaction(FriendlyFaction);        
            me->SetReactState(ReactStates::REACT_PASSIVE);          
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
