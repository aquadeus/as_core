...
public:
    ...
    struct shadowmoon_burial_grounds_nerzul_creature_initial_teleportAI : public Scripted_NoMovementAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetReactState(ReactStates::REACT_PASSIVE);
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
        }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            if (m_Instance != nullptr)
            {
                if (Creature* l_Nerzul = m_Instance->instance->GetCreature(m_Instance->GetData64(eShadowmoonBurialGroundsDatas::DataBossNerzul)))
                {
                    ...
                    {
                        if (Player* l_NearestPlayer = me->FindNearestPlayer(5.0f))
...
public:
    ...
    struct shadowmoon_burial_grounds_nerzul_creature_nerzul_propAI : public Scripted_NoMovementAI
    {
        ...
        void Reset() override
        {
            ...
            me->SetFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
        }
    ...
    class shadowmoon_burial_grounds_nerzul_spell_maleovlence_SpellScript : public SpellScript
    {
        ...
        void HandleAfterCast()
        {
            if (Unit* l_Caster = GetCaster())
            {
                ...
                l_Caster->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL);
            }
        }
