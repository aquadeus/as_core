...
class spell_highmaul_boars_rush : public SpellScriptLoader
{
    public:
        ...
        class spell_highmaul_boars_rush_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_highmaul_boars_rush_SpellScript::CorrectTargets, EFFECT_1, TARGET_UNIT_ENEMY_BETWEEN_DEST);
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_highmaul_boars_rush_SpellScript::CorrectTargets, EFFECT_3, TARGET_UNIT_ENEMY_BETWEEN_DEST);
            }
        };
...
class spell_highmaul_earthdevastating_slam_dmg : public SpellScriptLoader
{
    public:
        ...
        class spell_highmaul_earthdevastating_slam_dmg_SpellScript : public SpellScript
        {
            ...
            void Register() override
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_highmaul_earthdevastating_slam_dmg_SpellScript::CorrectTargets, EFFECT_0, TARGET_UNIT_ENEMY_BETWEEN_DEST);
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_highmaul_earthdevastating_slam_dmg_SpellScript::CorrectTargets, EFFECT_1, TARGET_UNIT_ENEMY_BETWEEN_DEST);
            }
        };
