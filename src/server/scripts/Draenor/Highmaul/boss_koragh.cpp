    ...
    public:
        ...
        class spell_highmaul_nullification_barrier_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_highmaul_nullification_barrier_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_SCHOOL_ABSORB, AURA_EFFECT_HANDLE_REAL);
            }
        };
    ...
    public:
        ...
        class spell_highmaul_caustic_energy_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_highmaul_caustic_energy_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_AREATRIGGER, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_highmaul_caustic_energy_dot : public SpellScriptLoader
{
    public:
        ...
        class spell_highmaul_caustic_energy_dot_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectApply += AuraEffectApplyFn(spell_highmaul_caustic_energy_dot_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove += AuraEffectRemoveFn(spell_highmaul_caustic_energy_dot_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_highmaul_expel_magic_fire : public SpellScriptLoader
{
    public:
        ...
        class spell_highmaul_expel_magic_fire_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_highmaul_expel_magic_fire_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE, AURA_EFFECT_HANDLE_REAL);
            }
        };
    ...
    public:
        ...
        class spell_highmaul_nullification_barrier_player_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_highmaul_nullification_barrier_player_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_SCHOOL_ABSORB, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_highmaul_suppression_field_aura : public SpellScriptLoader
{
    public:
        ...
        class spell_highmaul_suppression_field_aura_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_highmaul_suppression_field_aura_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
