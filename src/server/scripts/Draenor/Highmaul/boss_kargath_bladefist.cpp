...
class spell_highmaul_earth_breaker : public SpellScriptLoader
{
    public:
        ...
        class spell_highmaul_earth_breaker_SpellScript : public SpellScript
        {
            ...
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_highmaul_earth_breaker_SpellScript::CorrectTargets, EFFECT_1, TARGET_UNIT_ENEMY_BETWEEN_DEST);
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_highmaul_earth_breaker_SpellScript::CorrectTargets, EFFECT_2, TARGET_UNIT_ENEMY_BETWEEN_DEST);
