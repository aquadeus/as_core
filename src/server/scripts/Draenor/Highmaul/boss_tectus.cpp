    ...
    public:
        ...
        struct boss_tectusAI : public BossAI
        {
            ...
            void Reset() override
            {
                ...
                me->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_REMOVE_CLIENT_CONTROL | eUnitFlags::UNIT_FLAG_PREPARATION | eUnitFlags::UNIT_FLAG_DISARMED);
                ...
                switch (p_Action)
                {
                    ...
                    case eActions::MoteKilled:
                    {
                        ...
                        if (m_MoteKilled >= (eMiscs::MotesSpawnCount * 2))
                        {
                            ...
                            {
                                me->RemoveFlag(EUnitFields::UNIT_FIELD_FLAGS, eUnitFlags::UNIT_FLAG_NON_ATTACKABLE | eUnitFlags::UNIT_FLAG_NOT_SELECTABLE | eUnitFlags::UNIT_FLAG_IMMUNE_TO_PC);
                                if (me->GetMap()->GetPlayers().getSize())
                                {
...
class spell_highmaul_earthen_pillar_timer : public SpellScriptLoader
{
    public:
        ...
        class spell_highmaul_earthen_pillar_timer_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_highmaul_earthen_pillar_timer_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
    ...
    public:
        ...
        class spell_highmaul_accretion_AuraScript : public AuraScript
        {
            ...
            void OnProc(AuraEffect const* p_AurEff, ProcEventInfo& p_EventInfo)
            {
                ...
                {
                    m_DamageTaken += p_EventInfo.GetDamageInfo()->GetAmount();
    ...
    public:
        ...
        class spell_highmaul_tectonic_upheaval_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_highmaul_tectonic_upheaval_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            }
        };
