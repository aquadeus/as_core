            ...
            struct instance_SkyreachInstanceMapScript : public InstanceScript
            {
                ...
                void OnCreatureCreate(Creature* p_Creature)
                {
                    ...
                    case MobEntries::SKYREACH_SOLAR_CONSTRUCTOR:
                        ...
                        p_Creature->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_REMOVE_CLIENT_CONTROL | UNIT_FLAG_IMMUNE_TO_PC);
                    ...
                    case MobEntries::YoungKaliri:
                        ...
                        p_Creature->SetByteFlag(UNIT_FIELD_ANIM_TIER, UNIT_BYTES_1_OFFSET_ANIM_TIER, UNIT_BYTE1_FLAG_ALWAYS_STAND | UNIT_BYTE1_FLAG_HOVER);
                        p_Creature->SetReactState(REACT_PASSIVE);
                        p_Creature->setFaction(FACTION_MONSTER_2);
                        p_Creature->DisableEvadeMode();
                        p_Creature->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_REMOVE_CLIENT_CONTROL | UNIT_FLAG_NON_ATTACKABLE);
                        break;
                ...
                void SetData64(uint32 p_Type, uint64 p_Data)
                {
                    ...
                    case Data::SolarFlareDying:
                        ...
                        if (Unit* l_SolarFlareDying = sObjectAccessor->FindCreature(p_Data))
                        {
                            ...
                            l_Sum->setFaction(FACTION_MONSTER_2);
