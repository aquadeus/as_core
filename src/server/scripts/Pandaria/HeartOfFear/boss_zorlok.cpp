        ...
        struct boss_zorlokAI : public BossAI
        {
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                switch (events.ExecuteEvent())
                {
                    ...
                    case EVENT_BERSERK:
                    {
                        me->AddAura(SPELL_ZORLOK_BERSERK, me);
                        break;
                    }
...
class spell_sonic_pulse : public SpellScriptLoader
{
    public:
        ...
        class spell_sonic_pulse_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_sonic_pulse_AuraScript::ApplyAura, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
                AfterEffectApply += AuraEffectApplyFn(spell_sonic_pulse_AuraScript::ApplyAura, EFFECT_1, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_zorlok_exhale_damage : public SpellScriptLoader
{
    public:
        ...
        class spell_zorlok_exhale_damage_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_zorlok_exhale_damage_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_ENEMY_BETWEEN_DEST);
            }
        };
