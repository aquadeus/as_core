...
class spell_tayak_wind_step: public SpellScriptLoader
{
    public:
        ...
        class spell_tayak_wind_stepAuraScript: public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_tayak_wind_stepAuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_tempest_slash : public SpellScriptLoader
{
    public :
        ...
        class spell_tempest_slash_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_tempest_slash_AuraScript::AfterApply, EFFECT_2, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_tayak_su_visual : public SpellScriptLoader
{
    public:
        ...
        class spell_tayak_su_visualAuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_tayak_su_visualAuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_su_dummy_visual : public SpellScriptLoader
{
    public:
        ...
        class spell_su_dummy_visualAuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_su_dummy_visualAuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
