...
class spell_maddening_shout : public SpellScriptLoader
{
    public:
        ...
        class spell_maddening_shout_AuraScript : public AuraScript
        {
            ...
            {
                if (Unit* attacker = dmgInfo.GetActor())
            ...
            void Register()
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_maddening_shout_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_SCHOOL_ABSORB, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_sleight_of_hand : public SpellScriptLoader
{
    public:
        ...
        class spell_sleight_of_hand_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_sleight_of_hand_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_MOD_DAMAGE_PERCENT_DONE, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove += AuraEffectRemoveFn(spell_sleight_of_hand_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_MOD_DAMAGE_PERCENT_DONE, AURA_EFFECT_HANDLE_REAL);
            }
        };
