...
class spell_magnetized_qin : public SpellScriptLoader
{
    public:
        ...
        class spell_magnetized_qin_AuraScript : public AuraScript
        {
            ...
            void AfterApply(AuraEffect const* /*aurAff*/, AuraEffectHandleModes /*mode*/)
            {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_magnetized_qin_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_magnetized_jan : public SpellScriptLoader
{
    public:
        ...
        class spell_magnetized_jan_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_magnetized_jan_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_arc_visual : public SpellScriptLoader
{
    public:
        ...
        class spell_arc_visual_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_arc_visual_AuraScript::AfterApply, EFFECT_1, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_titan_gas : public SpellScriptLoader
{
    public:
        ...
        class spell_titan_gas_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_titan_gas_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_titan_gas2 : public SpellScriptLoader
{
    public:
        ...
        class spell_titan_gas2_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_titan_gas2_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_energized : public SpellScriptLoader
{
    public :
        ...
        class spell_energized_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_energized_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
