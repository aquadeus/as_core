            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                switch (events.ExecuteEvent())
                {
                    ...
                    case EVENT_CHECK_MELEE:
                    {
                        ...
                        if (!me->IsWithinDist(me->getVictim(), 10.0f))
...
class spell_spawn_flash_1_periodic : public SpellScriptLoader
{
    public:
        ...
        class spell_spawn_flash_1_periodic_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_spawn_flash_1_periodic_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_spawn_flash_2_periodic : public SpellScriptLoader
{
    public:
        ...
        class spell_spawn_flash_2_periodic_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_spawn_flash_2_periodic_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_spawn_flash_3_periodic : public SpellScriptLoader
{
    public:
        ...
        class spell_spawn_flash_3_periodic_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_spawn_flash_3_periodic_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            }
        };
    ...
    public:
        ...
        class spell_touch_of_titans_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_touch_of_titans_AuraScript::OnRemove, EFFECT_1, SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_draw_power : public SpellScriptLoader
{
    public:
        ...
        class spell_draw_power_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_draw_power_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_destabilizing_energies : public SpellScriptLoader
{
    public:
        ...
        class spell_destabilizing_energies_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_destabilizing_energies_AuraScript::AfterApply, EFFECT_2, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
