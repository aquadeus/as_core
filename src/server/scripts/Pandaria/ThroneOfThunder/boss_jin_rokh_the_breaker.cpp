...
class spell_ionization: public SpellScriptLoader
{
    public:
        ...
        class spell_ionization_SpellScript : public SpellScript
        {
            ...
            void CorrectTargets(std::list<WorldObject*>& targets)
            {
                ...
                for (auto target : targets)
                {
                    ...
                    if (plr->GetRoleForGroup(plr->GetActiveSpecializationID()) == ROLE_TANK)
        ...
        class spell_ionization_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_ionization_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
