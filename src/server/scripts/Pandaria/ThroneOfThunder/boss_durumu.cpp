    ...
    public:
        ...
        struct boss_durumuAI : public BossAI
        {
            ...
            void JustDied(Unit* /*p_Killer*/) override
            {
                ...
                GameObject* l_Gate = me->FindNearestGameObject(GOB_DURUMU_EXIT_GATE, 300.0f);
                if (!l_Gate)
                    return;

                l_Gate->UseDoorOrButton(10000);
            }
...
class spell_life_drain_main: public SpellScriptLoader
{
    public:
        ...
        class spell_life_drain_main_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_life_drain_main_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
            }
        };
...
class spell_colorblind_phase_link_visual: public SpellScriptLoader
{
    public:
        ...
        class spell_colorblind_phase_link_visual_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_colorblind_phase_link_visual_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
            }
        };
