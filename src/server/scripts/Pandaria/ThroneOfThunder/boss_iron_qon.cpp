...
class mob_roshak : public CreatureScript
{
    public:
        ...
        struct mob_roshakAI : public ScriptedAI
        {
            ...
            void DamageTaken(Unit* p_Attacker, uint32& p_Damages, SpellInfo const*  /*p_SpellInfo*/) override
            {
...
class mob_quetzal : public CreatureScript
{
    public:
        ...
        struct mob_quetzalAI : public ScriptedAI
        {
            ...
            void MovementInform(uint32 p_Type, uint32 p_Value) override
            {
...
class mob_damren : public CreatureScript
{
    public:
        ...
        struct mob_damrenAI : public ScriptedAI
        {
            ...
            bool CanBeAttackedBy(Unit* p_Attacker)
            {
...
class mob_lightning_cloud : public CreatureScript
{
    public:
        ...
        struct mob_lightning_cloudAI : public ScriptedAI
        {
            ...
            void OnSpellClick(Unit* p_Who) override
            {
    ...
    public:
        ...
        class spell_frozen_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_frozen_AuraScript::Shatter, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
