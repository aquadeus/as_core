...
void TwinJustDied(InstanceScript* p_Instance, Creature* p_DeadBoss)
{
...
class boss_lulin : public CreatureScript
{
    public:
        ...
        struct boss_lulinAI : public BossAI
        {
            ...
            void CheckHitResult(MeleeHitOutcome &p_MeleeHitResult, SpellMissInfo &p_SpellResult, Unit* /*p_Attacker*/, SpellInfo const* const p_SpellInfo) override
            {
            ...
            void DoAction(int32 const p_Action) override
            {
                switch (p_Action)
                {
                    case ACTION_ACTIVATE_COMET:
                    {
                        if (m_Instance)
                        {
                            if (Creature* l_Lulin = m_Instance->instance->GetCreature(m_Instance->GetData(NPC_LU_LIN)))
                            {
    ...
    public:
        ...
        class spell_cosmic_barrage_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_cosmic_barrage_AuraScript::LaunchStar, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_launch_star : public SpellScriptLoader
{
    public:
        ...
        class spell_launch_star_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_launch_star_AuraScript::ReturnToNormal, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
    ...
    public:
        ...
        class spell_tears_of_the_sun_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_tears_of_the_sun_AuraScript::Invisible, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
