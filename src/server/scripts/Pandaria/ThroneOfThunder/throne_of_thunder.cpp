...
Position const m_TortosLairPos = { 6044.40f, 5104.51f, -42.0f, 4.70f };

// 8937
class AreaTrigger_at_tot_tortos_lair_teleport : public AreaTriggerScript
{
public:
    AreaTrigger_at_tot_tortos_lair_teleport() : AreaTriggerScript("AreaTrigger_at_tot_tortos_lair_teleport") {}

    void OnEnter(Player* player, AreaTriggerEntry const* /*at*/) override
    {
        if (!player)
            return;

        // TODO. Need put scene or something here. When players enter's bridge here triggers scene
        player->NearTeleportTo(m_TortosLairPos);
    }
};
...
class spell_fixated : public SpellScriptLoader
{
    public:
        ...
        class spell_fixated_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_fixated_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_FIXATE, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_devoured : public SpellScriptLoader
{
    public:
        ...
        class spell_devoured_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_devoured_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
void AddSC_throne_of_thunder()
{
    ...
    new AreaTrigger_at_tot_tortos_lair_teleport();
}
#endif
