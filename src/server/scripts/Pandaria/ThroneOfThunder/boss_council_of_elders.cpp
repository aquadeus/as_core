                    ...
                    case EVENT_SOUL_FRAGMENT:
                    {
                        ...
                        if (!playerList.empty())
                        {
                            ...
                            if (Player* l_Player = playerList.front())
                            {
                                ...
                                l_Player->setFaction(FACTION_FRIENDLY);
...
class spell_reckless_charge_rolling : public SpellScriptLoader
{
    public:
        ...
        class spell_reckless_charge_rolling_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_reckless_charge_rolling_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_frigid_assault : public SpellScriptLoader
{
    public:
        ...
        class spell_frigid_assault_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_frigid_assault_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_PROC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
                AfterEffectRemove += AuraEffectRemoveFn(spell_frigid_assault_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_PROC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
            }
        };
    ...
    public:
        ...
        class spell_frosbite_malakk_aura_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_frosbite_malakk_aura_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL_WITH_VALUE, AURA_EFFECT_HANDLE_REAL);
            }
        };
    ...
    public:
        ...
        class spell_overload_discharge_kazra_jin_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                ...
                {
                    case 137166:
                        AfterEffectApply += AuraEffectApplyFn(spell_overload_discharge_kazra_jin_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
                        AfterEffectRemove += AuraEffectRemoveFn(spell_overload_discharge_kazra_jin_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
                        break;
                    default:
                        AfterEffectApply += AuraEffectApplyFn(spell_overload_discharge_kazra_jin_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
                        AfterEffectRemove += AuraEffectRemoveFn(spell_overload_discharge_kazra_jin_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
                        break;
                }
            }
        };
...
class spell_ensnared : public SpellScriptLoader
{
    public:
        ...
        class spell_ensnared_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_ensnared_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_MOD_DECREASE_SPEED, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
            }
        };
...
class spell_sandstorm : public SpellScriptLoader
{
    public:
        ...
        class spell_sandstorm_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_sandstorm_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
            }
        };
