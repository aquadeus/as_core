...
class spell_sunbeam : public SpellScriptLoader
{
    public:
        ...
        class spell_sunbeam_aura_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_sunbeam_aura_AuraScript::OnApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove += AuraEffectRemoveFn(spell_sunbeam_aura_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_light_of_the_day : public SpellScriptLoader
{
    public:
        ...
        class spell_light_of_the_day_AuraScript : public AuraScript
        {
            ...
            void AfterCheck(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_light_of_the_day_AuraScript::AfterCheck, EFFECT_1, SPELL_AURA_MOD_HEALING_DONE_PERCENT, AURA_EFFECT_HANDLE_REAL);
            }
        };
