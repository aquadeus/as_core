...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "cancel",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleServerShutDownCancelCommand,      "", NULL },
            { ""   ,            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleServerIdleRestartCommand,         "", NULL },
        ...
        {
            { "cancel",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleServerShutDownCancelCommand,      "", NULL },
            { ""   ,            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleServerIdleShutDownCommand,        "", NULL },
            { NULL,             0,                      0,                  false, NULL,                                    "", NULL }
        };
        ...
        {
            { "cancel",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleServerShutDownCancelCommand,      "", NULL },
            { ""   ,            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleServerRestartCommand,             "", NULL },
            { NULL,             0,                      0,                  false, NULL,                                    "", NULL }
        };
        ...
        {
            { "cancel",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleServerShutDownCancelCommand,      "", NULL },
            { ""   ,            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleServerShutDownCommand,            "", NULL },
            { NULL,             0,                      0,                  false, NULL,                                    "", NULL }
        };

        static ChatCommand serverSetCommandTable[] =
        {
            { "difftime",       SEC_CONSOLE,            SEC_CONSOLE,        true,  &HandleServerSetDiffTimeCommand,         "", NULL },
            { "loglevel",       SEC_CONSOLE,            SEC_CONSOLE,        true,  &HandleServerSetLogLevelCommand,         "", NULL },
            { "closed",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleServerSetClosedCommand,           "", NULL },
            { NULL,             0,                      0,                  false, NULL,                                    "", NULL }
        };

        static ChatCommand serverCommandTable[] =
        {
            { "exit",           SEC_CONSOLE,            SEC_CONSOLE,        true,  &HandleServerExitCommand,                "", NULL },
            { "idlerestart",    SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  NULL,                                    "", serverIdleRestartCommandTable },
            { "idleshutdown",   SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  NULL,                                    "", serverIdleShutdownCommandTable },
            { "info",           SEC_PLAYER,             SEC_PLAYER,         true,  &HandleServerInfoCommand,                "", NULL },
            { "motd",           SEC_PLAYER,             SEC_PLAYER,         true,  &HandleServerMotdCommand,                "", NULL },
            { "plimit",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleServerPLimitCommand,              "", NULL },
            { "restart",        SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  NULL,                                    "", serverRestartCommandTable },
            { "shutdown",       SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  NULL,                                    "", serverShutdownCommandTable },
            { "set",            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  NULL,                                    "", serverSetCommandTable },
            { NULL,             0,                      0,                  false, NULL,                                    "", NULL }
        };

         static ChatCommand commandTable[] =
        {
            { "server",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  NULL,                                    "", serverCommandTable },
            { NULL,             0,                      0,                  false, NULL,                                    "", NULL }
        };
        return commandTable;
    }
    ...
    static bool HandleServerInfoCommand(ChatHandler* p_Handler, char const* /*args*/)
    {
...
#ifdef CROSS
        p_Handler->PSendSysMessage("Legion (Cross)");
#endif /* CROSS */
#ifndef CROSS
        p_Handler->PSendSysMessage("WoW Circle Legion Development 7.3.5");
        p_Handler->PSendSysMessage("WoW Circle Core: Last Update: 31.07.21 Updatepack: 13");
        p_Handler->PSendSysMessage("WoW Circle DB: Last Update: 31.07.21 Updatepack: 56");
        ...
        if (p_Handler->GetSession())
        {
            ...
            if (l_Player && l_Player->GetMap())
                p_Handler->PSendSysMessage("Map delay: %u ms", l_Player->GetMap()->GetLastDiff());
        }
