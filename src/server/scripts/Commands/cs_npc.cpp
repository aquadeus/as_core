...
UnitFlag const unitFlags[UNIT_FLAGS_MAX] =
{
    ...
    { (uint32)UNIT_FLAG_REMOVE_CLIENT_CONTROL, "UNIT_FLAG_REMOVE_CLIENT_CONTROL"},
    ...
    { (uint32)UNIT_FLAG_CANNOT_SWIM         , "UNIT_FLAG_CANNOT_SWIM"           },
...
#define UNIT_NPC_FLAGS_MAX   33

NPCFlag const unitNPCFlags[UNIT_NPC_FLAGS_MAX] =
{
    { (uint32)UNIT_NPC_FLAG_NONE                      , "UNIT_NPC_FLAG_NONE"                       },
    { (uint32)UNIT_NPC_FLAG_GOSSIP                    , "UNIT_NPC_FLAG_GOSSIP"                     },
    { (uint32)UNIT_NPC_FLAG_QUESTGIVER                , "UNIT_NPC_FLAG_QUESTGIVER"                 },
    { (uint32)UNIT_NPC_FLAG_UNK1                      , "UNIT_NPC_FLAG_UNK1"                       },
    { (uint32)UNIT_NPC_FLAG_UNK2                      , "UNIT_NPC_FLAG_UNK2"                       },
    { (uint32)UNIT_NPC_FLAG_TRAINER                   , "UNIT_NPC_FLAG_TRAINER"                    },
    { (uint32)UNIT_NPC_FLAG_TRAINER_CLASS             , "UNIT_NPC_FLAG_TRAINER_CLASS"              },
    { (uint32)UNIT_NPC_FLAG_TRAINER_PROFESSION        , "UNIT_NPC_FLAG_TRAINER_PROFESSION"         },
    { (uint32)UNIT_NPC_FLAG_VENDOR                    , "UNIT_NPC_FLAG_VENDOR"                     },
    { (uint32)UNIT_NPC_FLAG_VENDOR_AMMO               , "UNIT_NPC_FLAG_VENDOR_AMMO"                },
    { (uint32)UNIT_NPC_FLAG_VENDOR_FOOD               , "UNIT_NPC_FLAG_VENDOR_FOOD"                },
    { (uint32)UNIT_NPC_FLAG_VENDOR_POISON             , "UNIT_NPC_FLAG_VENDOR_POISON"              },
    { (uint32)UNIT_NPC_FLAG_VENDOR_REAGENT            , "UNIT_NPC_FLAG_VENDOR_REAGENT"             },
    { (uint32)UNIT_NPC_FLAG_REPAIR                    , "UNIT_NPC_FLAG_REPAIR"                     },
    { (uint32)UNIT_NPC_FLAG_FLIGHTMASTER              , "UNIT_NPC_FLAG_FLIGHTMASTER"               },
    { (uint32)UNIT_NPC_FLAG_SPIRITHEALER              , "UNIT_NPC_FLAG_SPIRITHEALER"               },
    { (uint32)UNIT_NPC_FLAG_SPIRITGUIDE               , "UNIT_NPC_FLAG_SPIRITGUIDE"                },
    { (uint32)UNIT_NPC_FLAG_INNKEEPER                 , "UNIT_NPC_FLAG_INNKEEPER"                  },
    { (uint32)UNIT_NPC_FLAG_BANKER                    , "UNIT_NPC_FLAG_BANKER"                     },
    { (uint32)UNIT_NPC_FLAG_PETITIONER                , "UNIT_NPC_FLAG_PETITIONER"                 },
    { (uint32)UNIT_NPC_FLAG_TABARDDESIGNER            , "UNIT_NPC_FLAG_TABARDDESIGNER"             },
    { (uint32)UNIT_NPC_FLAG_BATTLEMASTER              , "UNIT_NPC_FLAG_BATTLEMASTER"               },
    { (uint32)UNIT_NPC_FLAG_AUCTIONEER                , "UNIT_NPC_FLAG_AUCTIONEER"                 },
    { (uint32)UNIT_NPC_FLAG_STABLEMASTER              , "UNIT_NPC_FLAG_STABLEMASTER"               },
    { (uint32)UNIT_NPC_FLAG_GUILD_BANKER              , "UNIT_NPC_FLAG_GUILD_BANKER"               },
    { (uint32)UNIT_NPC_FLAG_SPELLCLICK                , "UNIT_NPC_FLAG_SPELLCLICK"                 },
    { (uint32)UNIT_NPC_FLAG_PLAYER_VEHICLE            , "UNIT_NPC_FLAG_PLAYER_VEHICLE"             },
    { (uint32)UNIT_NPC_FLAG_MAILBOX                   , "UNIT_NPC_FLAG_MAILBOX"                    },
    { (uint32)UNIT_NPC_FLAG_ARTIFACT_POWER_RESPEC     , "UNIT_NPC_FLAG_ARTIFACT_POWER_RESPEC"      },
    { (uint32)UNIT_NPC_FLAG_TRANSMOGRIFIER            , "UNIT_NPC_FLAG_TRANSMOGRIFIER"             },
    { (uint32)UNIT_NPC_FLAG_VAULTKEEPER               , "UNIT_NPC_FLAG_VAULTKEEPER"                },
    { (uint32)UNIT_NPC_FLAG_PETBATTLE                 , "UNIT_NPC_FLAG_PETBATTLE"                  },
    { (uint32)UNIT_NPC_FLAG_BLACK_MARKET              , "UNIT_NPC_FLAG_BLACK_MARKET"               },
};

#define UNIT_NPC_FLAGS2_MAX   33
...
NPCFlag2 const unitNPCFlags2[UNIT_NPC_FLAGS2_MAX] =
{
    { (uint32)UNIT_NPC_FLAG2_NONE                     , "UNIT_NPC_FLAG2_NONE"                       },
    { (uint32)UNIT_NPC_FLAG2_ITEM_UPGRADE             , "UNIT_NPC_FLAG2_ITEM_UPGRADE"               },
    { (uint32)UNIT_NPC_FLAG2_GARRISON_ARCHITECT       , "UNIT_NPC_FLAG2_GARRISON_ARCHITECT"         },
    { (uint32)UNIT_NPC_FLAG2_AI_OBSTACLE              , "UNIT_NPC_FLAG2_AI_OBSTACLE"                },
    { (uint32)UNIT_NPC_FLAG2_STEERING                 , "UNIT_NPC_FLAG2_STEERING"                   },
    { (uint32)UNIT_NPC_FLAG2_GARRISON_SHIPMENT_CRAFTER, "UNIT_NPC_FLAG2_GARRISON_SHIPMENT_CRAFTER"  },
    { (uint32)UNIT_NPC_FLAG2_GARRISON_MISSION_NPC     , "UNIT_NPC_FLAG2_GARRISON_MISSION_NPC"       },
    { (uint32)UNIT_NPC_FLAG2_TRADESKILL_NPC           , "UNIT_NPC_FLAG2_TRADESKILL_NPC"             },
    { (uint32)UNIT_NPC_FLAG2_BLACK_MARKET_VIEW        , "UNIT_NPC_FLAG2_BLACK_MARKET_VIEW"          }
};
...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "formation",      SEC_MODERATOR,              SEC_MODERATOR,     false, &HandleNpcAddFormationCommand,      "", NULL },
            { "item",           SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcAddVendorItemCommand,     "", NULL },
            { "move",           SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcAddMoveCommand,           "", NULL },
            { "temp",           SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcAddTempSpawnCommand,      "", NULL },
            { "",               SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcAddCommand,               "", NULL },
            { NULL,             0,                          0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand npcDeleteCommandTable[] =
        {
            { "item",           SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcDeleteVendorItemCommand,  "", NULL },
            { "",               SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcDeleteCommand,            "", NULL },
            { NULL,             0,                          0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand npcFollowCommandTable[] =
        {
            { "stop",           SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcUnFollowCommand,          "", NULL },
            { "",               SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcFollowCommand,            "", NULL },
            { NULL,             0,                          0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand npcSetCommandTable[] =
        {
            { "allowmove",      SEC_ADMINISTRATOR,          SEC_ADMINISTRATOR,  false, &HandleNpcSetAllowMovementCommand,  "", NULL },
            { "entry",          SEC_ADMINISTRATOR,          SEC_ADMINISTRATOR,  false, &HandleNpcSetEntryCommand,          "", NULL },
            { "factionid",      SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetFactionIdCommand,      "", NULL },
            { "flag",           SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetFlagCommand,           "", NULL },
            { "flag2",          SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetFlag2Command,         "", NULL },
            { "level",          SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetLevelCommand,          "", NULL },
            { "link",           SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetLinkCommand,           "", NULL },
            { "model",          SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetModelCommand,          "", NULL },
            { "movetype",       SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetMoveTypeCommand,       "", NULL },
            { "phase",          SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetPhaseCommand,          "", NULL },
            { "spawndist",      SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetSpawnDistCommand,      "", NULL },
            { "spawntime",      SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetSpawnTimeCommand,      "", NULL },
            { "data",           SEC_ADMINISTRATOR,          SEC_ADMINISTRATOR,  false, &HandleNpcSetDataCommand,           "", NULL },
            { "animkit",        SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetAnimKitCommand,        "", NULL },
            { "emotestate",     SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcSetEmoteStateCommand,     "", NULL },
            { NULL,             0,                          0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand npcCommandTable[] =
        {
            { "info",           SEC_ADMINISTRATOR,          SEC_ADMINISTRATOR,  false, &HandleNpcInfoCommand,              "", NULL },
            { "move",           SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcMoveCommand,              "", NULL },
            { "playemote",      SEC_ADMINISTRATOR,          SEC_ADMINISTRATOR,  false, &HandleNpcPlayEmoteCommand,         "", NULL },
            { "say",            SEC_MODERATOR,              SEC_MODERATOR,      false, &HandleNpcSayCommand,               "", NULL },
            { "textemote",      SEC_MODERATOR,              SEC_MODERATOR,      false, &HandleNpcTextEmoteCommand,         "", NULL },
            { "whisper",        SEC_MODERATOR,              SEC_MODERATOR,      false, &HandleNpcWhisperCommand,           "", NULL },
            { "yell",           SEC_MODERATOR,              SEC_MODERATOR,      false, &HandleNpcYellCommand,              "", NULL },
            { "tame",           SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcTameCommand,              "", NULL },
            { "map_activate",   SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcActivateCommand,          "", NULL },
            { "near",           SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcNearCommand,              "", NULL },
            { "add",            SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, NULL,                 "", npcAddCommandTable },
            { "delete",         SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, NULL,              "", npcDeleteCommandTable },
            { "follow",         SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, NULL,              "", npcFollowCommandTable },
            { "set",            SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, NULL,                 "", npcSetCommandTable },
            { "groupscaling",   SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcGroupScaling,             "", NULL },
            { "listaggro",      SEC_GAMEMASTER,             SEC_GAMEMASTER,     false, &HandleNpcListAggro,                "", NULL },
            { "summon",         SEC_ADMINISTRATOR,          SEC_ADMINISTRATOR,  false, &HandleNpcSummonGroupCommand,       "", NULL },
            { NULL,             0,                          0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "npc",            SEC_MODERATOR,              SEC_MODERATOR,      false, NULL,                    "", npcCommandTable },
            { NULL,             0,                          0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
    ...
    static bool HandleNpcAddCommand(ChatHandler* p_Handler, const char* p_Args)
    {
        ...
        WorldDatabase.AsyncQuery(l_Statement, p_Handler->GetSession()->GetPlayer()->GetMap()->GetQueryCallbackMgr(), [l_Id, l_Teamval, l_CharacterGuid](PreparedQueryResult p_Result) -> void
        {
            if (!p_Result)
                return;
            ...
            if (Transport* l_Transport = l_Character->GetTransport())
            {
                ...
                l_Creature->SaveToDB(l_Transport->GetGOInfo()->moTransport.SpawnMap, 1 << l_Map->GetSpawnMode(), l_Character->GetPhaseMgr().GetPhaseMaskForSpawn());
                return;
            }
            ...
            if (!l_Creature->LoadCreatureFromDB(l_DbGuid, l_Map, true, false))
            {
                delete l_Creature;
                return;
            }
    ...
    static bool HandleNpcAddVendorItemCommand(ChatHandler* handler, char const* args)
    {
        ...
        handler->PSendSysMessage(LANG_ITEM_ADDED_TO_LIST, itemId, itemTemplate->Name1->Get(handler->GetSessionDb2Locale()), maxcount, incrtime, extendedcost);
        return true;
    }
    ...
    static bool HandleNpcDeleteVendorItemCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_ITEM_DELETED_FROM_LIST, itemId, itemTemplate->Name1->Get(handler->GetSessionDb2Locale()));
        return true;
    }
    ...
    static bool HandleNpcInfoCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        if (!target)
        {
            ...
            player->GetCreatureListInGrid(l_CreatureList, 5.0f);
            for (Creature* l_Creature : l_CreatureList)
            {
                CreatureTemplate const* cInfo = l_Creature->GetCreatureTemplate();

                uint32 faction = l_Creature->getFaction();
                uint32 l_NpcFlags = l_Creature->GetUInt32Value(UNIT_FIELD_NPC_FLAGS);
                uint32 l_NpcFlags2 = l_Creature->GetUInt32Value(UNIT_FIELD_NPC_FLAGS + 1);
                uint32 l_Flags = l_Creature->GetUInt32Value(UNIT_FIELD_FLAGS);
                uint32 mechanicImmuneMask = cInfo->MechanicImmuneMask;
                uint32 displayid = l_Creature->GetDisplayId();
                uint32 nativeid = l_Creature->GetNativeDisplayId();
                uint32 Entry = l_Creature->GetEntry();

                int64 curRespawnDelay = l_Creature->GetRespawnTimeEx() - time(NULL);
                if (curRespawnDelay < 0)
                    curRespawnDelay = 0;
                std::string curRespawnDelayStr = secsToTimeString(uint64(curRespawnDelay), true);
                std::string defRespawnDelayStr = secsToTimeString(l_Creature->GetRespawnDelay(), true);

                handler->PSendSysMessage(LANG_NPCINFO_CHAR, l_Creature->GetDBTableGUIDLow(), l_Creature->GetGUIDLow(), Entry, faction, displayid, nativeid);

                handler->PSendSysMessage(LANG_NPCINFO_UNIT_NPC_FIELD_FLAGS, l_Creature->GetUInt32Value(UNIT_FIELD_NPC_FLAGS));
                for (uint8 i = 0; i < UNIT_NPC_FLAGS_MAX; ++i)
                    if (l_NpcFlags & unitNPCFlags[i].flags)
                        handler->PSendSysMessage(unitNPCFlags[i].text, unitNPCFlags[i].flags);

                handler->PSendSysMessage(LANG_NPCINFO_UNIT_NPC_FIELD_FLAGS2, l_Creature->GetUInt32Value(UNIT_FIELD_NPC_FLAGS + 1));
                for (uint8 i = 0; i < UNIT_NPC_FLAGS_MAX; ++i)
                    if (l_NpcFlags2 & unitNPCFlags2[i].flags2)
                        handler->PSendSysMessage(unitNPCFlags2[i].text, unitNPCFlags2[i].flags2);

                handler->PSendSysMessage(LANG_NPCINFO_LEVEL, l_Creature->getLevel());
                handler->PSendSysMessage("EquipmentId: %u (Original: %u).", l_Creature->GetCurrentEquipmentId(), l_Creature->GetOriginalEquipmentId());
                handler->PSendSysMessage(LANG_NPCINFO_HEALTH, l_Creature->GetCreateHealth(), l_Creature->GetMaxHealth(), l_Creature->GetHealth());

                handler->PSendSysMessage(LANG_NPCINFO_UNIT_FIELD_FLAGS, l_Creature->GetUInt32Value(UNIT_FIELD_FLAGS));
                for (uint8 i = 0; i < UNIT_FLAGS_MAX; ++i)
                {
                    if (l_Flags & unitFlags[i].flag)
                        handler->PSendSysMessage(unitFlags[i].text, unitFlags[i].flag);
                }

                handler->PSendSysMessage(LANG_NPCINFO_FLAGS, l_Creature->GetUInt32Value(UNIT_FIELD_FLAGS_2), l_Creature->GetUInt32Value(OBJECT_FIELD_DYNAMIC_FLAGS), l_Creature->getFaction());
                handler->PSendSysMessage(LANG_COMMAND_RESPAWNTIMES, defRespawnDelayStr.c_str(), curRespawnDelayStr.c_str());
                handler->PSendSysMessage(LANG_NPCINFO_LOOT, cInfo->lootid, cInfo->pickpocketLootId, cInfo->SkinLootId);
                handler->PSendSysMessage(LANG_NPCINFO_DUNGEON_ID, l_Creature->GetInstanceId());
                handler->PSendSysMessage(LANG_NPCINFO_PHASEMASK, l_Creature->GetPhaseMask());
                handler->PSendSysMessage(LANG_NPCINFO_ARMOR, l_Creature->GetArmor());
                handler->PSendSysMessage(LANG_NPCINFO_INHABITTYPE, cInfo->InhabitType);
                handler->PSendSysMessage(LANG_NPCINFO_POSITION, float(l_Creature->GetPositionX()), float(l_Creature->GetPositionY()), float(l_Creature->GetPositionZ()));
                handler->PSendSysMessage(LANG_NPCINFO_AIINFO, l_Creature->GetAIName().c_str(), l_Creature->GetScriptName().c_str());

                if (ZoneScript* l_ZoneScript  = l_Creature->GetZoneScript())
                    handler->PSendSysMessage("ZoneScript: %s", l_ZoneScript->GetScriptName().c_str());

                if (l_NpcFlags & UNIT_NPC_FLAG_VENDOR)
                    handler->SendSysMessage(LANG_NPCINFO_VENDOR);

                if (l_NpcFlags & UNIT_NPC_FLAG_TRAINER)
                ...
                handler->PSendSysMessage("LinkedID: %s", l_Creature->ComputeLinkedId().c_str());
            }
        ...
        uint32 l_NpcFlags = target->GetUInt32Value(UNIT_FIELD_NPC_FLAGS);
        uint32 l_NpcFlags2 = target->GetUInt32Value(UNIT_FIELD_NPC_FLAGS + 1);
        uint32 l_Flags = target->GetUInt32Value(UNIT_FIELD_FLAGS);
        uint32 mechanicImmuneMask = cInfo->MechanicImmuneMask;
        ...
        handler->PSendSysMessage(LANG_NPCINFO_CHAR,  target->GetDBTableGUIDLow(), target->GetGUIDLow(), Entry, faction, displayid, nativeid);

        handler->PSendSysMessage(LANG_NPCINFO_UNIT_NPC_FIELD_FLAGS, target->GetUInt32Value(UNIT_FIELD_NPC_FLAGS));
        for (uint8 i = 0; i < UNIT_NPC_FLAGS_MAX; ++i)
            if (l_NpcFlags & unitNPCFlags[i].flags)
                handler->PSendSysMessage(unitNPCFlags[i].text, unitNPCFlags[i].flags);

        handler->PSendSysMessage(LANG_NPCINFO_UNIT_NPC_FIELD_FLAGS2, target->GetUInt32Value(UNIT_FIELD_NPC_FLAGS + 1));
        for (uint8 i = 0; i < UNIT_NPC_FLAGS_MAX; ++i)
            if (l_NpcFlags2 & unitNPCFlags2[i].flags2)
                handler->PSendSysMessage(unitNPCFlags2[i].text, unitNPCFlags2[i].flags2);
        ...
        handler->PSendSysMessage("LinkedID: %s", target->ComputeLinkedId().c_str());

        if (ZoneScript* l_ZoneScript = target->GetZoneScript())
            handler->PSendSysMessage("ZoneScript: %s", l_ZoneScript->GetScriptName().c_str());
    ...
    static bool HandleNpcMoveCommand(ChatHandler* handler, const char* args)
    {
        ...
        /// Save only on test servers
        if (sWorld->getIntConfig(CONFIG_REALM_ZONE) == REALM_ZONE_TEST_SERVER)
        {
    ...
    */
    ...
    static bool HandleNpcSetAnimKitCommand(ChatHandler* p_Handler, char const* p_Args)
    {
        ...
        if (!l_Target || !l_Target->GetCreatureData())
        {
        ...
        std::string l_LinkedID = l_Target->GetCreatureData()->linkedId;
        ...
        l_Statement->setString(0, l_LinkedID);
        ...
        if (l_Result)
        {
            ...
            l_Statement->setString(1, l_LinkedID);
        }
        else
        {
