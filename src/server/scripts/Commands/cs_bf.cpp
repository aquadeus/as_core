...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "start",          SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleBattlefieldStart,            "", NULL },
            { "stop",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleBattlefieldEnd,              "", NULL },
            { "switch",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleBattlefieldSwitch,           "", NULL },
            { "timer",          SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleBattlefieldTimer,            "", NULL },
            { "enable",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleBattlefieldEnable,           "", NULL },
            { NULL,             0,                      0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "bf",             SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, NULL,            "", battlefieldcommandTable },
            { NULL,             0,                      0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
