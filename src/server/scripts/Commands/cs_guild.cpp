...
class guild_commandscript: public CommandScript
{
    public:
        ...
        ChatCommand* GetCommands() const
        {
            ...
            {
                { "create",             SEC_GAMEMASTER,         SEC_GAMEMASTER,     true,  &HandleGuildCreateCommand,            "", NULL },
                { "delete",             SEC_GAMEMASTER,         SEC_GAMEMASTER,     true,  &HandleGuildDeleteCommand,            "", NULL },
                { "invite",             SEC_GAMEMASTER,         SEC_GAMEMASTER,     true,  &HandleGuildInviteCommand,            "", NULL },
                { "uninvite",           SEC_GAMEMASTER,         SEC_GAMEMASTER,     true,  &HandleGuildUninviteCommand,          "", NULL },
                { "rank",               SEC_GAMEMASTER,         SEC_GAMEMASTER,     true,  &HandleGuildRankCommand,              "", NULL },
                { "rename",             SEC_GAMEMASTER,         SEC_GAMEMASTER,     true,  &HandleGuildRenameCommand,            "", NULL },
                { "challengecomplete",  SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleGuildChallengeCompleteCommand,   "", NULL },
                { NULL,                 0,                      0,                  false, NULL,                                 "", NULL }
            };
            static ChatCommand commandTable[] =
            {
                { "guild",          SEC_ADMINISTRATOR,          SEC_ADMINISTRATOR,  true, NULL,                                 "", guildCommandTable },
                { NULL,             0,                          0,                  false, NULL,                                "", NULL }
            };
            return commandTable;
        }
        ...
        static bool HandleGuildChallengeCompleteCommand(ChatHandler* handler, char const* args)
        {
            ...
            targetGuild->CompleteGuildChallenge(l_ChallengeType, l_Player);
            return true;
        }
};
