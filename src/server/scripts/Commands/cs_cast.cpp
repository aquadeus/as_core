...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "back",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleCastBackCommand,              "", NULL },
            { "dist",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleCastDistCommand,              "", NULL },
            { "self",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleCastSelfCommand,              "", NULL },
            { "target",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleCastTargetCommad,             "", NULL },
            { "dest",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleCastDestCommand,              "", NULL },
            { "",               SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleCastCommand,                  "", NULL },
            { NULL,             0,                      0,                  false, NULL,                                "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "cast",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, NULL,                                "", castCommandTable },
            { NULL,             0,                      0,                  false, NULL,                                "", NULL }
        };
        return commandTable;
    }
