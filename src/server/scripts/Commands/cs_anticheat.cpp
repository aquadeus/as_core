...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "global",         SEC_GAMEMASTER,     SEC_GAMEMASTER,     true,  &HandleAntiCheatGlobalCommand,           "", NULL },
            { "player",         SEC_GAMEMASTER,     SEC_GAMEMASTER,     true,  &HandleAntiCheatPlayerCommand,           "", NULL },
            { "delete",         SEC_ADMINISTRATOR,  SEC_ADMINISTRATOR,  true,  &HandleAntiCheatDeleteCommand,           "", NULL },
            { "handle",         SEC_ADMINISTRATOR,  SEC_ADMINISTRATOR,  true,  &HandleAntiCheatHandleCommand,           "", NULL },
            { "jail",           SEC_GAMEMASTER,     SEC_GAMEMASTER,     true,  &HandleAnticheatJailCommand,             "", NULL },
            { "warn",           SEC_GAMEMASTER,     SEC_GAMEMASTER,     true,  &HandleAnticheatWarnCommand,             "", NULL },
            { NULL,             0,                  0,                  false, NULL,                                    "", NULL }
        };

        static ChatCommand commandTable[] =
        {
            { "anticheat",      SEC_GAMEMASTER,     SEC_GAMEMASTER,     true,   NULL,                     "",  anticheatCommandTable},
            { NULL,             0,                  0,                  false,  NULL,                     "", NULL }
        };
