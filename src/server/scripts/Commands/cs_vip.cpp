...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "bank",           SEC_PLAYER,         SEC_PLAYER,         false, &HandleVipBankCommand,               "", NULL },
            { "capital",        SEC_PLAYER,         SEC_PLAYER,         false, &HandleVipCapitalCommand,            "", NULL },
            //{ "home",           SEC_PLAYER,         SEC_PLAYER,         false, &HandleVipHomeCommand,               "", NULL },
        ...
        {
            { "vip",            SEC_PLAYER,         SEC_PLAYER,      false, NULL,                                "", vipCommandTable },
            { NULL,             0,                  0,               false, NULL,                                "", NULL }
        };
        return commandTable;
    }
