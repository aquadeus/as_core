...
class gobject_commandscript: public CommandScript
{
    public:
        ...
        ChatCommand* GetCommands() const
        {
            ...
            {
                { "temp",           SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectAddTempCommand,   "", NULL },
                { "",               SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectAddCommand,       "", NULL },
                { NULL,             0,                  0,                  false, NULL,                              "", NULL }
            };
            static ChatCommand gobjectSetCommandTable[] =
            {
                { "phase",          SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectSetPhaseCommand,  "", NULL },
                { "state",          SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectSetStateCommand,  "", NULL },
                { "flags",          SEC_ADMINISTRATOR,  SEC_ADMINISTRATOR,  false, &HandleGameObjectSetFlagsCommand,  "", NULL },
                { "field",          SEC_ADMINISTRATOR,  SEC_ADMINISTRATOR,  false, &HandleGameObjectSetFieldCommand,  "", NULL },
                { "animkit",        SEC_ADMINISTRATOR,  SEC_ADMINISTRATOR,  false, &HandleGameObjectSetAnimKitCommand,"", NULL },
                { "activateanim",   SEC_ADMINISTRATOR,  SEC_ADMINISTRATOR,  false, &HandleGameObjectActivateAnim,     "", NULL },
                { NULL,             0,                  0,                  false, NULL,                              "", NULL }
            };
            static ChatCommand gobjectGetCommandTable[] =
            {
                { "state",          SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectGetStateCommand,  "", NULL },
                { "flags",          SEC_ADMINISTRATOR,  SEC_ADMINISTRATOR,  false, &HandleGameObjectGetFlagsCommand,  "", NULL },
                { NULL,             0,                  0,                  false, NULL,                              "", NULL }
            };
            static ChatCommand gobjectCommandTable[] =
            {
                { "activate",       SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectActivateCommand,  "", NULL },
                { "go",             SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectGoCommand,        "", nullptr },
                { "map_activate",   SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectActivateMapCommand, "", NULL },
                { "delete",         SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectDeleteCommand,    "", NULL },
                { "info",           SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectInfoCommand,      "", NULL },
                { "move",           SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectMoveCommand,      "", NULL },
                { "near",           SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectNearCommand,      "", NULL },
                { "target",         SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectTargetCommand,    "", NULL },
                { "turn",           SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleGameObjectTurnCommand,      "", NULL },
                { "bindportal",     SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleBindPortalCommand,          "", NULL },
                { "damage",         SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleDamageObjectCommand,        "", NULL },
                { "add",            SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, NULL,            "", gobjectAddCommandTable },
                { "set",            SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, NULL,            "", gobjectSetCommandTable },
                { "get",            SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, NULL,            "", gobjectGetCommandTable },
                { NULL,             0,                  0,                  false, NULL,                              "", NULL }
            };
            static ChatCommand commandTable[] =
            {
                { "gobject",        SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, NULL,                "", gobjectCommandTable },
                { NULL,             0,                  0,                  false, NULL,                               "", NULL }
            };
            return commandTable;
        }
        ...
        static bool HandleGameObjectActivateCommand(ChatHandler* handler, char const* args)
        {
            ...
            if (object->IsTransport())
                object->SetGoState(object->GetGoState() == GOState::GO_STATE_TRANSPORT_ACTIVE ? GOState::GO_STATE_TRANSPORT_STOPPED : GOState::GO_STATE_TRANSPORT_ACTIVE);
            else
            {
        ...
        static bool HandleGameObjectGoCommand(ChatHandler* handler, char const* args)
        {
            Player* l_Player = handler->GetSession()->GetPlayer();
            uint32 l_Guid = GetGuidLowFromArgsOrLastTargetedGo(handler, args);
            if (!l_Guid || !l_Player)
                return false;
            ...
            float z = 0.0f;
            float ort = 0.0f;
            uint32 mapId = l_Player->GetMapId();

            GameObject* l_Go = NULL;
            if (GameObjectData const* goData = sObjectMgr->GetGOData(l_Guid))
                l_Go = handler->GetObjectGlobalyWithGuidOrNearWithDbGuid(l_Guid, goData->id);
            ...
            l_Player->TeleportTo(mapId, x, y, z, ort);
            return true;
        }
        ...
        static bool HandleGameObjectAddCommand(ChatHandler* handler, char const* args)
        {
            ...
            /// Disable .gob add for transports
            if (objectInfo->type == GAMEOBJECT_TYPE_TRANSPORT || objectInfo->type == GAMEOBJECT_TYPE_MAP_OBJ_TRANSPORT)
            {
                handler->PSendSysMessage("You cannot spawn a gameobject of type TRANSPORT!");
                return false;
            }
