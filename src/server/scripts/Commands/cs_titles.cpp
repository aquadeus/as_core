...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "mask",           SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleTitlesSetMaskCommand,        "", NULL },
            { NULL,             0,                  0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand titlesCommandTable[] =
        {
            { "add",            SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleTitlesAddCommand,            "", NULL },
            { "current",        SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleTitlesCurrentCommand,        "", NULL },
            { "remove",         SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, &HandleTitlesRemoveCommand,         "", NULL },
            { "set",            SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, NULL,              "", titlesSetCommandTable },
            { NULL,             0,                  0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "titles",         SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, NULL,                 "", titlesCommandTable },
            { NULL,             0,                  0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
    ...
    static bool HandleTitlesCurrentCommand(ChatHandler* handler, const char* args)
    {
        ...
        handler->PSendSysMessage(LANG_TITLE_CURRENT_RES, id, titleInfo->NameMale->Get(sWorld->GetDefaultDb2Locale()), tNameLink.c_str());
    ...
    static bool HandleTitlesAddCommand(ChatHandler* handler, const char* args)
    {
        ...
        snprintf(titleNameStr, 80, titleInfo->NameMale->Get(sWorld->GetDefaultDb2Locale()), targetName);
