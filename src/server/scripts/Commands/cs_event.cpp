...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "activelist",     SEC_GAMEMASTER,     SEC_GAMEMASTER,     true,  &HandleEventActiveListCommand,     "", NULL },
            { "start",          SEC_GAMEMASTER,     SEC_GAMEMASTER,     true,  &HandleEventStartCommand,          "", NULL },
            { "stop",           SEC_GAMEMASTER,     SEC_GAMEMASTER,     true,  &HandleEventStopCommand,           "", NULL },
            { "",               SEC_GAMEMASTER,     SEC_GAMEMASTER,     true,  &HandleEventInfoCommand,           "", NULL },
            { NULL,             0,                  0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "event",          SEC_GAMEMASTER,     SEC_GAMEMASTER,     false, NULL,                  "", eventCommandTable },
            { NULL,             0,                  0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
