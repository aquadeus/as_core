...
class hotfix_commandscript : public CommandScript
{
    public:
        ...
        ChatCommand * GetCommands() const
        {
            ...
            {
                { "blob",       SEC_GAMEMASTER,     SEC_GAMEMASTER, true,   &HandleReloadBlob,          "", NULL                },
                { "hash",       SEC_GAMEMASTER,     SEC_GAMEMASTER, true,   &HandleReloadHash,          "", NULL                },
                { "store",      SEC_GAMEMASTER,     SEC_GAMEMASTER, true,   &HandleReloadStore,         "", NULL                },
                { NULL,         0,                  0,              false,  NULL,                       "", NULL                }
            };

            static ChatCommand hotfixCommandTable[] =
            {
                { "reload",     SEC_GAMEMASTER,     SEC_GAMEMASTER, true,   NULL,                       "", reloadCommandTable  },
                { NULL,         0,                  0,              false,  NULL,                       "", NULL                }
            };

            static ChatCommand commandTable[] =
            {
                { "hotfix",     SEC_GAMEMASTER,     SEC_GAMEMASTER, false,  NULL,                       "", hotfixCommandTable  },
                { NULL,         0,                  0,              false,  NULL,                       "", NULL                }
            };
            return commandTable;
        }
