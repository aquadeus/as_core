...
class cheat_commandscript: public CommandScript
{
    public:
        ...
        ChatCommand* GetCommands() const
        {
            ...
            {
                { "god",        SEC_GAMEMASTER,     SEC_GAMEMASTER, false, &HandleGodModeCheatCommand,      "", NULL },
                { "casttime",   SEC_GAMEMASTER,     SEC_GAMEMASTER, false, &HandleCasttimeCheatCommand,     "", NULL },
                { "cooldown",   SEC_GAMEMASTER,     SEC_GAMEMASTER, false, &HandleCoolDownCheatCommand,     "", NULL },
                { "power",      SEC_GAMEMASTER,     SEC_GAMEMASTER, false, &HandlePowerCheatCommand,        "", NULL },
                { "waterwalk",  SEC_GAMEMASTER,     SEC_GAMEMASTER, false, &HandleWaterWalkCheatCommand,    "", NULL },
                { "status",     SEC_GAMEMASTER,     SEC_GAMEMASTER, false, &HandleCheatStatusCommand,       "", NULL },
                { "taxi",       SEC_GAMEMASTER,     SEC_GAMEMASTER, false, &HandleTaxiCheatCommand,         "", NULL },
                { "explore",    SEC_GAMEMASTER,     SEC_GAMEMASTER, false, &HandleExploreCheatCommand,      "", NULL },
                { "all",        SEC_GAMEMASTER,     SEC_GAMEMASTER, false, &HandleAllSpellCheatCommand,     "", NULL },
                { "nodr",       SEC_GAMEMASTER,     SEC_GAMEMASTER, false, &HandleNodrCheatCommand,         "", NULL },
            ...
            {
                { "cheat",  SEC_GAMEMASTER,         SEC_GAMEMASTER, false, NULL, "", cheatCommandTable },
                { NULL,     0,                      0,              false, NULL, "", NULL }
            };
            return commandTable;
        }
