...
class note_commandscript: public CommandScript
{
    public:
        ...
        ChatCommand* GetCommands() const
        {
            ...
            {
                { "write",          SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleAddNoteAccountCommand,    "", NULL },
                { "list",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  &HandleListNoteAccountCommand,   "", NULL },
                { NULL,             0,                      0,                  false, NULL,                            "", NULL }
            };
            static ChatCommand l_CommandTable[] =
            {
                { "note",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,  NULL,                            "", l_Notetable },
                { NULL,             0,                      0,                  false, NULL,                            "", NULL }
            };
