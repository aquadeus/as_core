...
class misc_commandscript: public CommandScript
{
    public:
        ...
        ChatCommand* GetCommands() const
        {
            ...
            {
                { "add",                SEC_MODERATOR,          SEC_MODERATOR,      true,  &HandleBadwordAddCommand,    "", NULL },
                { "remove",             SEC_MODERATOR,          SEC_MODERATOR,      true,  &HandleBadwordRemoveCommand, "", NULL },
                { NULL,                 0,                      0,                  false, NULL,                        "", NULL }
            };
            static ChatCommand groupCommandTable[] =
            {
                { "leader",             SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleGroupLeaderCommand,   "", NULL },
                { "disband",            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleGroupDisbandCommand,  "", NULL },
                { "remove",             SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false, &HandleGroupRemoveCommand,   "", NULL },
                { NULL,                 0,                      0,                  false, NULL,                        "", NULL }
            };
            static ChatCommand petCommandTable[] =
            {
                { "create",             SEC_GAMEMASTER,         SEC_GAMEMASTER,     false, &HandleCreatePetCommand,         "", NULL },
                { "learn",              SEC_GAMEMASTER,         SEC_GAMEMASTER,     false, &HandlePetLearnCommand,          "", NULL },
                { "unlearn",            SEC_GAMEMASTER,         SEC_GAMEMASTER,     false, &HandlePetUnlearnCommand,        "", NULL },
                { NULL,                 0,                      0,                  false, NULL,                            "", NULL }
            };
            static ChatCommand sendCommandTable[] =
            {
#ifndef CROSS
                { "items",              SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true, &HandleSendItemsCommand,          "", NULL },
                { "mail",               SEC_MODERATOR,          SEC_MODERATOR,      true, &HandleSendMailCommand,           "", NULL },
#endif /* not CROSS */
                { "message",            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true, &HandleSendMessageCommand,        "", NULL },
#ifndef CROSS
                { "money",              SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true, &HandleSendMoneyCommand,          "", NULL },
#endif /* not CROSS */
                { NULL,                 0,                      0,                  false, NULL,                            "", NULL }
            };
            static ChatCommand auraCommandTable[] =
            {
                { "duration",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,   &HandleAuraDurationCommand,     "", NULL },
                { "charges",            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,   &HandleAuraChargesCommand,      "", NULL },
                { "",                   SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,   &HandleAuraCommand,             "", NULL },
                { NULL,                 0,                      0,                  false,  NULL,                           "", NULL }
            };
#ifdef CROSS
            ...
            {
                { "fsccreate",          SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                { "fscupdate",          SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                { "fscappend",          SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                { "fscend",             SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                { "fscdelete",          SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                { "fscticketget",       SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                { "fscticketres",       SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                { NULL,                 0,                      0,                  false,  NULL,                           "", NULL },
            };
            ...
            {
                { "dev",                SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleDevCommand,              "", NULL },
                { "gps",                SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleGPSCommand,              "", NULL },
                { "aura",               SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  NULL,                           "", auraCommandTable },
                { "auraplayer",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleAuraPlayerCommand,       "", NULL },
                { "unaura",             SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleUnAuraCommand,           "", NULL },
                { "unauraplayer",       SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleUnAuraPlayerCommand,     "", NULL },
                { "appear",             SEC_MODERATOR,          SEC_MODERATOR,      false,  &HandleAppearCommand,           "", NULL },
                { "summon",             SEC_MODERATOR,          SEC_MODERATOR,      false,  &HandleSummonCommand,           "", NULL },
                { "groupsummon",        SEC_MODERATOR,          SEC_MODERATOR,      false,  &HandleGroupSummonCommand,      "", NULL },
                { "commands",           SEC_PLAYER,             SEC_PLAYER,         true,   &HandleCommandsCommand,         "", NULL },
                { "die",                SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleDieCommand,              "", NULL },
                { "dieplayer",          SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleDiePlayerCommand,        "", NULL }, 
                { "fsdie",              SEC_PLAYER,             SEC_PLAYER,         false,  &HandleFSDieCommand,            "", NULL },
                { "revive",             SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  true,   &HandleReviveCommand,           "", NULL },
                { "dismount",           SEC_PLAYER,             SEC_PLAYER,         false,  &HandleDismountCommand,         "", NULL },
                { "guid",               SEC_GAMEMASTER,         SEC_GAMEMASTER,     false,  &HandleGUIDCommand,             "", NULL },
                { "help",               SEC_PLAYER,             SEC_PLAYER,         true,   &HandleHelpCommand,             "", NULL },
                { "itemmove",           SEC_GAMEMASTER,         SEC_GAMEMASTER,     false,  &HandleItemMoveCommand,         "", NULL },
                { "cooldown",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleCooldownCommand,         "", NULL },
                { "distance",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleGetDistanceCommand,      "", NULL },
                { "recall",             SEC_MODERATOR,          SEC_MODERATOR,      false,  &HandleRecallCommand,           "", NULL },
                { "save",               SEC_PLAYER,             SEC_PLAYER,         false,  &HandleSaveCommand,             "", NULL },
                { "saveall",            SEC_MODERATOR,          SEC_MODERATOR,      true,   &HandleSaveAllCommand,          "", NULL },
                { "kick",               SEC_GAMEMASTER,         SEC_GAMEMASTER,     true,   &HandleKickPlayerCommand,       "", NULL },
                { "start",              SEC_PLAYER,             SEC_PLAYER,         false,  &HandleStartCommand,            "", NULL },
                { "linkgrave",          SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleLinkGraveCommand,        "", NULL },
                { "neargrave",          SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleNearGraveCommand,        "", NULL },
                { "showarea",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleShowAreaCommand,         "", NULL },
                { "hidearea",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleHideAreaCommand,         "", NULL },
                { "additem",            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleAddItemCommand,          "", NULL },
                { "additemset",         SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleAddItemSetCommand,       "", NULL },
                { "addequipitem",       SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleAddEquipItemCommand,     "", NULL },
                { "bank",               SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleBankCommand,             "", NULL },
                { "wchange",            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleChangeWeather,           "", NULL },
                { "setskill",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleSetSkillCommand,         "", NULL },
                { "pinfo",              SEC_GAMEMASTER,         SEC_GAMEMASTER,     true,   &HandlePInfoCommand,            "", NULL },
                { "pmoney",             SEC_GAMEMASTER,         SEC_GAMEMASTER,     true,   &HandlePMoneyCommand,           "", NULL },

                { "respawn",            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleRespawnCommand,          "", NULL },
                { "send",               SEC_MODERATOR,          SEC_MODERATOR,      true,   NULL,                           "", sendCommandTable },
                { "pet",                SEC_GAMEMASTER,         SEC_GAMEMASTER,     false,  NULL,                           "", petCommandTable },
                { "mute",               SEC_MODERATOR,          SEC_MODERATOR,      true,   &HandleMuteCommand,             "", NULL },
                { "unmute",             SEC_MODERATOR,          SEC_MODERATOR,      true,   &HandleUnmuteCommand,           "", NULL },
                { "movegens",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleMovegensCommand,         "", NULL },
                { "cometome",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleComeToMeCommand,         "", NULL },
                { "damage",             SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleDamageCommand,           "", NULL },
                { "damagepct",          SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleDamagePctCommand,        "", NULL },
                { "heal",               SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleDebugHealCommand,        "", NULL },
                { "combatstop",         SEC_GAMEMASTER,         SEC_GAMEMASTER,     true,   &HandleCombatStopCommand,       "", NULL },
                { "flusharenapoints",   SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleFlushArenaPointsCommand, "", NULL },
                { "repairitems",        SEC_GAMEMASTER,         SEC_GAMEMASTER,     true,   &HandleRepairitemsCommand,      "", NULL },
                { "freeze",             SEC_MODERATOR,          SEC_MODERATOR,      false,  &HandleFreezeCommand,           "", NULL },
                { "unfreeze",           SEC_MODERATOR,          SEC_MODERATOR,      false,  &HandleUnFreezeCommand,         "", NULL },
                { "listfreeze",         SEC_MODERATOR,          SEC_MODERATOR,      false,  &HandleListFreezeCommand,       "", NULL },
                { "group",              SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  NULL,                           "", groupCommandTable },
                { "possess",            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandlePossessCommand,          "", NULL },
                { "unpossess",          SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleUnPossessCommand,        "", NULL },
                { "bindsight",          SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleBindSightCommand,        "", NULL },
                { "unbindsight",        SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleUnbindSightCommand,      "", NULL },
                { "playall",            SEC_GAMEMASTER,         SEC_GAMEMASTER,     false,  &HandlePlayAllCommand,          "", NULL },
                { "selectfaction",      SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleSelectFactionCommand,    "", NULL },
                { "wargame",            SEC_GAMEMASTER,         SEC_GAMEMASTER,     false,  &HandleWargameCommand,          "", NULL },
                { "chatfilter",         SEC_PLAYER,             SEC_PLAYER,         false,  &HandleToggleChatFiltering,     "", NULL },
                { "initlfg",            SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,  false,  &HandleInitializeLFGCommand,    "", NULL },
                { "badword",            SEC_CONSOLE,            SEC_CONSOLE,        true,   NULL,                           "", badwordCommandTable },
                { "solo1v1",            SEC_GAMEMASTER,         SEC_GAMEMASTER,     false,  &HandleSoloQueue1v1Command,     "", NULL },
                { "dosome",             SEC_GAMEMASTER,         SEC_GAMEMASTER,     false,  &HandleDoSomeTestCommand,       "", NULL },
                { "auralist",           SEC_PLAYER,             SEC_PLAYER,         false,  &HandleAuraListCommand,         "", NULL },
#ifdef CROSS
                { "fsccreate",          SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                { "fscupdate",          SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                { "fscappend",          SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                ...
                { "fscticketget",       SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                { "fscticketres",       SEC_PLAYER,             SEC_PLAYER,         true,   &HandlePlaceHolderCommand,      "", NULL },
                { "ticket",             SEC_PLAYER,             SEC_PLAYER,         false,    NULL,                         "", ticketCommandTable },
#endif /* CROSS */
                { NULL,                 0,                      0,                  false,  NULL,                           "", NULL }
            };
            return commandTable;
        ...
        static bool HandleWargameCommand(ChatHandler* p_Handler, char const* p_Args)
        {
            ...
            */
            ...
            GroupPtr l_FirstGroup = l_FirstLeader->GetGroup();
            ...
            GroupPtr l_SecondGroup = l_SecondLeader->GetGroup();
            ...
            l_FirstGroup->GetMemberSlots().foreach([&](Group::MemberSlotPtr l_Itr) -> void
            {
            ...
            l_SecondGroup->GetMemberSlots().foreach([&](Group::MemberSlotPtr l_Itr) -> void
            {
                Player* l_Member = l_Itr->player;
                if (!l_Member)
                    return;
        ...
        static bool HandleSoloQueue1v1Command(ChatHandler* p_Handler, char const* p_Args)
        {
#ifndef CROSS
            ...
            if (l_Player->GetRoleBySpecializationId(l_Player->GetActiveSpecializationID()) != Roles::ROLE_DAMAGE)
            {
                p_Handler->PSendSysMessage("Healers and tanks can't queue in 1v1, you need to change your specialization.");
                return true;
            }

            ArenaType l_ArenaType = ArenaType::Arena1v1;

            bool l_Skirmish = p_Args != nullptr;

            Battleground* l_BG = sBattlegroundMgr->GetBattlegroundTemplate(MS::Battlegrounds::BattlegroundType::Arena1v1);
            if (!l_BG)
            {
                p_Handler->PSendSysMessage("Battleground: template BG for All Arenas not found.");
                return true;
            ...
            if (l_InterRealmEnable)
            {
                ...
                {
                    p_Handler->PSendSysMessage(LANG_INTERREALM_DISABLED);
                    return true;
                }
            }
            ...
            if (!l_InterRealmEnable)
            {
                ...
                // send status packet (in queue)
                MS::Battlegrounds::PacketFactory::Status(&l_Data, l_BG, l_Player, l_QueueSlot, STATUS_WAIT_QUEUE, l_AverageTime, 0, l_ArenaType, l_Skirmish);
        ...
        static bool HandleGPSCommand(ChatHandler* handler, char const* args)
        {
            ...
            handler->PSendSysMessage(LANG_MAP_POSITION,
                object->GetMapId(), (mapEntry ? mapEntry->MapNameLang->Get(sWorld->GetDefaultDb2Locale()) : "<unknown>"),
                zoneId, (zoneEntry ? zoneEntry->AreaNameLang->Get(sWorld->GetDefaultDb2Locale()) : "<unknown>"),
                areaId, (areaEntry ? areaEntry->AreaNameLang->Get(sWorld->GetDefaultDb2Locale()) : "<unknown>"),
                object->GetPhaseMask(),
                object->GetPositionX(), object->GetPositionY(), object->GetPositionZ(), object->GetOrientation(),
                cell.GridX(), cell.GridY(), cell.CellX(), cell.CellY(), object->GetInstanceId(),
                zoneX, zoneY, groundZ, floorZ, haveMap, haveVMap);

            handler->PSendSysMessage("Diffyculty %i spawnmask %i vmapZ %f GetPositionH %f GetPositionZH %f", map->GetDifficultyID(), map->GetSpawnMode(), vmapZ, object->GetPositionH(), object->GetPositionZH());
            ...
            if (!phases.empty())
            {
                ...
                handler->PSendSysMessage("Object Phases: %s", ss.str().c_str());
            }
        ...
        static bool HandleAuraPlayerCommand(ChatHandler* p_Handler, char const* p_Args)
        {
            char* l_SpellIDChar = strtok((char*)p_Args, " ");
            char* l_PlayerGUIDChar = strtok(nullptr, " ");
            if (!l_SpellIDChar || !l_PlayerGUIDChar)
                return false;

            uint32 l_SpellID = atoi(l_SpellIDChar);
            SpellInfo const* l_SpellInfo = sSpellMgr->GetSpellInfo(l_SpellID);
            if (!l_SpellInfo)
            {
                p_Handler->PSendSysMessage("Incorrect Spell ID");
                return false;
            }
            ...
            uint32 l_ParseGuid = MAKE_NEW_GUID(atol((char*)p_Args), 0, HIGHGUID_PLAYER);
            if (sObjectMgr->GetPlayerNameByGUID(l_ParseGuid, l_TargetName))
            {
                l_Target = sObjectMgr->GetPlayerByLowGUID(l_ParseGuid);
                l_TargetGuid = l_ParseGuid;
            }
            else if (!p_Handler->extractPlayerTarget(l_PlayerGUIDChar, &l_Target, &l_TargetGuid, &l_TargetName))
                return false;

            if (!l_Target || !l_Target->IsSelfOrInSameMap(l_Player))
            {
                p_Handler->PSendSysMessage("Player GUID " UI64FMTD " wasn't found on your map.", atoul(l_PlayerGUIDChar));
                return false;
            }

            if (p_Handler->HasLowerSecurity(NULL, l_TargetGuid))
                return false;

            Aura::TryRefreshStackOrCreate(l_SpellInfo, MAX_EFFECT_MASK, l_Target, l_Target);
        ...
        static bool HandleUnAuraPlayerCommand(ChatHandler* p_Handler, char const* p_Args)
        {
            char* l_SpellIDChar = strtok((char*)p_Args, " ");
            char* l_PlayerGUIDChar = strtok(nullptr, " ");
            if (!l_SpellIDChar || !l_PlayerGUIDChar)
...
# ifndef CROSS
            bool l_IsOnCrossRealm = false;
            if (Player* l_TargetPlayer = sObjectAccessor->FindPlayerInOrOutOfWorld(targetGuid))
            {
                if (l_TargetPlayer->GetSession()->GetInterRealmBG())
                    l_IsOnCrossRealm = true;
            }
            ...
            if (l_IsOnCrossRealm)
            {
                ...
                if (InterRealmSession* l_InterRealmSession = sWorld->GetInterRealmSession())
                    l_InterRealmSession->SendAppearRequest(_player, targetGuid);
...
# endif
            ...
            if (target)
            {
                ...
                else if (map->IsDungeon())
                {
                    ...
                    InstancePlayerBindPtr bind = _player->GetBoundInstance(target->GetMapId(), target->GetDifficultyID(map->GetEntry()));
                    if (!bind)
                    {
                        GroupPtr group = _player->GetGroup();
                        // if no bind exists, create a solo bind
                        InstanceGroupBindPtr gBind = group ? group->GetBoundInstance(target) : nullptr;                // if no bind exists, create a solo bind
                        if (!gBind)
                        if (InstanceSavePtr save = sInstanceSaveMgr->GetInstanceSave(target->GetInstanceId()))
                            _player->BindToInstance(save, !save->CanReset(), BindExtensionState::EXTEND_STATE_NORMAL);
                    }
                ...
                _player->SetAppearZoneInstanceId(target->GetMap()->GetInstanceZoneId() ? target->GetMap()->GetInstanceZoneId() : target->GetMap()->GetInstanceId());
...
# ifndef CROSS
            bool l_IsOnCrossRealm = false;
            if (Player* l_PlayerTarget = sObjectAccessor->FindPlayerInOrOutOfWorld(targetGuid))
            {
                if (l_PlayerTarget->GetSession()->GetInterRealmBG())
                    l_IsOnCrossRealm = true;
            }
            ...
            if (l_IsOnCrossRealm)
            {
                if (InterRealmSession* l_IRSession = sWorld->GetInterRealmSession())
                    l_IRSession->SendSummonPlayer(targetGuid, *_player);
            ...
            if (target)
            {
                ...
                uint32 l_MapId = handler->GetSession()->GetPlayer()->GetMapId();
                float l_O = target->GetOrientation();
                uint32 l_PhaseMask = handler->GetSession()->GetPlayer()->GetPhaseMask();

                target->AddCriticalOperation([target, x, y, z, l_O, l_MapId, l_PhaseMask]() -> void
                {
                    // stop flight if need
                    ...
                    target->TeleportTo(l_MapId, x, y, z, l_O);
                    target->SetPhaseMask(l_PhaseMask, true);
                });
            }
            else
            {
        ...
        static bool HandleGroupSummonCommand(ChatHandler* handler, char const* args)
        {
            ...
            group->GetMemberSlots().foreach_until([&](Group::MemberSlotPtr l_Member) -> bool
            {
        ...
        static bool HandleDiePlayerCommand(ChatHandler* p_Handler, char const* p_Args)
        {
            char* l_PlayerGUIDChar = strtok((char*)p_Args, " ");
            if (!l_PlayerGUIDChar)
                return false;
            ...
            {
                if (sWorld->getBoolConfig(CONFIG_DIE_COMMAND_MODE))
                    p_Handler->GetSession()->GetPlayer()->Kill(l_Target);
                else
                    p_Handler->GetSession()->GetPlayer()->DealDamage(l_Target, l_Target->GetHealth(), nullptr, DIRECT_DAMAGE, SPELL_SCHOOL_MASK_NORMAL, nullptr, false);
            }

            return true;
        }

        static bool HandleFSDieCommand(ChatHandler* handler, char const* /*args*/)
        {
            ...
            if (player->isDead() || player->GetUInt32Value(PlayerFlags::PLAYER_FLAGS_GHOST))
            {
        ...
        static bool HandleReviveCommand(ChatHandler* handler, char const* args)
        {
            ...
            if (target)
            {
                target->AddCriticalOperation([target]()->void
                {
        ...
        static bool HandleCooldownCommand(ChatHandler* p_Handler, char const* p_Args)
        {
            ...
            std::string l_NameLink;
            Player* l_PlayerTarget = l_Target->ToPlayer();
            if (l_PlayerTarget)
                l_NameLink = p_Handler->GetNameLink(l_PlayerTarget);

            Pet* l_PetTarget;
            if (!l_PlayerTarget)
                l_PetTarget = l_Target->ToPet();

            if (!*p_Args)
            {
                if (l_PlayerTarget)
                {
                    l_PlayerTarget->RemoveAllSpellCooldown();
                    l_PlayerTarget->ResetAllCharges();
                    p_Handler->PSendSysMessage(LANG_REMOVEALL_COOLDOWN, l_NameLink.c_str());
                }
                else if (l_PetTarget)
                    l_PetTarget->m_CreatureSpellCooldowns.clear();
            }
            else if (l_PlayerTarget)
            {
                /// Number or [name] Shift-click form |color|Hspell:spell_id|h[name]|h|r or Htalent form
                ...
                l_PlayerTarget->RemoveSpellCooldown(l_SpellID, true);
                l_PlayerTarget->ResetCharges(l_SpellInfo->ChargeCategoryEntry);
        ...
        {
            return HandleAddItemCommand(p_Handler, p_Args, nullptr);
        }

        static bool HandleAddItemCommand(ChatHandler* p_Handler, char const* p_Args, ItemPosCount* p_Dest)
        {
            if (!*p_Args)
                return false;

            std::vector<uint32> l_Bonuses;
            std::string LinkArgs = p_Args;
            uint32 l_ItemID = p_Handler->GetItemIDAndBonusesFromLink((char*)p_Args, l_Bonuses);
            ...
            char const* l_BonusStr = strtok(nullptr, " ");
            if (l_Bonuses.empty() && l_BonusStr)
            {
                do
                {
                    l_Bonuses.push_back(strtol(l_BonusStr, nullptr, 10));
                    l_BonusStr = strtok(nullptr, " ");
                }
                while (l_BonusStr);
            }
            ...
            if (l_Count == 0)
            {
                char const* l_SecondCCount;

                do
                {
                    l_SecondCCount = strtok(nullptr, " ");
                    if (l_SecondCCount)
                        l_Count = strtol(l_SecondCCount, nullptr, 10);
                }
                while (l_SecondCCount);
            }
            ...
            Item* l_Item = l_PlayerTarget->StoreNewItem(l_Dest, l_ItemID, true, Item::GenerateItemRandomPropertyId(l_ItemID), l_Bonuses);
            if (l_Item && p_Dest && l_Dest.size() == 1 && l_Dest[0].count == 1)
            {
                p_Dest->pos = l_Dest[0].pos;
                p_Dest->count = l_Dest[0].count;
            }
        ...
        static bool HandleAddEquipItemCommand(ChatHandler* p_Handler, char const* p_Args)
        {
            ItemPosCount* l_Dest = new ItemPosCount(0,0);

            if (!HandleAddItemCommand(p_Handler, p_Args, l_Dest))
                return false;

            uint8 l_Bag = l_Dest->pos >> 8;
            uint8 l_Slot = l_Dest->pos & 255;
            ...
            p_Handler->GetSession()->HandleAutoEquipItemOpcode(p_Data);
        ...
        static bool HandleSetSkillCommand(ChatHandler* handler, char const* args)
        {
            ...
            {
                handler->PSendSysMessage(LANG_SET_SKILL_ERROR, tNameLink.c_str(), skill, skillLine->DisplayName);
                handler->SetSentErrorMessage(true);
                return false;
            }
            ...
            handler->PSendSysMessage(LANG_SET_SKILL, skill, skillLine->DisplayName, tNameLink.c_str(), level, max);
        ...
        static bool HandlePInfoCommand(ChatHandler* handler, char const* args)
        {
            ...
            Player* l_Player = handler->GetSession()->GetPlayer();
            if (!l_Player)
                return false;
            ...
            uint32 l_AccountId = handler->GetSession()->GetAccountId();
            uint64 l_PlayerGuid = l_Player->GetGUID();

            CharacterDatabase.AsyncQuery(stmt, l_Player->GetQueryCallbackMgr(), [targetName, targetGuid, l_AccountId, l_PlayerGuid](PreparedQueryResult const& p_Result)
            {
                if (!p_Result)
                    return;

                Player* l_Target = sObjectAccessor->FindPlayerInOrOutOfWorld(targetGuid);

                PlayerInfoQuery* l_PlayerInfo = new PlayerInfoQuery();

                Field* fields = p_Result->Fetch();
                l_PlayerInfo->totalPlayerTime = fields[0].GetUInt32();
                l_PlayerInfo->level           = fields[1].GetUInt8();
                l_PlayerInfo->money           = fields[2].GetUInt64();
                l_PlayerInfo->accId           = fields[3].GetUInt32();
                l_PlayerInfo->race            = fields[4].GetUInt8();
                l_PlayerInfo->Class           = fields[5].GetUInt8();
                l_PlayerInfo->mapId           = fields[6].GetUInt16();
                l_PlayerInfo->areaId          = fields[7].GetUInt16();

                /// If the player is online, use last data instead old db ones
                if (l_Target)
                {
                    l_PlayerInfo->accId           = l_Target->GetSession()->GetAccountId();
                    l_PlayerInfo->money           = l_Target->GetMoney();
                    l_PlayerInfo->totalPlayerTime = l_Target->GetTotalPlayedTime();
                    l_PlayerInfo->level           = l_Target->getLevel();
                    l_PlayerInfo->latency         = l_Target->GetSession()->GetLatency();
                    l_PlayerInfo->race            = l_Target->getRace();
                    l_PlayerInfo->Class           = l_Target->getClass();
                    l_PlayerInfo->muteTime        = l_Target->GetSession()->m_muteTime;
                    l_PlayerInfo->mapId           = l_Target->GetMapId();
                    l_PlayerInfo->areaId          = l_Target->GetAreaId();
                    l_PlayerInfo->phase           = l_Target->GetPhaseMask();

                    if (auto l_Garr = l_Target->GetGarrison())
                        l_PlayerInfo->GarrisonID = l_Garr->GetGarrisonID();
                }
                ...
                PreparedStatement* l_Stmt = LoginDatabase.GetPreparedStatement(LOGIN_SEL_LAST_ACCOUNT_NOTE);
                l_Stmt->setUInt32(0, l_PlayerInfo->accId);
                LoginDatabase.AsyncQuery(l_Stmt, l_Player->GetQueryCallbackMgr(), [targetName, targetGuid, l_PlayerInfo, l_AccountId](PreparedQueryResult const& p_Result)
                {
                    if (p_Result)
                    {
                        do
                        {
                            ...
                            if (!l_Fields[3].GetCString()) ///< Notedby column cannot be null
                                return;

                            l_PlayerInfo->LastNoteTime = std::to_string(1900 + l_Tm->tm_year) + "-" + std::to_string(l_Tm->tm_mon + 1) + "-" + std::to_string(l_Tm->tm_mday) + " " + std::to_string(l_Tm->tm_hour) + ":" + std::to_string(l_Tm->tm_min) + " by " + l_Fields[3].GetCString();
                            l_PlayerInfo->LastNote = l_Fields[1].GetCString();
                        }
                        while (p_Result->NextRow());
                    }

                    WorldSession* l_Session = sWorld->FindSession(l_AccountId);
                    if (!l_Session || !l_Session->GetPlayer())
                    {
                        delete l_PlayerInfo;
                        return;
                    }

                    l_PlayerInfo->userName  = ChatHandler(l_Session).GetTrinityString(LANG_ERROR);
                    l_PlayerInfo->eMail     = ChatHandler(l_Session).GetTrinityString(LANG_ERROR);
                    l_PlayerInfo->lastIp    = ChatHandler(l_Session).GetTrinityString(LANG_ERROR);
                    l_PlayerInfo->security  = 0;
                    l_PlayerInfo->lastLogin = ChatHandler(l_Session).GetTrinityString(LANG_ERROR);

                    PreparedStatement* stmt = LoginDatabase.GetPreparedStatement(LOGIN_SEL_PINFO);
                    stmt->setInt32(0, int32(g_RealmID));
                    stmt->setUInt32(1, l_PlayerInfo->accId);

                    LoginDatabase.AsyncQuery(stmt, l_Session->GetPlayer()->GetQueryCallbackMgr(), [targetName, targetGuid, l_PlayerInfo, l_AccountId](PreparedQueryResult const& p_Result)
                    {
                        WorldSession* l_Session = sWorld->FindSession(l_AccountId);
                        if (!l_Session || !l_Session->GetPlayer())
                        {
                        ...
                        {
                            Field* fields = p_Result->Fetch();
                            l_PlayerInfo->userName = fields[0].GetString();
                            l_PlayerInfo->security = fields[1].GetUInt8();
                            l_PlayerInfo->eMail = fields[2].GetString();
                            l_PlayerInfo->muteTime = fields[5].GetUInt64();

                            if (l_PlayerInfo->eMail.empty())
                                l_PlayerInfo->eMail = "-";

                            if (!l_Session || l_Session->GetSecurity() >= AccountTypes(l_PlayerInfo->security))
                            {
                                l_PlayerInfo->lastIp = fields[3].GetString();
                                l_PlayerInfo->lastLogin = fields[4].GetString();
                            }
                            else
                            {
                                l_PlayerInfo->lastIp = "-";
                                l_PlayerInfo->lastLogin = "-";
                            }
                        }

                        std::string nameLink = ChatHandler(l_Session).playerLink(targetName);

                        Player* l_Target = sObjectAccessor->FindPlayerInOrOutOfWorld(targetGuid);

                        ChatHandler(l_Session).PSendSysMessage(LANG_PINFO_ACCOUNT, (l_Target ? "" : ChatHandler(l_Session).GetTrinityString(LANG_OFFLINE)), nameLink.c_str(), GUID_LOPART(targetGuid), l_PlayerInfo->userName.c_str(), l_PlayerInfo->accId, l_PlayerInfo->eMail.c_str(), l_PlayerInfo->security, l_PlayerInfo->lastIp.c_str(), l_PlayerInfo->lastLogin.c_str(), l_PlayerInfo->latency);

                        PreparedStatement* stmt = LoginDatabase.GetPreparedStatement(LOGIN_SEL_PINFO_BANS);
                        stmt->setUInt32(0, l_PlayerInfo->accId);
                        LoginDatabase.AsyncQuery(stmt, l_Session->GetPlayer()->GetQueryCallbackMgr(), [targetName, targetGuid, l_PlayerInfo, l_AccountId](PreparedQueryResult const& p_Result)
                        {
                            ...
                            {
                                Field* fields = p_Result->Fetch();
                                l_PlayerInfo->banTime = int64(fields[1].GetBool() ? 0 : fields[0].GetUInt32());
                            ...
                            if (l_PlayerInfo->muteTime > 0)
                                ChatHandler(l_Session).PSendSysMessage(LANG_PINFO_MUTE, secsToTimeString(l_PlayerInfo->muteTime - time(NULL), true).c_str());
                            if (l_PlayerInfo->banTime >= 0)
                                ChatHandler(l_Session).PSendSysMessage(LANG_PINFO_BAN, l_PlayerInfo->banTime > 0 ? secsToTimeString(l_PlayerInfo->banTime - time(NULL), true).c_str() : "permanently", bannedby.c_str(), banreason.c_str());

                            std::string raceStr, ClassStr;
                            switch (l_PlayerInfo->race)
                            {
                                case RACE_HUMAN:
                                    raceStr = "Human";
                                    break;
                            ...
                            std::string timeStr = secsToTimeString(l_PlayerInfo->totalPlayerTime, true, true);
                            uint32 gold = l_PlayerInfo->money / GOLD;
                            uint32 silv = (l_PlayerInfo->money % GOLD) / SILVER;
                            uint32 copp = (l_PlayerInfo->money % GOLD) % SILVER;
                            ChatHandler(l_Session).PSendSysMessage(LANG_PINFO_LEVEL, raceStr.c_str(), ClassStr.c_str(), timeStr.c_str(), l_PlayerInfo->level, gold, silv, copp);

                            // Add map, zone, subzone and phase to output
                            std::string areaName = "<unknown>";
                            std::string zoneName = "";

                            MapEntry const* map = sMapStore.LookupEntry(l_PlayerInfo->mapId);

                            AreaTableEntry const* area = sAreaTableStore.LookupEntry(l_PlayerInfo->areaId);
                            if (area)
                            {
                                areaName = area->AreaNameLang->Get(sWorld->GetDefaultDb2Locale());

                                AreaTableEntry const* zone = sAreaTableStore.LookupEntry(area->ContinentID);

                                if (zone)
                                    zoneName = zone->AreaNameLang->Get(sWorld->GetDefaultDb2Locale());
                            }

                            std::string l_MapName = "";
                            if (map)
                                 l_MapName = map->MapNameLang->Get(sWorld->GetDefaultDb2Locale());

                            if (Player* l_Target = sObjectAccessor->FindPlayerInOrOutOfWorld(targetGuid))
                            {
                                if (!zoneName.empty())
                                    ChatHandler(l_Session).PSendSysMessage(LANG_PINFO_MAP_ONLINE, l_PlayerInfo->GarrisonID, l_MapName.c_str(), zoneName.c_str(), areaName.c_str(), l_PlayerInfo->phase);
                                else
                                    ChatHandler(l_Session).PSendSysMessage(LANG_PINFO_MAP_ONLINE, l_PlayerInfo->GarrisonID, l_MapName.c_str(), areaName.c_str(), "<unknown>", l_PlayerInfo->phase);
                            }
                            else if (map)
                                ChatHandler(l_Session).PSendSysMessage(LANG_PINFO_MAP_OFFLINE, map->MapNameLang, areaName.c_str());

                            if (l_PlayerInfo->LastNote != "")
                                ChatHandler(l_Session).SendSysMessage(std::string("Note[" + l_PlayerInfo->LastNoteTime + "]: " + l_PlayerInfo->LastNote).c_str());
        ...
        // show money of player
        static bool HandlePMoneyCommand(ChatHandler* handler, char const* args)
        {
            Player* target;
            uint64 targetGuid;
            std::string targetName;
            ...
            PreparedStatement* stmt = CharacterDatabase.GetPreparedStatement(CHAR_SEL_CHAR_PMONEY);
            stmt->setUInt32(0, GUID_LOPART(targetGuid));
            ...
            CharacterDatabase.AsyncQuery(stmt, l_Player->GetQueryCallbackMgr(), [targetName, targetGuid, l_AccountId, l_PlayerGuid](PreparedQueryResult const& p_Result)
            {
                ...
                Field* fields = p_Result->Fetch();
                uint64 l_Money = fields[0].GetUInt64();

                /// If the player is online, use last data instead old db ones
                if (l_Target)
                    l_Money = l_Target->GetMoney();

                WorldSession* l_Session = sWorld->FindSession(l_AccountId);
                if (!l_Session || !l_Session->GetPlayer())
                    return;

                uint32 gold = l_Money / GOLD;
                uint32 silv = (l_Money % GOLD) / SILVER;
                uint32 copp = (l_Money % GOLD) % SILVER;

                ChatHandler(l_Session).PSendSysMessage("Player %s has %ug %us %uc", targetName.c_str(), gold, silv, copp);
            });
        ...
        static bool HandleMuteCommand(ChatHandler* handler, char const* args)
        {
            ...
            if (target)
            {
                ...
                stmt->setInt64(l_Index++, muteTime);
            ...
            stmt->setUInt32(l_Index++, accountId);
        ...
        */
        ...
        static bool HandleDamageCommand(ChatHandler* p_Handler, char const* p_Args)
        {
            if (!*p_Args)
                return false;
            ...
            if (strcmp(l_Str, "go") == 0)
            {
                char* l_GuidStr = strtok(NULL, " ");
                if (!l_GuidStr)
                {
                ...
                int32 l_Damage = atoi(l_DamageStr);
                if (!l_Damage)
                {
                    p_Handler->SendSysMessage(LANG_BAD_VALUE);
                    p_Handler->SetSentErrorMessage(true);
                ...
                if (Player* l_Player = p_Handler->GetSession()->GetPlayer())
                {
                    GameObject* l_Go = NULL;

                    if (GameObjectData const* l_GoData = sObjectMgr->GetGOData(l_Guid))
                        l_Go = p_Handler->GetObjectGlobalyWithGuidOrNearWithDbGuid(l_Guid, l_GoData->id);

                    if (!l_Go)
                    {
                        p_Handler->PSendSysMessage(LANG_COMMAND_OBJNOTFOUND, l_Guid);
                        p_Handler->SetSentErrorMessage(true);
                        return false;
                    }

                    if (!l_Go->IsDestructibleBuilding())
                    {
                        p_Handler->SendSysMessage(LANG_INVALID_GAMEOBJECT_TYPE);
                        p_Handler->SetSentErrorMessage(true);
                        return false;
                    }

                    l_Go->ModifyHealth(-l_Damage, l_Player);
                    p_Handler->PSendSysMessage(LANG_GAMEOBJECT_DAMAGED, l_Go->GetName(), l_Guid, -l_Damage, l_Go->GetGOValue()->Building.Health);
                }
            ...
            {
                if (p_Handler->HasLowerSecurity((Player*)l_Target, 0, false))
                    return false;
            }
            ...
            char* l_DamageStr = l_Str;
            if (!l_DamageStr)
                return false;

            int32 l_DamageInt = atoi(l_DamageStr);
            if (l_DamageInt <= 0)
                return true;

            uint32 l_Damage = l_DamageInt;

            char* l_SchoolStr = strtok(nullptr, " ");

            // flat melee damage without resistence/etc reduction
            if (!l_SchoolStr)
            {
                p_Handler->GetSession()->GetPlayer()->DealDamage(l_Target, l_Damage, nullptr, DIRECT_DAMAGE, SPELL_SCHOOL_MASK_NORMAL, nullptr, false);
                if (l_Target != p_Handler->GetSession()->GetPlayer())
                    p_Handler->GetSession()->GetPlayer()->SendAttackStateUpdate(HITINFO_AFFECTS_VICTIM, l_Target, 1, SPELL_SCHOOL_MASK_NORMAL, l_Damage, 0, 0, VICTIMSTATE_HIT, 0);
                return true;
            }

            uint32 l_School = l_SchoolStr ? atoi((char*)l_SchoolStr) : SPELL_SCHOOL_NORMAL;
            if (l_School >= MAX_SPELL_SCHOOL)
                return false;

            DamageInfo l_DamageInfo(p_Handler->GetSession()->GetPlayer(), l_Target, l_Damage, SpellSchoolMask(1 << l_School), DamageEffectType::DIRECT_DAMAGE, WeaponAttackType::BaseAttack);

            if (Unit::IsDamageReducedByArmor(l_DamageInfo.GetSchoolMask()))
                p_Handler->GetSession()->GetPlayer()->CalcArmorReducedDamage(l_DamageInfo);
            ...
            if (!l_SpellStr)
            {
                p_Handler->GetSession()->GetPlayer()->CalcAbsorbResist(l_DamageInfo);

                if (l_DamageInfo.GetAmount() == 0)
                    return true;

                l_Damage -= l_DamageInfo.GetAbsorb() + l_DamageInfo.GetResist();

                p_Handler->GetSession()->GetPlayer()->DealDamageMods(l_DamageInfo);
                p_Handler->GetSession()->GetPlayer()->DealDamage(l_DamageInfo.GetTarget(), l_DamageInfo.GetAmount(), nullptr, l_DamageInfo.GetDamageType(), l_DamageInfo.GetSchoolMask(), l_DamageInfo.GetSpellInfo(), false, l_DamageInfo.GetAbsorb());
                p_Handler->GetSession()->GetPlayer()->SendAttackStateUpdate(HITINFO_AFFECTS_VICTIM, l_DamageInfo.GetTarget(), 1, l_DamageInfo.GetSchoolMask(), l_DamageInfo.GetAmount(), l_DamageInfo.GetAbsorb(), l_DamageInfo.GetResist(), VICTIMSTATE_HIT, l_DamageInfo.GetBlock());
                return true;
            }
            ...
            // number or [name] Shift-click form |color|Hspell:spell_id|h[name]|h|r or Htalent form
            uint32 l_SpellID = p_Handler->extractSpellIdFromLink((char*)l_SpellStr);
            if (!l_SpellID || !sSpellMgr->GetSpellInfo(l_SpellID))
                return false;

            p_Handler->GetSession()->GetPlayer()->SpellNonMeleeDamageLog(l_Target, l_SpellID, l_Damage);
            return true;
        }

        static bool HandleDamagePctCommand(ChatHandler* p_Handler, char const* p_Args)
        {
            char* l_DamageStr = strtok((char*)p_Args, " ");
            Unit* l_Target = p_Handler->getSelectedUnit();
            ...
            if (l_Target->IsPlayer() || !l_Target->isAlive() || !l_DamageStr)
                return false;

            double l_DamagePct = atof(l_DamageStr);
            ...
            if (l_Target->GetHealthPct() >= l_DamagePct)
                l_Damage = uint32((uint32(l_Target->GetMaxHealth() / 100) * l_DamagePct));
        ...
        static bool HandleDebugHealCommand(ChatHandler* p_Handler, char const* p_Args)
        {
            if (!*p_Args)
                return false;
            ...
            l_Player->DealHeal(l_Target, l_Damage, nullptr);
            if (l_Target != l_Player)
                l_Player->SendHealSpellLog(l_Target, 24, l_Damage, 0, 0, false);
        ...
        static bool HandlePossessCommand(ChatHandler* handler, char const* /*args*/)
        {
            ...
            handler->GetSession()->GetPlayer()->CastSpell(unit, 183171, true);
            return true;
        }
        ...
        static bool HandleBadwordAddCommand(ChatHandler* handler, char const* args)
        {
            ...
            if (sWordFilterMgr->AddBadWord(word, true))
                handler->PSendSysMessage(LANG_WORD_FILTER_SUCCESS_ADD_WORD, word.c_str());
            else
                handler->PSendSysMessage(LANG_WORD_FILTER_FAILED_ADD_WORD, word.c_str());
        ...
        static bool HandleBadwordRemoveCommand(ChatHandler* handler, char const* args)
        {
            ...
            if (sWordFilterMgr->RemoveBadWord(word, true))
                handler->PSendSysMessage(LANG_WORD_FILTER_SUCCESS_REMOVE_WORD, word.c_str());
            else
                handler->PSendSysMessage(LANG_WORD_FILTER_FAILED_REMOVE_WORD, word.c_str());

            return true;
        }

        static bool HandleDoSomeTestCommand(ChatHandler* handler, char const* args)
        {
            auto player = handler->GetSession()->GetPlayer();
            for (uint8 i = 0; i < MAX_QUEST_LOG_SIZE; ++i)
                if (uint32 questId = player->GetQuestSlotQuestId(i))
                    handler->PSendSysMessage("%u %u", i, questId);
            //handler->PSendSysMessage("%u", i);
            return true;
        }

        static bool HandleAuraListCommand(ChatHandler* handler, char const* args)
        {
            if (auto plr = handler->GetSession()->GetPlayer())
            {
                ...
                auto unit = handler->getSelectedUnit();
                if (!unit)
                {
                    handler->SendSysMessage(LANG_SELECT_CHAR_OR_CREATURE);
                    return false;
                ...
                auto targetGUID = unit->GetGUID();
                char const* tool = "Aura: |cffffff00%d %s %s";

                Unit::AuraApplicationMap const& auras = unit->GetAppliedAuras();
                uint16 auraListSize = (uint16)auras.size();
                std::ostringstream h_info;
                Player* tPlr = unit->ToPlayer();
                if (tPlr)
                {
                    const char* pName = unit->GetName();
                    h_info << pName << " has " << auraListSize << " aura(s)";
                }
                else
                {
                    h_info << "Creature has " << auraListSize << " aura(s)";
                }

                handler->PSendSysMessage("%s", h_info.str().c_str());

                for (const auto& itr : auras)
                {
                    auto aurApp = itr.second;

                    Aura const* aura = aurApp->GetBase();
                    auto casterGUID = aura->GetCasterGUID();
                    uint32 quality = 2;
                    ...
                    for (size_t i = 0; i < 32; i++)
                    {
                        if (AuraEffect* eff = aura->GetEffect(i))
                        {
                            if (float a = eff->GetAmount())
                            {
                                if (!_find)
                                {
                                    ss_info << "|cffffffffBP:" << "|cffffffff" << i << ":|cffff0000" << a << "  ";
                                    _find = true;
                                    continue;
                                }
                    ...
                    if (dur > 0)
                        ss_info << "|cff808080Duration:" << "|cffffff00" << dur;
                    ...
                    char const* name = aura->GetSpellInfo()->SpellName->Str[0];
                    std::ostringstream ss_name;
                    ss_name << nameColor << aura->GetId() << "|h[" << name << "]|h|r";

                    handler->PSendSysMessage(tool, aura->GetId(), (ss_name.str().c_str()),
                        (ss_info.str().c_str()));
                }

                if (!myAura.empty())
                {
                    handler->PSendSysMessage("His aura(s) %u: ", uint32(myAura.size()));
                    ...
                    for (auto itr : myAura)
                    {
                        ...
                        char const* name = itr->GetSpellInfo()->SpellName->Str[0];
                        std::ostringstream ss_name;
                        ss_name << "|cff7dd0ff|Hspell:" << itr->GetId() << "|h[" << name << "]|h|r";

                        handler->PSendSysMessage(tool, itr->GetId(), (ss_name.str().c_str()),
                            (ss_info.str().c_str()));
                    }
                }
                ...
                if (!othersAura.empty())
                {
                    handler->PSendSysMessage("Other aura(s) %u: ", uint32(othersAura.size()));
