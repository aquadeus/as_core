...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "spell",                  SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleRemoveDisableSpellCommand,               "", NULL },
            { "quest",                  SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleRemoveDisableQuestCommand,               "", NULL },
            { "map",                    SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleRemoveDisableMapCommand,                 "", NULL },
            { "battleground",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleRemoveDisableBattlegroundCommand,        "", NULL },
            { "achievement_criteria",   SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleRemoveDisableAchievementCriteriaCommand, "", NULL },
            { "outdoorpvp",             SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleRemoveDisableOutdoorPvPCommand,          "", NULL },
            { "vmap",                   SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleRemoveDisableVmapCommand,                "", NULL },
            { NULL,                     0,                      0,                      false,  NULL,                                           "", NULL }
        };
        static ChatCommand addDisableCommandTable[] =
        {
            { "spell",                  SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleAddDisableSpellCommand,                  "", NULL },
            { "quest",                  SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleAddDisableQuestCommand,                  "", NULL },
            { "map",                    SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleAddDisableMapCommand,                    "", NULL },
            { "battleground",           SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleAddDisableBattlegroundCommand,           "", NULL },
            { "achievement_criteria",   SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleAddDisableAchievementCriteriaCommand,    "", NULL },
            { "outdoorpvp",             SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleAddDisableOutdoorPvPCommand,             "", NULL },
            { "vmap",                   SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleAddDisableVmapCommand,                   "", NULL },
            { "itemsell",               SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   &HandleAddDisableItemSellCommand,               "", NULL },
            { NULL,                     0,                      0,                      false,  NULL,                                           "", NULL }
        };
        static ChatCommand disableCommandTable[] =
        {
            { "add",                    SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   NULL,                                           "", addDisableCommandTable },
            { "remove",                 SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,      true,   NULL,                                           "", removeDisableCommandTable },
            { NULL,                     0,                      0,                      false,  NULL,                                           "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "disable",                SEC_ADMINISTRATOR,      SEC_ADMINISTRATOR,     false,   NULL,                                           "", disableCommandTable },
            { NULL,                     0,                      0,                     false,   NULL,                                           "", NULL }
        };
        return commandTable;
    }
