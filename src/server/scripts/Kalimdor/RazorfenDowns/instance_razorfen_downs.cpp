                ...
                case DATA_AMNENNAR:
                {
                    if (p_State == DONE)
                    {
                        ...
                        if (!l_PlayerList.isEmpty())
                        {
                            ...
                            {
                                Player* l_Player = i->getSource();
                                if (!l_Player)
                                    continue;

                                if (!l_Player->HasAchieved(eAchievements::AchievementRazorfenDowns))
                                {
                                    if (AchievementEntry const* l_AchEntry = sAchievementStore.LookupEntry(eAchievements::AchievementRazorfenDowns))
                                        l_Player->CompletedAchievement(l_AchEntry);
                                }
                            }
                        }
                    }
