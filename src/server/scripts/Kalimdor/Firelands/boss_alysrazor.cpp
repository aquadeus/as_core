...
// Achievement "Do a Barrel Roll!" (5813)
...
enum Events
{
    ...
    EVENT_FLY_OUT           = 16,
    EVENT_EGG_EXPLOSION     = 17,
    EVENT_SUMMON_HATCHLING  = 18,
    EVENT_REMOVE_WINGS      = 19,
    EVENT_GUSHING_WOUND     = 20,
    EVENT_HUNGRY            = 21,
    EVENT_EAT_WORM          = 22,
    EVENT_SUMMON_WORMS      = 23,
    EVENT_HERALD            = 24,
    EVENT_CATACLYSM         = 25,
    EVENT_FIRESTORM         = 26,
    EVENT_FIRESTORM_1       = 27,
    EVENT_FIRESTORM_END     = 28,
    EVENT_VORTEX            = 29,
};
    ...
    public:
        ...
        struct boss_alysrazorAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                if (instance)
                {
                    ...
                    instance->SetData(DATA_ACHIEV_CRITERIA_DO_A_BARREL_ROLL_BRUSHFIRE, 1);
                    instance->SetData(DATA_ACHIEV_CRITERIA_DO_A_BARREL_ROLL_LAVA_SPEW, 1);
                    instance->SetData(DATA_ACHIEV_CRITERIA_DO_A_BARREL_ROLL_INCENDIARY_CLOUD, 1);
                    instance->SetData(DATA_ACHIEV_CRITERIA_DO_A_BARREL_ROLL_FIERY_TORNADO, 1);
                }
            }
        ...
        private:
            ...
            void RemoveEncounterAuras()
            {
                ...
                /// This prevents players from dying from falling damage
                instance->DoCastSpellOnPlayers(SPELL_SAFE_FALL);
            }
...
class npc_alysrazor_incindiary_cloud : public CreatureScript
{
    public:
        ...
        struct npc_alysrazor_incindiary_cloudAI : public Scripted_NoMovementAI
        {
            ...
            {
                if (pInstance && spell->Id == SPELL_INCENDIARY_CLOUD_DMG && target->GetTypeId() == TYPEID_PLAYER)
                    pInstance->SetData(DATA_ACHIEV_CRITERIA_DO_A_BARREL_ROLL_INCENDIARY_CLOUD, 0);
            }
        };
};
...
class npc_alysrazor_fiery_tornado : public CreatureScript
{
    public:
        ...
        struct npc_alysrazor_fiery_tornadoAI : public Scripted_NoMovementAI
        {
            ...
            void SpellHitTarget(Unit* target, SpellInfo const* spell)
            {
                if (pInstance && spell->Id == SPELL_FIERY_TORNADO_DMG && target->GetTypeId() == TYPEID_PLAYER)
                    pInstance->SetData(DATA_ACHIEV_CRITERIA_DO_A_BARREL_ROLL_FIERY_TORNADO, 0);
            }
...
class npc_alysrazor_blazing_talon_initiate : public CreatureScript
{
    public:
        ...
        struct npc_alysrazor_blazing_talon_initiateAI : public Scripted_NoMovementAI
        {
            ...
            {
                me->SetByteFlag(UNIT_FIELD_ANIM_TIER, 3, 0x02);
                me->SetCanFly(true);
                me->SetDisableGravity(true);
            }
            ...
            void MovementInform(uint32 type, uint32 data)
            {
                ...
                if (data == POINT_INITIATE_1)
                {
                    ...
                    me->SetCanFly(false);
                    me->SetDisableGravity(false);
                    me->RemoveByteFlag(UNIT_FIELD_ANIM_TIER, 3, 0x02);
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                if (casting_spell)
                {
                    ...
                    {
                        DoCast(pTarget, casting_spell);
                        if (casting_spell == SPELL_BRUSHFIRE)
                            casting_spell = SPELL_FIEROBLAST;
                        else
                            casting_spell = SPELL_BRUSHFIRE;
                    }
                }
                else
                {
                    events.Update(diff);
                    if (events.ExecuteEvent() == EVENT_START_COMBAT)
                        casting_spell = SPELL_BRUSHFIRE;
                }
            }
        };
    ...
    public:
        ...
        struct npc_alysrazor_brushfireAI : public ScriptedAI
        {
            ...
            void Reset()
            {
                ...
                DoCast(me, SPELL_BRUSHFIRE_AURA);
                me->GetMotionMaster()->MovePoint(0, me->GetPositionX() + 140.0f * cos(me->GetOrientation()), me->GetPositionY() + 140.0f * sin(me->GetOrientation()), me->GetPositionZ());
            }

            void SpellHitTarget(Unit* target, SpellInfo const* spell)
            {
                if (pInstance && spell->Id == SPELL_BRUSHFIRE_AURA_DMG && target->GetTypeId() == TYPEID_PLAYER)
                    pInstance->SetData(DATA_ACHIEV_CRITERIA_DO_A_BARREL_ROLL_BRUSHFIRE, 0);
            }
        };
};
    ...
    public:
        ...
        struct npc_alysrazor_plump_lava_wormAI : public Scripted_NoMovementAI
        {
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                if (events.ExecuteEvent() == EVENT_ROTATE)
                {
            ...
            void SpellHitTarget(Unit* target, SpellInfo const* spell)
            {
                if (pInstance && spell->Id == SPELL_LAVA_SPEW_DMG && target->GetTypeId() == TYPEID_PLAYER)
                    pInstance->SetData(DATA_ACHIEV_CRITERIA_DO_A_BARREL_ROLL_LAVA_SPEW, 0);
            }
        };
};
...
class spell_alysrazor_harsh_winds : public SpellScriptLoader
{
    public:
        ...
        class spell_alysrazor_harsh_winds_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_alysrazor_harsh_winds_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENTRY);
            }
...
class spell_alysrazor_molten_feather_script : public SpellScriptLoader
{
    public:
        ...
        class spell_alysrazor_molten_feather_script_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnHit += SpellHitFn(spell_alysrazor_molten_feather_script_SpellScript::HandleScript);
            }
        };
...
class spell_alysrazor_firestorm : public SpellScriptLoader
{
    public:
        ...
        class spell_alysrazor_firestorm_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_alysrazor_firestorm_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENTRY);
            }
