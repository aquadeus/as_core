                        ...
                        for (Map::PlayerList::const_iterator itr = PlayerList.begin(); itr != PlayerList.end(); ++itr)
                        {
                            if (Player* pPlayer = itr->getSource())
                            {
                                ...
                                if (!(pPlayer->getClass() == CLASS_MAGE ||
                                    ...
                                    (pPlayer->getClass() == CLASS_SHAMAN && (pPlayer->GetPrimarySpecialization() == SPEC_SHAMAN_ELEMENTAL || pPlayer->GetPrimarySpecialization() == SPEC_SHAMAN_RESTORATION)) ||
                                    (pPlayer->getClass() == CLASS_DRUID && (pPlayer->GetPrimarySpecialization() == SPEC_DRUID_BALANCE || pPlayer->GetPrimarySpecialization() == SPEC_DRUID_RESTORATION))))
                                    continue;
...
class spell_firelands_ancient_core_hound_dinner_time : public SpellScriptLoader
{
    public:
        ...
        class spell_firelands_ancient_core_hound_dinner_time_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_firelands_ancient_core_hound_dinner_time_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove += AuraEffectRemoveFn(spell_firelands_ancient_core_hound_dinner_time_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_firelands_ancient_core_hound_flame_breath : public SpellScriptLoader
{
    public:
        ...
        class spell_firelands_ancient_core_hound_flame_breath_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_firelands_ancient_core_hound_flame_breath_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove += AuraEffectRemoveFn(spell_firelands_ancient_core_hound_flame_breath_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_firelands_fire_turtle_hatchling_shell_spin : public SpellScriptLoader
{
    public:
        ...
        class spell_firelands_fire_turtle_hatchling_shell_spin_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_firelands_fire_turtle_hatchling_shell_spin_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove += AuraEffectRemoveFn(spell_firelands_fire_turtle_hatchling_shell_spin_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
class spell_firelands_flame_archon_fiery_torment : public SpellScriptLoader
{
    public:
        ...
        class spell_firelands_flame_archon_fiery_torment_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_firelands_flame_archon_fiery_torment_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove += AuraEffectRemoveFn(spell_firelands_flame_archon_fiery_torment_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
...
class npc_harbinger_of_flame : public CreatureScript
{
    public:
        ...
        struct npc_harbinger_of_flameAI : public ScriptedAI
        {
            ...
            {
                for (Guid128 l_BirdGUID : me->GetChannelObjects())
                    if (Creature* l_Bird = ObjectAccessor::GetCreature(*me, Guid128To64(l_BirdGUID)))
                        DoZoneInCombat(l_Bird, 200.0f);
    ...
    public:
        ...
        struct npc_blazing_monstrosityAI : public PassiveAI
        {
            ...
            void PassengerBoarded(Unit* passenger, int8 /*seat*/, bool apply)
            {
                ...
                passenger->setFaction(FACTION_FRIENDLY);
...
class npc_molten_barrage : public CreatureScript
{
    public:
        ...
        struct npc_molten_barrageAI : public NullCreatureAI
        {
            ...
            void AttackStart(Unit* target, bool /*p_Melee*/)
            {
                if (target)
