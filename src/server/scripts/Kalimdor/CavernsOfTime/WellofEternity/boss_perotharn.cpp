    ...
    public:
        ...
        struct boss_perotharnAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                if (instance && instance->GetData(DATA_EVENT_ILLIDAN_1) == IN_PROGRESS)
                {
    ...
    public:
        ...
        class spell_perotharn_drain_essence_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_perotharn_drain_essence_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_MOD_PACIFY_SILENCE, AURA_EFFECT_HANDLE_REAL);
            }
        };
