...
enum Creatures
{
    ...
    NPC_HIGHELF_MAGE_PRIEST             = 27747,
    NPC_RISEN_ZOMBIE_ALT                = 27737,
    NPC_RUNNING_CITIZEN                 = 28169,
};

enum GameObjects
{
    GO_HIDDEN_DOOR                      = 188686,
    GO_EXIT_GATE                        = 191788,
...
enum ArthasPhase
{
    ...
    COS_PROGRESS_FINISHED_CITY_INTRO_SKIP       = 5,
    COS_PROGRESS_KILLED_MEATHOOK                = 6,
    COS_PROGRESS_KILLED_SALRAMM                 = 7,
    COS_PROGRESS_REACHED_TOWN_HALL              = 8,
    COS_PROGRESS_KILLED_EPOCH                   = 9,
    COS_PROGRESS_LAST_CITY                      = 10,
    COS_PROGRESS_BEFORE_MALGANIS                = 11,
    COS_PROGRESS_FINISHED                       = 12,
};
...
const Position CitizenSpawn    = {2147.06f, 1257.73f, 134.45f, 1.09f};
...
const Position EventPos[] = 
{
    ...
    {2174.13f,  1255.18f,  134.91f,  1.93f},        // meathook spawn position
...
Position const skipFootmansPos[] =
{
    { 2096.662f, 1298.304f, 139.046f, 6.177f },
    { 2096.764f, 1290.711f, 138.656f, 6.177156f },
    { 2096.261f, 1284.050f, 138.838f, 0.094244f },
    { 2096.690f, 1279.513f, 139.29f, 0.094f },
};

Position const skipMagesPos[] =
{
    { 2091.020f, 1281.529f, 139.993f, 0.094f },
    { 2091.234f, 1293.715f, 139.818f, 6.196f },
};

Position const zombiePos[] =
{
    { 2156.690f, 1274.689f, 134.35202f, 3.01f }, // X: 2156.690674 Y: 1274.689819 Z: 134.352020 Orientation: 3.019842
    { 2158.2468f, 1287.1802f, 133.574f, 3.0394f }, // X: 2158.246826 Y: 1287.180298 Z: 133.574631 Orientation: 3.039477
    { 2157.102f, 1279.1413f, 133.974f, 3.0002f }, // X: 2157.102539 Y: 1279.141357 Z: 133.974686 Orientation: 3.000207
};
