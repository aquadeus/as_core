...
public:
    ...
    struct npc_thrall_old_hillsbradAI : public npc_escortAI
    {
        ...
        void DoAction(int32 param) override
        {
            switch (param)
            {
                case ENCOUNTER_PROGRESS_DRAKE_KILLED:
                    events.RescheduleEvent(EVENT_OPEN_DOORS, 0);
                    events.RescheduleEvent(EVENT_START_WP, 3000);
                    break;
                ...
                case ENCOUNTER_PROGRESS_TARETHA_MEET:
                    events.RescheduleEvent(EVENT_SUMMON_CHRONO, 0);
                    events.RescheduleEvent(EVENT_THRALL_TALK_2, 6000);
                    events.RescheduleEvent(EVENT_TARETHA_FALL, 11000);
                    events.RescheduleEvent(EVENT_THRALL_TALK_3, 14000);
                    events.RescheduleEvent(EVENT_THRALL_MOVE_DOWN, 17000);
                    break;
                case NPC_TARETHA:
                    events.RescheduleEvent(EVENT_THRALL_FACE_TARETHA, 0);
                    events.RescheduleEvent(EVENT_THRALL_TALK_4, 4000);
                    events.RescheduleEvent(EVENT_TARETHA_TALK_1, 13000);
                    events.RescheduleEvent(EVENT_THRALL_TALK_5, 17000);
                    events.RescheduleEvent(EVENT_SUMMON_EROZION, 17500);
                    events.RescheduleEvent(EVENT_EROZION_TALK_1, 18000);
                    events.RescheduleEvent(EVENT_EROZION_ACTION_1, 26000);
                    events.RescheduleEvent(EVENT_EROZION_TALK_2, 29000);
                    events.RescheduleEvent(EVENT_EROZION_TALK_3, 42000);
                    events.RescheduleEvent(EVENT_EROZION_ACTION_2, 47000);
                    events.RescheduleEvent(EVENT_THRALL_TALK_6, 48000);
                    events.RescheduleEvent(EVENT_THRALL_RUN_AWAY, 51000);
                    events.RescheduleEvent(EVENT_TARETHA_TALK_2, 53000);
                    break;
            }
        }
        ...
        void WaypointReached(uint32 waypointId) override
        {
            switch (waypointId)
            {
                case 0:
                    ...
                    break;
                case 8:
                    events.RescheduleEvent(EVENT_SET_FACING, 500);
                    break;
                case 9:
                    SetRun(false);
                    events.RescheduleEvent(EVENT_KILL_ARMORER, 500);
                    events.RescheduleEvent(EVENT_TALK_KILL_ARMORER, 4000);
                    break;
                case 10:
                    SetRun(true);
                    events.RescheduleEvent(EVENT_DRESSING_KNEEL, 500);
                    events.RescheduleEvent(EVENT_DRESSING_ARMOR, 3000);
                    events.RescheduleEvent(EVENT_DRESSING_STAND, 4000);
                    events.RescheduleEvent(EVENT_DRESSING_AXE, 7000);
                    events.RescheduleEvent(EVENT_DRESSING_SHIELD, 9000);
                    events.RescheduleEvent(EVENT_DRESSING_TALK, 12000);
                    break;
                case 13:
                ...
                case 29:
                    ...
                    break;
                case 30:
                    events.RescheduleEvent(EVENT_ENTER_MOUNT, 3000);
                    events.RescheduleEvent(EVENT_TALK_START_RIDE, 7000);
                    break;
                case 59:
                ...
                case 64:
                    ...
                    break;
                case 67:
                    events.RescheduleEvent(EVENT_LOOK_1, 500);
                    events.RescheduleEvent(EVENT_MOVE_AROUND, 3500);
                    events.RescheduleEvent(EVENT_LOOK_2, 5000);
                    events.RescheduleEvent(EVENT_LOOK_3, 6700);
                    events.RescheduleEvent(EVENT_SUMMON_GUARDS, 6000);
                    events.RescheduleEvent(EVENT_SUMMON_TALK1, 6500);
                    events.RescheduleEvent(EVENT_SUMMON_TALK2, 12000);
                    break;
                case 82:
                    events.RescheduleEvent(EVENT_LOOK_4, 500);
                    events.RescheduleEvent(EVENT_SUMMON_GUARDS_2, 1000);
                    events.RescheduleEvent(EVENT_SUMMON_TALK3, 1500);
                    break;
                case 91:
                    ...
                    for (auto& sum : summons)
                        if (auto summon = ObjectAccessor::GetCreature(*me, sum))
                            if (summon->GetEntry() == NPC_TM_LOOKOUT)
                ...
                case 94:
                    ...
                    events.RescheduleEvent(EVENT_THRALL_TALK, 2000);
                    break;
                case 101:
                    SetEscortPaused(true);
                    events.RescheduleEvent(EVENT_EPOCH_INTRO, 500);
                    events.RescheduleEvent(EVENT_SUMMON_INFINITES, 1500);
                    events.RescheduleEvent(EVENT_TRANSFORM, 8000);
                    events.RescheduleEvent(EVENT_START_WAVE_1, 25000);
                    break;
                case 103:
                    for (auto& sum : summons)
                        if (auto erozion = ObjectAccessor::GetUnit(*me, sum))
                            if (erozion->GetEntry() == NPC_EROZION)
                                erozion->SetFlag(UNIT_FIELD_NPC_FLAGS, UNIT_NPC_FLAG_QUESTGIVER);
        ...
        {
            combatEvents.Reset();
            combatEvents.RescheduleEvent(EVENT_CHECK_HEALTH, 500);
            combatEvents.RescheduleEvent(EVENT_SPELL_SHIELD_BLOCK, 8000);
            combatEvents.RescheduleEvent(EVENT_SPELL_STRIKE, 2000);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_START_WAVE_1:
                    events.RescheduleEvent(EVENT_CHECK_WAVE_1, 500);
                    summons.DoAction(ACTION_REMOVE_IMMUNE_FLAG);
                ...
                case EVENT_CHECK_WAVE_1:
                    if (summons.size() == 1)
                    {
                        ...
                        summons.DoAction(ACTION_START_COMBAT);
                        events.RescheduleEvent(EVENT_CHECK_WAVE_2, 500);
                        break;
                    }
                    events.RescheduleEvent(EVENT_CHECK_WAVE_1, 500);
                    break;
                case EVENT_CHECK_WAVE_2:
                    if (summons.size() == 1)
                    {
                        ...
                        summons.DoAction(ACTION_START_COMBAT);
                        events.RescheduleEvent(EVENT_CHECK_WAVE_3, 500);
                        break;
                    }
                    events.RescheduleEvent(EVENT_CHECK_WAVE_2, 500);
                    break;
                case EVENT_CHECK_WAVE_3:
                    if (summons.size() == 1)
                    {
                        ...
                        events.RescheduleEvent(EVENT_CALL_EPOCH, 8000);
                        break;
                    }
                    events.RescheduleEvent(EVENT_CHECK_WAVE_3, 500);
                    break;
                case EVENT_CALL_EPOCH:
                    if (Creature* epoch = summons.GetCreatureWithEntry(NPC_EPOCH_HUNTER))
                    {
                        ...
                        epoch->GetMotionMaster()->MovePoint(0, *me, false);
                    }
                    break;
                ...
                case EVENT_SUMMON_EROZION:
                    if (Creature* erozion = me->SummonCreature(NPC_EROZION, 2646.31f, 680.01f, 55.36f, 3.76f, TEMPSUMMON_MANUAL_DESPAWN))
                        erozion->SetUInt32Value(UNIT_FIELD_NPC_FLAGS, UNIT_NPC_FLAG_NONE);
                    break;
        ...
        void UpdateEscortAI(uint32 diff) override
        {
            ...
            switch (combatEvents.ExecuteEvent())
            {
                case EVENT_CHECK_HEALTH:
                    ...
                    events.RescheduleEvent(EVENT_CHECK_HEALTH, 500);
                    break;
                case EVENT_SPELL_STRIKE:
                    DoCastVictim(SPELL_STRIKE, false);
                    events.RescheduleEvent(EVENT_SPELL_STRIKE, 6000);
                    break;
                case EVENT_SPELL_SHIELD_BLOCK:
                    me->CastSpell(me, SPELL_SHIELD_BLOCK, false);
                    events.RescheduleEvent(EVENT_SPELL_SHIELD_BLOCK, 6000);
                    break;
            }
...
{
    go_barrel_old_hillsbrad(GameObject* go) : GameObjectAI(go) { }

    void SpellHit(Unit* unit, const SpellInfo* spellInfo) override
    {
        if (spellInfo->Id == 32744)
        {
            if (auto instance = go->GetInstanceScript())
                instance->SetData(DATA_BOMBS_PLACED, 1);
        }
    }
};
...
{
    RegisterGameObjectAI(go_barrel_old_hillsbrad);
