...
class boss_hagara_the_stormbinder: public CreatureScript
{
    public:
        ...
        struct boss_hagara_the_stormbinderAI : public BossAI
        {
            ...
            {
                if (instance)
                    instance->SetBossState(DATA_HAGARA, FAIL);
...
class npc_hagara_the_stormbinder_ice_lance : public CreatureScript
{
    public:
        ...
        struct npc_hagara_the_stormbinder_ice_lanceAI : public Scripted_NoMovementAI
        {
            ...
            uint64 GetGUID(int32 type) override
            {
                if (type == DATA_ICE_LANCE_GUID)
                    return targetPlayer;
                return 0;
    ...
    public:
        ...
        struct npc_hagara_the_stormbinder_collapsing_icicleAI : public Scripted_NoMovementAI
        {
            ...
            void UpdateAI(const uint32 diff) override
            {
                ...
                {
                    DoCast(me, SPELL_ICICLE_VISUAL);
                    DoCast(me, SPELL_ICICLE_AURA, true);
                }
            }
    ...
    public:
        ...
        class spell_hagara_the_stormbinder_frostflake_AuraScript : public AuraScript
        {
            ...
            void AfterRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                if (GetCaster())
                    GetCaster()->CastSpell(GetTarget(), 13810, true);
            }

            void HandleDispel(DispelInfo* /*dispelInfo*/)
            {
                GetUnitOwner()->RemoveAura(SPELL_FROSTFLAKE);
            }
            ...
            void Register() override
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_hagara_the_stormbinder_frostflake_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_MOD_DECREASE_SPEED, AURA_EFFECT_HANDLE_REAL);
        ...
        class spell_hagara_the_stormbinder_lightning_conduit_AuraScript : public AuraScript
        {
            ...
            void HandlePeriodicTick(AuraEffect const* /*aurEff*/)
            {
                ...
                if (!players.empty())
                {
                    ...
                    {
                        case Difficulty10N:
                            spell_dmg = SPELL_LIGHTNING_CONDUIT_DMG;
                            break;
                        case Difficulty25N:
                            spell_dmg = SPELL_LIGHTNING_CONDUIT_DMG_25;
                            break;
                        case Difficulty10HC:
                            spell_dmg = SPELL_LIGHTNING_CONDUIT_DMG_10H;
                            break;
                        case Difficulty25HC:
                            spell_dmg = SPELL_LIGHTNING_CONDUIT_DMG_25H;
                            break;
                        default:
                            break;
                    }
            ...
            void Register() override
            {
                OnEffectPeriodic += AuraEffectPeriodicFn(spell_hagara_the_stormbinder_lightning_conduit_AuraScript::HandlePeriodicTick, EFFECT_0, SPELL_AURA_DUMMY);
            }
