    ...
    public:
        ...
        struct boss_general_vezaxAI : public BossAI
        {
            ...
            void Reset() override
            {
                ...
                _vaporKilled = false;
                if (instance)
                    instance->SetBossState(BOSS_VEZAX, NOT_STARTED);
            }
            ...
            void JustDied(Unit* /*who*/) override
            {
                ...
                if (instance)
                {
                    instance->SetBossState(BOSS_VEZAX, DONE);
...
class spell_aura_of_despair_aura: public SpellScriptLoader // Spell 62692
{
    public:
        ...
        class spell_aura_of_despair_AuraScript : public AuraScript
        {
            ...
            {
                AfterEffectApply += AuraEffectApplyFn(spell_aura_of_despair_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_PREVENT_REGENERATE_POWER, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove += AuraEffectRemoveFn(spell_aura_of_despair_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_PREVENT_REGENERATE_POWER, AURA_EFFECT_HANDLE_REAL);
            }
