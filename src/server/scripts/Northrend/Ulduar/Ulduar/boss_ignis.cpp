                        ...
                        case EVENT_CONSTRUCT:
                            ...
                            if (!_creatureList.empty())
                            {
                                ...
                                if (Creature* construct = Unit::GetCreature(*me, *itr))
                                {
                                    ...
                                    construct->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_STUNNED | UNIT_FLAG_REMOVE_CLIENT_CONTROL);
...
class npc_iron_construct : public CreatureScript
{
    public:
        ...
        struct npc_iron_constructAI : public ScriptedAI
        {
            ...
            {
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_STUNNED | UNIT_FLAG_REMOVE_CLIENT_CONTROL);
