    ...
    public:
        ...
        struct boss_xt002_AI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_REMOVE_CLIENT_CONTROL);  // Just for the case they are still present
    ...
    public:
        ...
        class spell_xt002_tympanic_tantrum_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                ...
                OnEffectHitTarget += SpellEffectFn(spell_xt002_tympanic_tantrum_SpellScript::HandleDamageCalc, EFFECT_0, SPELL_EFFECT_DAMAGE_FROM_MAX_HEALTH_PCT);
            }
        };
