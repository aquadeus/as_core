...
class spell_load_into_catapult: public SpellScriptLoader
{
    ...
    public:
        ...
        class spell_load_into_catapult_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectApply += AuraEffectApplyFn(spell_load_into_catapult_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_CONTROL_VEHICLE, AURA_EFFECT_HANDLE_REAL);
                AfterEffectRemove += AuraEffectRemoveFn(spell_load_into_catapult_AuraScript::AfterRemove, EFFECT_0, SPELL_AURA_CONTROL_VEHICLE, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
            }
        };
...
class spell_systems_shutdown: public SpellScriptLoader
{
    public:
        ...
        class spell_systems_shutdown_AuraScript : public AuraScript
        {
            ...
            {
                AfterEffectApply += AuraEffectApplyFn(spell_systems_shutdown_AuraScript::AfterApply, EFFECT_0, SPELL_AURA_MOD_DAMAGE_PERCENT_TAKEN, AURA_EFFECT_HANDLE_REAL);
