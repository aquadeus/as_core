    ...
    public:
        ...
        class spell_algalon_phase_punch_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_algalon_phase_punch_AuraScript::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
...
void AddSC_boss_algalon_the_observer()
{
    ...
    /// new achievement_he_feeds_on_your_tears(); ///< Need to rework
}
#endif
