    ...
    public:
        ...
        struct boss_kologarnAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                instance->DoStopCriteriaTimer(CRITERIA_TIMED_TYPE_EVENT, DATA_DISARMED_EVENT);
            }
            ...
            void PassengerBoarded(Unit* who, int8 /*seatId*/, bool apply)
            {
                ...
                if (!apply)
                {
                    ...
                    instance->DoStartCriteriaTimer(CRITERIA_TIMED_TYPE_EVENT, DATA_DISARMED_EVENT);
                }
                else
                {
                    instance->DoStopCriteriaTimer(CRITERIA_TIMED_TYPE_EVENT, DATA_DISARMED_EVENT);
                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_RESPAWN_RIGHT_ARM:
                        {
                            if (vehicle)
                            {
                                ...
                                VehicleAccessory l_Accessory(entry, seat, true, TEMPSUMMON_MANUAL_DESPAWN, 0, Position());
                                vehicle->InstallAccessory(&l_Accessory);
                            }
