            ...
            void JustSummoned(Creature* summon)
            {
                ...
                switch (summon->GetEntry())
                {
                    ...
                    case NPC_IMPALE_TARGET:
                        ...
                        summon->SetDisplayId(summon->GetCreatureTemplate()->Modelid[1]);
                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_PREPARE_POUND:
                        {
                            ...
                            if (Creature* target = me->SummonCreature(22515, x, y, z + 2.0f, 0.0f, TEMPSUMMON_TIMED_DESPAWN, 4500))
                            {
                                ...
                                target->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_REMOVE_CLIENT_CONTROL | UNIT_FLAG_IMMUNE_TO_NPC);
                                AttackStart(target);
