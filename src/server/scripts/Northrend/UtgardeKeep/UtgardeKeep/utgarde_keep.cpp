...
class spell_ticking_time_bomb: public SpellScriptLoader
{
    public:
        ...
        class spell_ticking_time_bomb_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                AfterEffectRemove += AuraEffectRemoveFn(spell_ticking_time_bomb_AuraScript::HandleOnEffectRemove, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
