        ...
        struct boss_skadiAI : public ScriptedAI
        {
            ...
            void Reset()
            {
                ...
                if (_instance)
                {
                    ...
                    _instance->DoStopCriteriaTimer(CRITERIA_TIMED_TYPE_EVENT, ACHIEV_TIMED_START_EVENT);
                }
            }
            ...
            void EnterCombat(Unit* /*who*/)
            {
                ...
                if (_instance)
                {
                    ...
                    _instance->DoStartCriteriaTimer(CRITERIA_TIMED_TYPE_EVENT, ACHIEV_TIMED_START_EVENT);
