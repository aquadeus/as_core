...
enum Spells
{
    ...
    SPELL_SCALE_AURA                    = 70507, // Aura created in spell_db2
    ...
    SPELL_SUMMON_EXIT_PORTALS           = 74805, // Custom spell created in spell_db2
    ...
    SPELL_COPY_DAMAGE                   = 74810  // Aura not found in DB2s.
};
