...
public:
    ...
    struct boss_sartharionAI : public ScriptedAI
    {
        ...
        void FetchDragons()
        {
            ...
            {
                case 3:
                    instance->DoUpdateWorldState(eOSWorldStates::TwilightZone, 1);
                    // don't break;
                case 2:
                    instance->DoUpdateWorldState(eOSWorldStates::TwilightDuo, 1);
                    // don't break;
                case 1:
                    instance->DoUpdateWorldState(eOSWorldStates::TwilightAssist, 1);
                    break;
            }
        }
