    ...
    public:
        ...
        struct boss_the_lich_kingAI : public BossAI
        {
            ...
            void JustDied(Unit* /*killer*/) override
            {
                ...
                me->RemoveByteFlag(UNIT_FIELD_ANIM_TIER, UNIT_BYTES_1_OFFSET_ANIM_TIER, UNIT_BYTE1_FLAG_ALWAYS_STAND | UNIT_BYTE1_FLAG_HOVER);
        ...
        private:
            ...
            void SendLightOverride(uint32 overrideId, uint32 fadeInTime) const
            {
                ...
                data << uint32(2488);       // Light.db2 entry (map default)
    ...
    public:
        ...
        class spell_the_lich_king_restore_soul_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex /*effIndex*/)
            {
                ...
                p_Caster->GetCreatureListWithEntryInGrid(spirits, NPC_WICKED_SPIRIT, 200.0f);
                for (std::list<Creature*>::iterator itr = spirits.begin(); itr != spirits.end(); ++itr)
                    (*itr)->AI()->EnterEvadeMode();

                std::list<Player*>l_PlayerList;
                p_Caster->GetPlayerListInGrid(l_PlayerList, 200.0f);

                for (Player* l_Player : l_PlayerList)
                    l_Player->RemoveAurasByType(SPELL_AURA_MOD_STUN);
            }
...
class playerscript_harvest_souls : public PlayerScript
{
    public:
        playerscript_harvest_souls() : PlayerScript("playerscript_harvest_souls") { }
        ...
        void OnLogin(Player* p_Player) override
        {
            ...
            if (p_Player->HasAura(SPELL_HARVEST_SOULS))
                p_Player->RemoveAura(SPELL_HARVEST_SOULS);
        }
};
...
void AddSC_boss_the_lich_king()
{
    ...
    /// Player Scripts
    new playerscript_harvest_souls();
