    ...
    public:
        ...
        class spell_sindragosa_s_fury_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex effIndex)
            {
                ...
                SpellNonMeleeDamage damageInfo(GetCaster(), GetHitUnit(), damage, damage, GetSpellInfo(), DamageEffectType::SPELL_DIRECT_DAMAGE, GetSpellInfo()->GetSpellXSpellVisualId(GetCaster()));
