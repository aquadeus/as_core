    ...
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            for (int i = 0; i < MAX_RINGS_NUMBER; ++i)
            {
                ...
                {
                    creature->MonsterWhisper(sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_ALREADY_HAVE), player->GetGUID());
                    player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_DELETE), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 21, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_CONFIRM), 0, false);
            ...
            {
                case REP_FRIENDLY:
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_CASTER_FRIENDLY), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_HEALER_FRIENDLY), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_MELEE_STRENGTH_FRIENDLY), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_MELEE_AGILITY_FRIENDLY), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_TANK_FRIENDLY), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
                    break;
                case REP_HONORED:
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_CASTER_HONORED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 6);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_HEALER_HONORED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 7);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_MELEE_STRENGTH_HONORED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 8);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_MELEE_AGILITY_HONORED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 9);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_TANK_HONORED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 10);
                    break;
                case REP_REVERED:
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_CASTER_REVERED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 11);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_HEALER_REVERED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 12);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_MELEE_STRENGTH_REVERED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 13);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_MELEE_AGILITY_REVERED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 14);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_TANK_REVERED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 15);
                    break;
                case REP_EXALTED:
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_CASTER_EXALTED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 16);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_HEALER_EXALTED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 17);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_MELEE_STRENGTH_EXALTED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 18);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_MELEE_AGILITY_EXALTED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 19);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_TANK_EXALTED), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 20);
                    break;
                default:
                    creature->MonsterWhisper(sObjectMgr->GetTrinityStringForDB2Locale(LANG_ICC_RING_NOT_ENOUGH_REP), player->GetGUID());
                    break;
            }
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
        {
            ...
            {
                player->ModifyMoney(int64(-2000000), "npc_icc_ring_recover");
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            if (_instance->GetData(DATA_BUFF_REMOVED) != DONE)
                if (player->GetGroup() && player->GetGroup()->IsLeader(player->GetGUID()))
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, sObjectMgr->GetTrinityStringForDB2Locale(creature->GetEntry() == NPC_KING_VARIAN_WRYNN ? LANG_ICC_BUFF_REMOVE_A : LANG_ICC_BUFF_REMOVE_H), GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
