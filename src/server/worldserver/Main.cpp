...
bool   g_DatabaseUpdaterOnly;                                 ///< Start the database updater, update the db and exit
...
extern int main(int argc, char **argv)
{
    ...
    while ( c < argc )
    {
        ...
        if (strcmp(argv[c], "updateronly") == 0)
            g_DatabaseUpdaterOnly = true;
