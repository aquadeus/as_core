...
#define LEGACY_BROADCAST_ENTRY_FLAG 0x40000000
#define HOTFIX_REMOVE_ROW_ENTRY_FLAG 0x02000000

#define MAX_CREATURE_BASE_HP 7
...
enum OverridePvpTypes
{
    TypeNoType,      ///< Doesn't override zone Pvp default type
    TypeNeutral,     ///< Friendly for all factions
    TypeFFA,         ///< Free for all (aggressive)
    TypeContestedPvP ///< Horde vs Alliance
};
...
enum SpecIndex
{
    ...
    SPEC_DEMON_HUNTER_HAVOC        = 577,
    SPEC_DEMON_HUNTER_VENGEANCE    = 581
};
...
enum Expansion
{
    ...
    MAX_ACCOUNT_EXPANSIONS              ///< used to unlock subraces
};
...
enum SpellAttr2
{
    ...
    SPELL_ATTR2_CAN_TARGET_NOT_IN_LOS            = 0x00000004, //  2 26368 4.0.1 db2 change
...
enum SpellAttr4
{
    ...
    SPELL_ATTR4_HAS_DELAY                        = 0x00000010, //  4
...
enum SpellAttr5
{
    SPELL_ATTR5_USABLE_WHILE_MOVING              = 0x00000001, //  0 usable while moving NYI
...
enum SpellAttr7
{
    ...
    SPELL_ATTR7_SEND_CAST_LOG_DATA               = 0x80000000  // 31
};
...
enum SpellAttr10
{
    ...
    SPELL_ATTR10_RESET_COOLDOWN_UPON_ENDING_AN_ENCOUNTER    = 0x00000400, // 10 Omar's Seal of Approval, Spellweaving
    ...
    SPELL_ATTR10_CAN_PARRY_BLOCK_ON_CAST                    = 0x00040000, // 18 When player casted spell can parry and block
...
enum SpellAttr11
{
    SPELL_ATTR11_DONT_TURN_DURING_CAST_2          = 0x00000001, //  0 See CGUnit_C::UpdateSmoothFacing
    ...
    SPELL_ATTR11_USABLE_IN_GROUP_ONLY             = 0x00001000, // 12
...
enum SpellAttr13
{
    SPELL_ATTR13_UNK0                             = 0x00000001, ///<  0       Probably SPELL_ATTR13_PLAYER_SPELL
    SPELL_ATTR13_UNK1                             = 0x00000002, //  1
    SPELL_ATTR13_UNK2                             = 0x00000004, //  2
    SPELL_ATTR13_CANCEL_CURRENT_CAST              = 0x00000008, //  3
...
#define MAX_PVP_TALENT_SPELLS   6
...
enum SpellClickUserTypes
{
    ...
    SPELL_CLICK_USER_NOT_IN_COMBAT     = 5
};
...
enum SpellEffects
{
    ...
    SPELL_EFFECT_CREATE_OR_RECHARGE_ITEM            = 66,
    SPELL_EFFECT_HEAL_MAX_HEALTH                    = 67,
    SPELL_EFFECT_INTERRUPT_CAST                     = 68,
    SPELL_EFFECT_DISTRACT                           = 69,
    SPELL_EFFECT_COMPLETE_WORLD_QUEST               = 70,
    ...
    SPELL_EFFECT_INCREASE_FOLLOWER_ITEM_LEVEL       = 80,
    ...
    SPELL_EFFECT_CANCEL_CONVERSATION                = 113, ///< @TODO
    ...
    SPELL_EFFECT_122                                = 122, ///< unk miscvalueA but BP is max stack count
    ...
    SPELL_EFFECT_JOIN_LEAVE_PLAYER_PARTY            = 190, ///< NPC join your party
    SPELL_EFFECT_TELEPORT_TO_DIGSITE                = 191,
    SPELL_EFFECT_UNCAGE_BATTLE_PET                  = 192,
    SPELL_EFFECT_START_PET_BATTLE                   = 193,
    SPELL_EFFECT_194                                = 194, ///< 7.1.5 unused
    SPELL_EFFECT_PLAY_SCENEOBJECT_3                 = 195,
    SPELL_EFFECT_PLAY_SPELL_SCENE                   = 196,
    SPELL_EFFECT_PLAY_SPELL_SCENE_2                 = 197,
    SPELL_EFFECT_PLAY_SPELL_SCENE_3                 = 198,
    SPELL_EFFECT_199                                = 199,
    SPELL_EFFECT_RESURECT_BATTLE_PETS               = 200,
    SPELL_EFFECT_CAN_PETBATTLE                      = 201,
    SPELL_EFFECT_APPLY_AURA_2                       = 202,
    ...
    SPELL_EFFECT_FEED_NIGHTFALLEN                   = 208,
    SPELL_EFFECT_209                                = 209, ///< MiscvalueA is a phase
    SPELL_EFFECT_LEARN_BLUE_PRINT                   = 210,
    SPELL_EFFECT_LEARN_GARRISON_SPECIALIZATION      = 211,
    SPELL_EFFECT_212                                = 212, ///< 7.1.5 unused
    ...
    SPELL_EFFECT_218                                = 218, ///< areatrigger force related
    ...
    SPELL_EFFECT_SUMMON_FRIEND                      = 226,
    SPELL_EFFECT_TELEPORT_TO_LFG_DUNGEON            = 227, ///< MiscValueB is LFGDungeon ID
    SPELL_EFFECT_RAF_TELEPORT                       = 228,
    SPELL_EFFECT_SET_FOLLOWER_QUALITY               = 229,
    SPELL_EFFECT_INTENSIFICATION                    = 230,
    SPELL_EFFECT_INCREASE_FOLLOWER_EXPERIENCE       = 231,
    SPELL_EFFECT_REMOVE_PHASE                       = 232,
    SPELL_EFFECT_RANDOMIZE_FOLLOWER_ABILITIES       = 233,
    SPELL_EFFECT_234                                = 234, ///< 7.1.5 unused
    SPELL_EFFECT_AK_CATCHUP                         = 235, ///< BP is AK level (15 -25) MiscValueA is min player level
    ...
    SPELL_EFFECT_EARN_ARTIFACT_POWER                = 242,
    ...
    SPELL_EFFECT_ADD_GARRISON_MISSION_2             = 247,
    ...
    SPELL_EFFECT_MOD_GARRISON_CACHE_CAPACITY        = 251,
    SPELL_EFFECT_TELEPORT_UNITS                     = 252,
    SPELL_EFFECT_GIVE_HONOR                         = 253,
    SPELL_EFFECT_JUMP_DEST_2                        = 254,
    SPELL_EFFECT_COLLECT_APPEARANCE                 = 255,
...
enum SpellCastResult
{
    ...
    SPELL_FAILED_NO_ACTIVE_GLYPHS_2                             = 289,
    SPELL_FAILED_UNKNOWN                                        = 290,
...
{   // (C) used in caster aura state     (T) used in target aura state
    ...
    AURA_STATE_HEALTHLESS_25_PERCENT        = 6,            // T   |
...
enum Targets
{
    ...
    TARGET_UNIT_BETWEEN_DEST           = 109, // spell 89008
...
enum GameobjectTypes : uint8
{
    ...
    GAMEOBJECT_TYPE_KEYSTONE_RECEPTABLE    = 49,
...
enum GameObjectDynamicLowFlags
{
    ...
    GO_DYNFLAG_LO_CHALLENGE_AVAILABLE   = 0x400,                ///< Challenge ativated loot
    GO_DYNFLAG_LO_CHALLENGE_CLAIMED     = 0x800,                ///< Challenge loots already claimed
    GO_DYNFLAG_LO_CHALLENGE_NO_LOOTS    = 0x1000                ///< No challenge completed
};
...
enum eArtifacts
{
    DemonHunterHavocA       = 127829,
    DemonHunterVengeanceA   = 128832,
    DeathKnightBloodA       = 128402,
    DeathKnightFrostA       = 128292,
    DeathKnightUnholyA      = 128403,
    DruidBalanceA           = 128858,
    DruidFeralA             = 128860,
    DruidGuardianA          = 128821,
    DruidRestorationA       = 128306,
    HunterBeastMasteryA     = 128861,
    HunterMarksmanshipA     = 128826,
    HunterSurvivalA         = 128808,
    MageArcaneA             = 127857,
    MageFireA               = 128820,
    MageFrostA              = 128862,
    MonkBrewmasterA         = 128938,
    MonkMistweaverA         = 128937,
    MonkWindwalkerA         = 128940,
    PaladinHolyA            = 128823,
    PaladinProtectionA      = 128866,
    PaladinRetributionA     = 120978,
    PriestDisciplineA       = 128868,
    PriestHolyA             = 128825,
    PriestShadowA           = 128827,
    RogueAssassinationA     = 128870,
    RogueOutlawA            = 128872,
    RogueSubletyA           = 128476,
    ShamanElementalA        = 128935,
    ShamanEnhancementA      = 128819,
    ShamanRestorationA      = 128911,
    WarlockAfflictionA      = 128942,
    WarlockDemonologyA      = 128943,
    WarlockDestructionA     = 128941,
    WarriorArmsA            = 128910,
    WarriorFuryA            = 128908,
    WarriorProtectionA      = 128289
};
...
enum TextEmotes
{
    ...
    TEXT_EMOTE_READ                 = 456,
    TEXT_EMOTE_BOOT                 = 506,
    TEXT_EMOTE_FOR_THE_ALLIANCE     = 507,
    TEXT_EMOTE_FOR_THE_HORDE        = 508,
    TEXT_EMOTE_WHOA                 = 517,
    TEXT_EMOTE_OOPS                 = 518,
...
enum Anim
{
    ...
    ANIM_COMBATABILITY2HL01                = 844,
    ANIM_FLYCOMBATABILITY2HL01             = 845,
    ANIM_COMBATABILITY2HL02                = 846,
    ANIM_FLYCOMBATABILITY2HL02             = 847,
    ANIM_COMBATABILITY2HLBIG01             = 848,
    ANIM_FLYCOMBATABILITY2HLBIG01          = 849,
    ANIM_COMBATUNARMED01                   = 850,
    ANIM_FLYCOMBATUNARMED01                = 851,
    ANIM_COMBATSTOMPLEFT                   = 852,
    ANIM_FLYCOMBATSTOMPLEFT                = 853,
    ANIM_COMBATSTOMPRIGHT                  = 854,
    ANIM_FLYCOMBATSTOMPRIGHT               = 855,
    ANIM_COMBATLEAPLOOP                    = 856,
    ANIM_FLYCOMBATLEAPLOOP                 = 857,
    ANIM_COMBATLEAPEND                     = 858,
    ANIM_FLYCOMBATLEAPEND                  = 859,
    ANIM_SHAREADYSPELLCAST                 = 860,
    ANIM_FLYSHAREADYSPELLCAST              = 861,
    ANIM_SHASPELLPRECASTBOTHCHANNEL        = 862,
    ANIM_FLYSHASPELLPRECASTBOTHCHANNEL     = 863,
    ANIM_SHASPELLCASTBOTHUP                = 864,
    ANIM_FLYSHASPELLCASTBOTHUP             = 865,
    ANIM_SHASPELLCASTBOTHUPCHANNEL         = 866,
    ANIM_FLYSHASPELLCASTBOTHUPCHANNEL      = 867,
    ANIM_SHASPELLCASTBOTHFRONTCHANNEL      = 868,
    ANIM_FLYSHASPELLCASTBOTHFRONTCHANNEL   = 869,
    ANIM_SHASPELLCASTLEFTFRONTCHANNEL      = 870,
    ANIM_FLYSHASPELLCASTLEFTFRONTCHANNEL   = 871,
    ANIM_SHASPELLCASTRIGHTFRONTCHANNEL     = 872,
    ANIM_FLYSHASPELLCASTRIGHTFRONTCHANNEL  = 873,
    ANIM_PRIREADYSPELLCAST                 = 874,
    ANIM_FLYPRIREADYSPELLCAST              = 875,
    ANIM_PRISPELLPRECASTBOTH               = 876,
    ANIM_FLYPRISPELLPRECASTBOTH            = 877,
    ANIM_PRISPELLPRECASTBOTHCHANNEL        = 878,
    ANIM_FLYPRISPELLPRECASTBOTHCHANNEL     = 879,
    ANIM_PRISPELLCASTBOTHUP                = 880,
    ANIM_FLYPRISPELLCASTBOTHUP             = 881,
    ANIM_PRISPELLCASTBOTHFRONT             = 882,
    ANIM_FLYPRISPELLCASTBOTHFRONT          = 883,
    ANIM_PRISPELLCASTLEFTFRONT             = 884,
    ANIM_FLYPRISPELLCASTLEFTFRONT          = 885,
    ANIM_PRISPELLCASTRIGHTFRONT            = 886,
    ANIM_FLYPRISPELLCASTRIGHTFRONT         = 887,
    ANIM_PRISPELLCASTBOTHUPCHANNEL         = 888,
    ANIM_FLYPRISPELLCASTBOTHUPCHANNEL      = 889,
    ANIM_PRISPELLCASTBOTHFRONTCHANNEL      = 890,
    ANIM_FLYPRISPELLCASTBOTHFRONTCHANNEL   = 891,
    ANIM_PRISPELLCASTLEFTFRONTCHANNEL      = 892,
    ANIM_FLYPRISPELLCASTLEFTFRONTCHANNEL   = 893,
    ANIM_PRISPELLCASTRIGHTFRONTCHANNEL     = 894,
    ANIM_FLYPRISPELLCASTRIGHTFRONTCHANNEL  = 895,
    ANIM_MAGREADYSPELLCAST                 = 896,
    ANIM_FLYMAGREADYSPELLCAST              = 897,
    ANIM_MAGSPELLPRECASTBOTH               = 898,
    ANIM_FLYMAGSPELLPRECASTBOTH            = 899,
    ANIM_MAGSPELLPRECASTBOTHCHANNEL        = 900,
    ANIM_FLYMAGSPELLPRECASTBOTHCHANNEL     = 901,
    ANIM_MAGSPELLCASTBOTHUP                = 902,
    ANIM_FLYMAGSPELLCASTBOTHUP             = 903,
    ANIM_MAGSPELLCASTBOTHFRONT             = 904,
    ANIM_FLYMAGSPELLCASTBOTHFRONT          = 905,
    ANIM_MAGSPELLCASTLEFTFRONT             = 906,
    ANIM_FLYMAGSPELLCASTLEFTFRONT          = 907,
    ANIM_MAGSPELLCASTRIGHTFRONT            = 908,
    ANIM_FLYMAGSPELLCASTRIGHTFRONT         = 909,
    ANIM_MAGSPELLCASTBOTHUPCHANNEL         = 910,
    ANIM_FLYMAGSPELLCASTBOTHUPCHANNEL      = 911,
    ANIM_MAGSPELLCASTBOTHFRONTCHANNEL      = 912,
    ANIM_FLYMAGSPELLCASTBOTHFRONTCHANNEL   = 913,
    ANIM_MAGSPELLCASTLEFTFRONTCHANNEL      = 914,
    ANIM_FLYMAGSPELLCASTLEFTFRONTCHANNEL   = 915,
    ANIM_MAGSPELLCASTRIGHTFRONTCHANNEL     = 916,
    ANIM_FLYMAGSPELLCASTRIGHTFRONTCHANNEL  = 917,
    ANIM_LOCREADYSPELLCAST                 = 918,
    ANIM_FLYLOCREADYSPELLCAST              = 919,
    ANIM_LOCSPELLPRECASTBOTH               = 920,
    ANIM_FLYLOCSPELLPRECASTBOTH            = 921,
    ANIM_LOCSPELLPRECASTBOTHCHANNEL        = 922,
    ANIM_FLYLOCSPELLPRECASTBOTHCHANNEL     = 923,
    ANIM_LOCSPELLCASTBOTHUP                = 924,
    ANIM_FLYLOCSPELLCASTBOTHUP             = 925,
    ANIM_LOCSPELLCASTBOTHFRONT             = 926,
    ANIM_FLYLOCSPELLCASTBOTHFRONT          = 927,
    ANIM_LOCSPELLCASTLEFTFRONT             = 928,
    ANIM_FLYLOCSPELLCASTLEFTFRONT          = 929,
    ANIM_LOCSPELLCASTRIGHTFRONT            = 930,
    ANIM_FLYLOCSPELLCASTRIGHTFRONT         = 931,
    ANIM_LOCSPELLCASTBOTHUPCHANNEL         = 932,
    ANIM_FLYLOCSPELLCASTBOTHUPCHANNEL      = 933,
    ANIM_LOCSPELLCASTBOTHFRONTCHANNEL      = 934,
    ANIM_FLYLOCSPELLCASTBOTHFRONTCHANNEL   = 935,
    ANIM_LOCSPELLCASTLEFTFRONTCHANNEL      = 936,
    ANIM_FLYLOCSPELLCASTLEFTFRONTCHANNEL   = 937,
    ANIM_LOCSPELLCASTRIGHTFRONTCHANNEL     = 938,
    ANIM_FLYLOCSPELLCASTRIGHTFRONTCHANNEL  = 939,
    ANIM_DRUREADYSPELLCAST                 = 940,
    ANIM_FLYDRUREADYSPELLCAST              = 941,
    ANIM_DRUSPELLPRECASTBOTH               = 942,
    ANIM_FLYDRUSPELLPRECASTBOTH            = 943,
    ANIM_DRUSPELLPRECASTBOTHCHANNEL        = 944,
    ANIM_FLYDRUSPELLPRECASTBOTHCHANNEL     = 945,
    ANIM_DRUSPELLCASTBOTHUP                = 946,
    ANIM_FLYDRUSPELLCASTBOTHUP             = 947,
    ANIM_DRUSPELLCASTBOTHFRONT             = 948,
    ANIM_FLYDRUSPELLCASTBOTHFRONT          = 949,
    ANIM_DRUSPELLCASTLEFTFRONT             = 950,
    ANIM_FLYDRUSPELLCASTLEFTFRONT          = 951,
    ANIM_DRUSPELLCASTRIGHTFRONT            = 952,
    ANIM_FLYDRUSPELLCASTRIGHTFRONT         = 953,
    ANIM_DRUSPELLCASTBOTHUPCHANNEL         = 954,
    ANIM_FLYDRUSPELLCASTBOTHUPCHANNEL      = 955,
    ANIM_DRUSPELLCASTBOTHFRONTCHANNEL      = 956,
    ANIM_FLYDRUSPELLCASTBOTHFRONTCHANNEL   = 957,
    ANIM_DRUSPELLCASTLEFTFRONTCHANNEL      = 958,
    ANIM_FLYDRUSPELLCASTLEFTFRONTCHANNEL   = 959,
    ANIM_DRUSPELLCASTRIGHTFRONTCHANNEL     = 960,
    ANIM_FLYDRUSPELLCASTRIGHTFRONTCHANNEL  = 961,
    ANIM_ARTMAINLOOP                       = 962,
    ANIM_FLYARTMAINLOOP                    = 963,
    ANIM_ARTDUALLOOP                       = 964,
    ANIM_FLYARTDUALLOOP                    = 965,
    ANIM_ARTFISTSLOOP                      = 966,
    ANIM_FLYARTFISTSLOOP                   = 967,
    ANIM_ARTBOWLOOP                        = 968,
    ANIM_FLYARTBOWLOOP                     = 969,
    ANIM_COMBATABILITY1H01OFF              = 970,
    ANIM_FLYCOMBATABILITY1H01OFF           = 971,
    ANIM_COMBATABILITY1H02OFF              = 972,
    ANIM_FLYCOMBATABILITY1H02OFF           = 973,
    ANIM_COMBATFURIOUSSTRIKE01             = 974,
    ANIM_FLYCOMBATFURIOUSSTRIKE01          = 975,
    ANIM_COMBATFURIOUSSTRIKE02             = 976,
    ANIM_FLYCOMBATFURIOUSSTRIKE02          = 977,
    ANIM_COMBATFURIOUSSTRIKES              = 978,
    ANIM_FLYCOMBATFURIOUSSTRIKES           = 979,
    ANIM_COMBATREADYSPELLCAST              = 980,
    ANIM_FLYCOMBATREADYSPELLCAST           = 981,
    ANIM_COMBATSHIELDTHROW                 = 982,
    ANIM_FLYCOMBATSHIELDTHROW              = 983,
    ANIM_PALSPELLCAST1HUP                  = 984,
    ANIM_FLYPALSPELLCAST1HUP               = 985,
    ANIM_COMBATREADYPOSTSPELLCAST          = 986,
    ANIM_FLYCOMBATREADYPOSTSPELLCAST       = 987,
    ANIM_PRIREADYPOSTSPELLCAST             = 988,
    ANIM_FLYPRIREADYPOSTSPELLCAST          = 989,
    ANIM_DHCOMBATRUN                       = 990,
    ANIM_FLYDHCOMBATRUN                    = 991,
    ANIM_COMBATSHIELDBASH                  = 992,
    ANIM_FLYCOMBATSHIELDBASH               = 993,
    ANIM_COMBATTHROW                       = 994,
    ANIM_FLYCOMBATTHROW                    = 995,
    ANIM_COMBATABILITY1HPIERCE             = 996,
    ANIM_FLYCOMBATABILITY1HPIERCE          = 997,
    ANIM_COMBATABILITY1HOFFPIERCE          = 998,
    ANIM_FLYCOMBATABILITY1HOFFPIERCE       = 999,
    ANIM_COMBATMUTILATE                    = 1000,
    ANIM_FLYCOMBATMUTILATE                 = 1001,
    ANIM_COMBATBLADESTORM                  = 1002,
    ANIM_FLYCOMBATBLADESTORM               = 1003,
    ANIM_COMBATFINISHINGMOVE               = 1004,
    ANIM_FLYCOMBATFINISHINGMOVE            = 1005,
    ANIM_COMBATLEAPSTART                   = 1006,
    ANIM_FLYCOMBATLEAPSTART                = 1007,
    ANIM_GLVTHROWMAIN                      = 1008,
    ANIM_FLYGLVTHROWMAIN                   = 1009,
    ANIM_GLVTHROWNOFF                      = 1010,
    ANIM_FLYGLVTHROWNOFF                   = 1011,
    ANIM_DHCOMBATSPRINT                    = 1012,
    ANIM_FLYDHCOMBATSPRINT                 = 1013,
    ANIM_COMBATABILITYGLV01                = 1014,
    ANIM_FLYCOMBATABILITYGLV01             = 1015,
    ANIM_COMBATABILITYGLV02                = 1016,
    ANIM_FLYCOMBATABILITYGLV02             = 1017,
    ANIM_COMBATABILITYGLVOFF0              = 1018,
    ANIM_FLYCOMBATABILITYGLVOFF01          = 1019,
    ANIM_COMBATABILITYGLVOFF02             = 1020,
    ANIM_FLYCOMBATABILITYGLVOFF02          = 1021,
    ANIM_COMBATABILITYGLVBIG01             = 1022,
    ANIM_FLYCOMBATABILITYGLVBIG01          = 1023,
    ANIM_COMBATABILITYGLVBIG02             = 1024,
    ANIM_FLYCOMBATABILITYGLVBIG02          = 1025,
    ANIM_READYGLV                          = 1026,
    ANIM_FLYREADYGLV                       = 1027,
    ANIM_COMBATABILITYGLVBIG03             = 1028,
    ANIM_FLYCOMBATABILITYGLVBIG03          = 1029,
    ANIM_DOUBLEJUMPSTART                   = 1030,
    ANIM_FLYDOUBLEJUMPSTART                = 1031,
    ANIM_DOUBLEJUMP                        = 1032,
    ANIM_FLYDOUBLEJUMP                     = 1033,
    ANIM_COMBATEVISCERATE                  = 1034,
    ANIM_FLYCOMBATEVISCERATE               = 1035,
    ANIM_DOUBLEJUMPLANDRUN                 = 1036,
    ANIM_FLYDOUBLEJUMPLANDRUN              = 1037,
    ANIM_BACKFLIPSTART                     = 1038,
    ANIM_FLYBACKFLIPSTART                  = 1039,
    ANIM_BACKFLIPLOOP                      = 1040,
    ANIM_FLYBACKFLIPLOOP                   = 1041,
    ANIM_FELRUSHLOOP                       = 1042,
    ANIM_FLYFELRUSHLOOP                    = 1043,
    ANIM_FELRUSHEND                        = 1044,
    ANIM_FLYFELRUSHEND                     = 1045,
    ANIM_DHTOALTEREDSTART                  = 1046,
    ANIM_FLYDHTOALTEREDSTART               = 1047,
    ANIM_DHTOALTEREDEND                    = 1048,
    ANIM_FLYDHTOALTEREDEND                 = 1049,
    ANIM_DHGLIDE                           = 1050,
    ANIM_FLYDHGLIDE                        = 1051,
    ANIM_FANOFKNIVES                       = 1052,
    ANIM_FLYFANOFKNIVES                    = 1053,
    ANIM_SINGLEJUMPSTART                   = 1054,
    ANIM_FLYSINGLEJUMPSTART                = 1055,
    ANIM_DHBLADEDANCE1                     = 1056,
    ANIM_FLYDHBLADEDANCE1                  = 1057,
    ANIM_DHBLADEDANCE2                     = 1058,
    ANIM_FLYDHBLADEDANCE2                  = 1059,
    ANIM_DHBLADEDANCE3                     = 1060,
    ANIM_FLYDHBLADEDANCE3                  = 1061,
    ANIM_DHMETEORSTRIKE                    = 1062,
    ANIM_FLYDHMETEORSTRIKE                 = 1063,
    ANIM_COMBATEXECUTE                     = 1064,
    ANIM_FLYCOMBATEXECUTE                  = 1065,
    ANIM_ARTLOOP                           = 1066,
    ANIM_FLYARTLOOP                        = 1067,
    ANIM_PARRYGLV                          = 1068,
    ANIM_FLYPARRYGLV                       = 1069,
    ANIM_COMBATUNARMED02                   = 1070,
    ANIM_FLYCOMBATUNARMED02                = 1071,
    ANIM_COMBATPISTOLSHOT                  = 1072,
    ANIM_FLYCOMBATPISTOLSHOT               = 1073,
    ANIM_COMBATPISTOLSHOTOFF               = 1074,
    ANIM_FLYCOMBATPISTOLSHOTOFF            = 1075,
    ANIM_MONK2HLIDLE                       = 1076,
    ANIM_FLYMONK2HLIDLE                    = 1077,
    ANIM_ARTSHIELDLOOP                     = 1078,
    ANIM_FLYARTSHIELDLOOP                  = 1079,
    ANIM_COMBATABILITY2H03                 = 1080,
    ANIM_FLYCOMBATABILITY2H0               = 1081,
    ANIM_COMBATSTOMP                       = 1082,
    ANIM_FLYCOMBATSTOMP                    = 1083,
    ANIM_COMBATROAR                        = 1084,
    ANIM_FLYCOMBATROAR                     = 1085,
    ANIM_PALREADYSPELLCAST                 = 1086,
    ANIM_FLYPALREADYSPELLCAST              = 1087,
    ANIM_PALSPELLPRECASTRIGHT              = 1088,
    ANIM_FLYPALSPELLPRECASTRIGHT           = 1089,
    ANIM_PALSPELLPRECASTRIGHTCHANNEL       = 1090,
    ANIM_FLYPALSPELLPRECASTRIGHTCHANNEL    = 1091,
    ANIM_PALSPELLCASTRIGHTFRONT            = 1092,
    ANIM_FLYPALSPELLCASTRIGHTFRONT         = 1093,
    ANIM_SHASPELLCASTBOTHOUT               = 1094,
    ANIM_FLYSHASPELLCASTBOTHOUT            = 1095,
    ANIM_ATTACKWEAPON                      = 1096,
    ANIM_FLYATTACKWEAPON                   = 1097,
    ANIM_READYWEAPON                       = 1098,
    ANIM_FLYREADYWEAPON                    = 1099,
    ANIM_ATTACKWEAPONOFF                   = 1100,
    ANIM_FLYATTACKWEAPONOFF                = 1101,
    ANIM_SPECIALDUAL                       = 1102,
    ANIM_FLYSPECIALDUAL                    = 1103,
    ANIM_FUTUREPATCH01                     = 1104,
    ANIM_FLYFUTUREPATCH01                  = 1105,
    ANIM_FUTUREPATCH02                     = 1106,
    ANIM_FLYFUTUREPATCH02                  = 1107,
    ANIM_FUTUREPATCH03                     = 1108,
    ANIM_FLYFUTUREPATCH03                  = 1109,
    ANIM_FUTUREPATCH04                     = 1110,
    ANIM_FLYFUTUREPATCH04                  = 1111,
    ANIM_FUTUREPATCH05                     = 1112,
    ANIM_FLYFUTUREPATCH05                  = 1113,
    ANIM_FUTUREPATCH06                     = 1114,
    ANIM_FLYFUTUREPATCH06                  = 1115,
    ANIM_FUTUREPATCH07                     = 1116,
    ANIM_FLYFUTUREPATCH07                  = 1117,
    ANIM_FUTUREPATCH08                     = 1118,
    ANIM_FLYFUTUREPATCH08                  = 1119,
    ANIM_FUTUREPATCH09                     = 1120,
    ANIM_FLYFUTUREPATCH09                  = 1121,
    ANIM_FUTUREPATCH10                     = 1122,
    ANIM_FLYFUTUREPATCH10                  = 1123,
    ANIM_DRUMLOOP                          = 1124,
    ANIM_FLYDRUMLOOP                       = 1125
};
...
enum CreatureFamily
{
    ...
    CREATURE_FAMILY_HORSE_CUSTOM        = 10,   // Does not exist in DB2 but used for horse like beasts in DB
    ...
    CREATURE_FAMILY_MECHANICAL          = 154,  ///< 7.0.3
    CREATURE_FAMILY_ABOMINATION         = 155,  ///< 7.0.3
    CREATURE_FAMILY_SCALEHIDEL          = 156,  ///< 7.0.3
    CREATURE_FAMILY_OXEN                = 157,  ///< 7.0.3
    CREATURE_FAMILY_FEATHERMANE         = 160,  ///< 7.3.2
    CREATURE_FAMILY_VOID_STALKER        = 161,  ///< 7.3.5
...
enum CreatureTypeFlags2
{
    ...
    CREATURE_TYPEFLAGS_2_UNK12          = 0x00000800, ///< Maybe scaling level
...
enum HolidayIds
{
    ...
    HOLIDAY_DARKMOON_FAIRE_ELWYNN                = 374, ///< don't exist in DB2 anymore
    HOLIDAY_DARKMOON_FAIRE_THUNDER               = 375, ///< don't exist in DB2 anymore
    HOLIDAY_DARKMOON_FAIRE_SHATTRATH             = 376, ///< don't exist in DB2 anymore
    ...
    HOLIDAY_TIMEWALKING_1                        = 587,
    HOLIDAY_ANNIVERSARY_12_YERS                  = 589,
    HOLIDAY_AUCTION_HOUSE_DANCE_PARTY_1          = 590,
    HOLIDAY_BONUS_EVENT_LEGION_DUNGEON           = 591,
    HOLIDAY_BONUS_EVENT_WORLD_QUEST              = 592,
    HOLIDAY_BONUS_EVENT_APEXIS_1                 = 593,
    HOLIDAY_BONUS_EVENT_APEXIS_2                 = 594,
    HOLIDAY_BONUS_EVENT_APEXIS_3                 = 595,
    HOLIDAY_BONUS_EVENT_DRAENOR_DUNGEON_1        = 596,
    HOLIDAY_BONUS_EVENT_DRAENOR_DUNGEON_2        = 597,
    HOLIDAY_BONUS_EVENT_DRAENOR_DUNGEON_3        = 598,
    HOLIDAY_BONUS_EVENT_PET_BATTLE_1             = 599,
    HOLIDAY_BONUS_EVENT_PET_BATTLE_2             = 600,
    HOLIDAY_BONUS_EVENT_PET_BATTLE_3             = 601,
    HOLIDAY_BONUS_EVENT_BATTLEGROUND_1           = 602,
    HOLIDAY_BONUS_EVENT_BATTLEGROUND_2           = 603,
    HOLIDAY_BONUS_EVENT_BATTLEGROUND_3           = 604,
    HOLIDAY_BONUS_EVENT_LEGION_DUNGEON_1         = 605,
    HOLIDAY_BONUS_EVENT_LEGION_DUNGEON_2         = 606,
    HOLIDAY_BONUS_EVENT_LEGION_DUNGEON_3         = 607,
    HOLIDAY_BONUS_EVENT_ARENA_SKIRMISH_1         = 610,
    HOLIDAY_BONUS_EVENT_ARENA_SKIRMISH_2         = 611,
    HOLIDAY_BONUS_EVENT_ARENA_SKIRMISH_3         = 612,
    HOLIDAY_BONUS_EVENT_WORLD_QUEST_1            = 613,
    HOLIDAY_BONUS_EVENT_WORLD_QUEST_2            = 614,
    HOLIDAY_BONUS_EVENT_WORLD_QUEST_3            = 615,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_1    = 616,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_2    = 617,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_3    = 618,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_4    = 622,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_5    = 623,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_6    = 624,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_7    = 628,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_8    = 629,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_9    = 630,
    HOLIDAY_BONUS_EVENT_HATCHING_HIPPOGRYPHS     = 634, ///< http://www.wowhead.com/event=634
    HOLIDAY_BONUS_EVENT_VOLUNTEER_GUARD_DAY      = 635,
    HOLIDAY_BONUS_EVENT_DIABLO20TH_ANNIVERSARY   = 636,
    HOLIDAY_BONUS_EVENT_DIABLO20TH_ANNIVERSARY_1 = 637,
    HOLIDAY_BONUS_EVENT_CALL_OF_SCARAB           = 638, ///< http://www.wowhead.com/event=638/
    HOLIDAY_BONUS_EVENT_THOUSAND_BOAT_BASH       = 642, ///< http://www.wowhead.com/event=644/
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_10   = 643,
    HOLIDAY_BONUS_EVENT_UNGORO_MADNESS           = 644, ///< http://www.wowhead.com/event=644/
    HOLIDAY_BONUS_EVENT_SPRING_BALOON_FESTIVAL   = 645, ///< http://www.wowhead.com/event=645/
    HOLIDAY_BONUS_EVENT_KIRINTOR_TAVERN_CRAWL    = 646, ///< http://www.wowhead.com/event=646/
    HOLIDAY_BONUS_EVENT_MARCH_OF_TADPOLES        = 647, ///< http://www.wowhead.com/event=647/
    HOLIDAY_BONUS_EVENT_GLOWCAP_FESTIVAL         = 648, ///< http://www.wowhead.com/event=648/
    HOLIDAY_715_0                                = 650,
    HOLIDAY_715_1                                = 651,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_11   = 652,
    HOLIDAY_715_2                                = 653,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_12   = 654,
    HOLIDAY_715_3                                = 655,
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_13   = 656,
    HOLIDAY_715_4                                = 657,
    /// since 7.1.5 blizz added 124 event entry
    HOLIDAY_FIREWORKS_CELEBRATION                = 658, ///< http://www.wowhead.com/event=658/
    HOLIDAY_GRAVITY_LAPSE_1                      = 659, ///< PvP Brawl: Gravity Lapse
    HOLIDAY_SOUTHSHORE_VS_TARREN_MILL_1          = 660, ///< PvP Brawl: Southshore vs. Tarren Mill
    HOLIDAY_WARSONG_SCRAMBLE_1                   = 661, ///< PvP Brawl: Warsong Scramble
    HOLIDAY_SOUTHSHORE_VS_TARREN_MILL_2          = 662, ///< PvP Brawl: Southshore vs. Tarren Mill
    HOLIDAY_GRAVITY_LAPSE_2                      = 663, ///< PvP Brawl: Gravity Lapse
    HOLIDAY_WARSONG_SCRAMBLE_2                   = 664, ///< PvP Brawl: Warsong Scramble
    HOLIDAY_DEEPWIND_DEEP_1                      = 665, ///< PvP Brawl: Deepwind Dunk
    HOLIDAY_ARATHI_BLIZZARD_1                    = 666, ///< PvP Brawl: Arathi Blizzard
    HOLIDAY_PACKED_HOUSE_1                       = 667, ///< PvP Brawl: Packed House
    HOLIDAY_TEMPLE_OF_HOTMOGU_1                  = 668, ///< PvP Brawl: Temple of Hotmogu
    HOLIDAY_SOUTHSHORE_VS_TARREN_MILL_3          = 669, ///< PvP Brawl: Southshore vs. Tarren Mill
    HOLIDAY_GRAVITY_LAPSE_3                      = 670, ///< PvP Brawl: Gravity Lapse
    HOLIDAY_WARSONG_SCRAMBLE_3                   = 671, ///< PvP Brawl: Warsong Scramble
    HOLIDAY_DEEPWIND_DEEP_2                      = 672, ///< PvP Brawl: Deepwind Dunk
    HOLIDAY_ARATHI_BLIZZARD_2                    = 673, ///< PvP Brawl: Arathi Blizzard
    HOLIDAY_PACKED_HOUSE_2                       = 674, ///< PvP Brawl: Packed House
    HOLIDAY_TEMPLE_OF_HOTMOGU_2                  = 675, ///< PvP Brawl: Temple of Hotmogu
    HOLIDAY_SOUTHSHORE_VS_TARREN_MILL_4          = 676, ///< PvP Brawl: Southshore vs. Tarren Mill
    HOLIDAY_GRAVITY_LAPSE_4                      = 677, ///< PvP Brawl: Gravity Lapse
    HOLIDAY_WARSONG_SCRAMBLE_4                   = 678, ///< PvP Brawl: Warsong Scramble
    HOLIDAY_DEEPWIND_DEEP_3                      = 679, ///< PvP Brawl: Deepwind Dunk
    HOLIDAY_ARATHI_BLIZZARD_3                    = 680, ///< PvP Brawl: Arathi Blizzard
    HOLIDAY_PACKED_HOUSE_3                       = 681, ///< PvP Brawl: Packed House
    HOLIDAY_TEMPLE_OF_HOTMOGU_3                  = 682, ///< PvP Brawl: Temple of Hotmogu
    HOLIDAY_SOUTHSHORE_VS_TARREN_MILL_5          = 683, ///< PvP Brawl: Southshore vs. Tarren Mill
    HOLIDAY_GRAVITY_LAPSE_5                      = 684, ///< PvP Brawl: Gravity Lapse
    HOLIDAY_WARSONG_SCRAMBLE_5                   = 685, ///< PvP Brawl: Warsong Scramble
    HOLIDAY_DEEPWIND_DEEP_4                      = 686, ///< PvP Brawl: Deepwind Dunk
    HOLIDAY_ARATHI_BLIZZARD_4                    = 687, ///< PvP Brawl: Arathi Blizzard
    HOLIDAY_PACKED_HOUSE_4                       = 688, ///< PvP Brawl: Packed House
    HOLIDAY_TEMPLE_OF_HOTMOGU_4                  = 689, ///< PvP Brawl: Temple of Hotmogu
    HOLIDAY_UNK_LEGION_1                         = 690, ///< No name
    HOLIDAY_TRIAL_OF_STYLE                       = 691, ///< http://www.wowhead.com/event=691/
    HOLIDAY_AUCTION_HOUSE_DANCE_PARTY_2          = 692, ///< http://www.wowhead.com/event=692/
    HOLIDAY_WOW_13TH_BIRTHDAY                    = 693, ///< http://www.wowhead.com/event=693/
    HOLIDAY_MOONKIN_FESTIVAL                     = 694, ///< http://www.wowhead.com/event=694/
    HOLIDAY_UNK_LEGION_2                         = 695, ///< No name 7.3.2
    HOLIDAY_GNOMEREGAN_RUN                       = 696, ///< http://www.wowhead.com/event=696
    HOLIDAY_UNK_LEGION_3                         = 697, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_4                         = 698, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_5                         = 699, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_6                         = 700, ///< No name 7.3.2
    HOLIDAY_WARSONG_SCRAMBLE_6                   = 701, ///< PvP Brawl: Warsong Scramble
    HOLIDAY_DEEP_SIX_1                           = 702, ///< PvP Brawl: Deep Six
    HOLIDAY_SHADOPAN_SHOWDOWN_1                  = 703, ///< PvP Brawl: Shado-Pan Showdown
    HOLIDAY_DEEP_SIX_2                           = 704, ///< PvP Brawl: Deep Six
    HOLIDAY_DEEP_SIX_3                           = 705, ///< PvP Brawl: Deep Six
    HOLIDAY_DEEP_SIX_4                           = 706, ///< PvP Brawl: Deep Six
    HOLIDAY_SHADOPAN_SHOWDOWN_2                  = 707, ///< PvP Brawl: Shado-Pan Showdown
    HOLIDAY_SHADOPAN_SHOWDOWN_3                  = 708, ///< PvP Brawl: Shado-Pan Showdown
    HOLIDAY_SHADOPAN_SHOWDOWN_4                  = 709, ///< PvP Brawl: Shado-Pan Showdown
    HOLIDAY_TOMB_OF_SARGERAS_1                   = 710, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_2                   = 711, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_3                   = 712, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_4                   = 713, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_5                   = 714, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_6                   = 715, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_7                   = 716, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_8                   = 717, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_9                   = 718, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_10                  = 719, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_11                  = 720, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_12                  = 721, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_13                  = 722, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_14                  = 723, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_15                  = 724, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_16                  = 725, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_17                  = 726, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_18                  = 727, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_19                  = 728, ///< Tomb of Sargeras
    HOLIDAY_TOMB_OF_SARGERAS_20                  = 729, ///< Tomb of Sargeras
    HOLIDAY_BONUS_EVENT_TIMEWALKING_DUNGEON_14   = 732, ///< Timewalking Dungeon Event
    HOLIDAY_SHADOPAN_SHOWDOWN_5                  = 735, ///< PvP Brawl: Shado-Pan Showdown
    HOLIDAY_DEEP_SIX_5                           = 736, ///< PvP Brawl: Deep Six
    HOLIDAY_ARATHI_BLIZZARD_5                    = 737, ///< PvP Brawl: Arathi Blizzard
    HOLIDAY_DEEPWIND_DEEP_5                      = 738, ///< PvP Brawl: Deepwind Dunk
    HOLIDAY_TEMPLE_OF_HOTMOGU_5                  = 739, ///< PvP Brawl: Temple of Hotmogu
    HOLIDAY_UNK_LEGION_7                         = 740, ///<  No name 7.3.2
    HOLIDAY_UNK_LEGION_8                         = 741, ///<  No name 7.3.2
    HOLIDAY_UNK_LEGION_9                         = 742, ///<  No name 7.3.2
    HOLIDAY_UNK_LEGION_10                        = 743, ///<  No name 7.3.2
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_2_UNLOCKS_1    = 744, ///< 7.3 Shadows of Argus: Week 2 Unlocks
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_3_UNLOCKS_1    = 745, ///< 7.3 Shadows of Argus: Week 3 Unlocks
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_2_UNLOCKS_2    = 746, ///< 7.3 Shadows of Argus: Week 2 Unlocks
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_2_UNLOCKS_3    = 747, ///< 7.3 Shadows of Argus: Week 2 Unlocks
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_2_UNLOCKS_4    = 748, ///< 7.3 Shadows of Argus: Week 2 Unlocks
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_3_UNLOCKS_2    = 749, ///< 7.3 Shadows of Argus: Week 3 Unlocks
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_3_UNLOCKS_3    = 750, ///< 7.3 Shadows of Argus: Week 3 Unlocks
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_3_UNLOCKS_4    = 751, ///< 7.3 Shadows of Argus: Week 3 Unlocks
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_1_UNLOCKS_1    = 752, ///< 7.3 Shadows of Argus: Week 1
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_1_UNLOCKS_2    = 753, ///< 7.3 Shadows of Argus: Week 1
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_1_UNLOCKS_3    = 754, ///< 7.3 Shadows of Argus: Week 1
    HOLIDAY_SHADOWS_OF_ARGUS_WEEK_1_UNLOCKS_4    = 755, ///< 7.3 Shadows of Argus: Week 1
    HOLIDAY_ANTORUS_LFR_FORBIDEN_DESCENT_1       = 756, ///< Antorus, the Burning Throne LFR Forbidden Descent
    HOLIDAY_ANTORUS_LFR_FORBIDEN_DESCENT_2       = 757, ///< Antorus, the Burning Throne LFR Forbidden Descent
    HOLIDAY_ANTORUS_LFR_FORBIDEN_DESCENT_3       = 758, ///< Antorus, the Burning Throne LFR Forbidden Descent
    HOLIDAY_ANTORUS_LFR_FORBIDEN_DESCENT_4       = 759, ///< Antorus, the Burning Throne LFR Forbidden Descent
    HOLIDAY_ANTORUS_LFR_HOPES_END_1              = 760, ///< Antorus, the Burning Throne LFR Hope's End
    HOLIDAY_ANTORUS_LFR_HOPES_END_2              = 761, ///< Antorus, the Burning Throne LFR Hope's End
    HOLIDAY_ANTORUS_LFR_HOPES_END_3              = 762, ///< Antorus, the Burning Throne LFR Hope's End
    HOLIDAY_ANTORUS_LFR_HOPES_END_4              = 763, ///< Antorus, the Burning Throne LFR Hope's End
    HOLIDAY_ANTORUS_LFR_SEAT_OF_PANTHEON_1       = 764, ///< Antorus, the Burning Throne LFR Seat of the Pantheon
    HOLIDAY_ANTORUS_LFR_SEAT_OF_PANTHEON_2       = 765, ///< Antorus, the Burning Throne LFR Seat of the Pantheon
    HOLIDAY_ANTORUS_LFR_SEAT_OF_PANTHEON_3       = 766, ///< Antorus, the Burning Throne LFR Seat of the Pantheon
    HOLIDAY_ANTORUS_LFR_SEAT_OF_PANTHEON_4       = 767, ///< Antorus, the Burning Throne LFR Seat of the Pantheon
    HOLIDAY_ANTORUS_LFR_LIGHTS_BREACH_1          = 768, ///< Antorus, the Burning Throne LFR Light's Breach
    HOLIDAY_ANTORUS_LFR_LIGHTS_BREACH_2          = 769, ///< Antorus, the Burning Throne LFR Light's Breach
    HOLIDAY_ANTORUS_LFR_LIGHTS_BREACH_3          = 770, ///< Antorus, the Burning Throne LFR Light's Breach
    HOLIDAY_ANTORUS_LFR_LIGHTS_BREACH_4          = 771, ///< Antorus, the Burning Throne LFR Light's Breach
    HOLIDAY_ANTORUS_LFR_UNK_1                    = 772, ///< Antorus, the Burning Throne
    HOLIDAY_ANTORUS_LFR_UNK_2                    = 773, ///< Antorus, the Burning Throne
    HOLIDAY_ANTORUS_LFR_UNK_3                    = 774, ///< Antorus, the Burning Throne
    HOLIDAY_ANTORUS_LFR_UNK_4                    = 775, ///< Antorus, the Burning Throne
    HOLIDAY_ANTORUS_LFR_UNK_5                    = 776, ///< Antorus, the Burning Throne
    HOLIDAY_ANTORUS_LFR_UNK_6                    = 777, ///< Antorus, the Burning Throne
    HOLIDAY_UNK_LEGION_11                        = 778, ///< Antorus, the Burning Throne
    HOLIDAY_UNK_LEGION_12                        = 779, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_13                        = 780, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_14                        = 781, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_15                        = 782, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_16                        = 783, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_17                        = 784, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_18                        = 786, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_19                        = 787, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_20                        = 788, ///< No name 7.3.2
    HOLIDAY_UNK_LEGION_21                        = 789, ///< Antorus, the Burning Throne
    HOLIDAY_UNK_LEGION_22                        = 790, ///< Antorus, the Burning Throne
    HOLIDAY_UNK_LEGION_23                        = 791, ///< Antorus, the Burning Throne
    HOLIDAY_UNK_LEGION_24                        = 792, ///< Antorus, the Burning Throne
    HOLIDAY_UNK_LEGION_25                        = 793, ///< Antorus, the Burning Throne
    HOLIDAY_UNK_LEGION_26                        = 794, ///< Antorus, the Burning Throne
    HOLIDAY_UNK_LEGION_27                        = 797, ///< No name 7.3.5
    HOLIDAY_UNK_LEGION_28                        = 798, ///< No name 7.3.5
    HOLIDAY_UNK_LEGION_29                        = 799, ///< No name 7.3.5
    HOLIDAY_UNK_LEGION_30                        = 800, ///< No name 7.3.5
    HOLIDAY_UNK_LEGION_31                        = 801, ///< No name 7.3.5
    HOLIDAY_UNK_LEGION_32                        = 802, ///< No name 7.3.5
    HOLIDAY_UNK_LEGION_33                        = 803, ///< No name 7.3.5
    HOLIDAY_UNK_LEGION_34                        = 804, ///< No name 7.3.5
    HOLIDAY_UNK_LEGION_35                        = 805, ///< No name 7.3.5
    HOLIDAY_UNK_LEGION_36                        = 806, ///< No name 7.3.5
    HOLIDAY_UNK_LEGION_37                        = 809, ///< No name 7.3.5
...
enum QuestInfos
{
    ...
    QUEST_INFO_SCENARIO                   = 98,  ///< 5.0.5
    QUEST_INFO_ACCOUNT                    = 102, ///< 5.0.5
    QUEST_INFO_SIDE_QUEST                 = 104, ///< 6.0.1
    QUEST_INFO_ARTIFACT                   = 107, ///< 7.0.3
    QUEST_INFO_WORLD_QUEST                = 109, ///< 7.0.3
    QUEST_INFO_EPIC_WORLD_QUEST           = 110, ///< 7.0.3
    QUEST_INFO_ELITE_WORLD_QUEST          = 112, ///< 7.0.3
    QUEST_INFO_PVP_WORLD_QUEST            = 113, ///< 7.0.3
    QUEST_INFO_FIRST_AID_WORLD_QUEST      = 114, ///< 7.0.3
    QUEST_INFO_BATTLE_PET_WORLD_QUEST     = 115, ///< 7.0.3
    QUEST_INFO_BLACKSMITHING_WORLD_QUEST  = 116, ///< 7.0.3
    QUEST_INFO_LEATHERWORKING_WORLD_QUEST = 117, ///< 7.0.3
    QUEST_INFO_ALCHEMY_WORLD_QUEST        = 118, ///< 7.0.3
    QUEST_INFO_HERBALISM_WORLD_QUEST      = 119, ///< 7.0.3
    QUEST_INFO_MINING_WORLD_QUEST         = 120, ///< 7.0.3
    QUEST_INFO_TAILORING_WORLD_QUEST      = 121, ///< 7.0.3
    QUEST_INFO_ENGINEERING_WORLD_QUEST    = 122, ///< 7.0.3
    QUEST_INFO_ENCHANTING_WORLD_QUEST     = 123, ///< 7.0.3
    QUEST_INFO_SKINNING_WORLD_QUEST       = 124, ///< 7.0.3
    QUEST_INFO_JEWELCRAFTING_WORLD_QUEST  = 125, ///< 7.0.3
    QUEST_INFO_INSCRIPTION_WORLD_QUEST    = 126, ///< 7.0.3
    QUEST_INFO_EMISSARY                   = 128, ///< 7.0.3
    QUEST_INFO_ARCHAEOLOGY_WORLD_QUEST    = 129, ///< 7.0.3
    QUEST_INFO_FISHING_WORLD_QUEST        = 130, ///< 7.0.3
    QUEST_INFO_COOKING_WORLD_QUEST        = 131, ///< 7.0.3
    QUEST_INFO_RARE_WORLD_QUEST           = 135, ///< 7.0.3
    QUEST_INFO_RARE_ELITE_WORLD_QUEST     = 136, ///< 7.0.3
    QUEST_INFO_DUNGEON_WORLD_QUEST        = 137, ///< 7.0.3
    QUEST_INFO_LEGION_INVASION_WQ         = 139, ///< 7.2.0
    QUEST_INFO_RATED_REWARD               = 140, ///< 7.1.X
    QUEST_INFO_RAID_WORLD_QUEST           = 141, ///< 7.2.0
    QUEST_INFO_LEGION_INVASION_ELITE_WQ   = 142, ///< 7.2.0
    QUEST_INFO_LEGIONFALL_CONTRIBUTION    = 143, ///< 7.2.0
    QUEST_INFO_LEGIONFALL_WQ              = 144, ///< 7.2.0
    QUEST_INFO_LEGIONFALL_DUNGEON_WQ      = 145, ///< 7.2.0
    QUEST_INFO_LEGION_INVASION_WQ_WRAPPER = 146, ///< 7.3.X
    QUEST_INFO_PICKPOCKETING              = 148,  ///< 7.3.X
...
enum QuestSort
{
    ...
    QUEST_SORT_ARTIFACT               = 406, ///< 7.0.3
    QUEST_SORT_DEMON_HUNTER           = 407, ///< 7.0.3
    QUEST_SORT_MINING                 = 408, ///< 7.0.3
    QUEST_SORT_WEEKEND_EVENT          = 409, ///< 6.2.0 Holiday bonus event quest
    QUEST_SORT_ENCHANTING             = 410, ///< 7.0.3
    QUEST_SORT_SKINNING               = 411, ///< 7.0.3
    QUEST_SORT_WORLD_QUEST            = 412, ///< 7.0.3
    QUEST_SORT_DEATH_KNIGHT_CAMPAIGN  = 413, ///< 7.0.3
    QUEST_SORT_DEMON_HUNTER_CAMPAIGN  = 416, ///< 7.0.3
    QUEST_SORT_DRUID_CAMPAIGNG        = 417, ///< 7.0.3
    QUEST_SORT_HUNTER_CAMPAIGN        = 418, ///< 7.0.3
    QUEST_SORT_MONK_CAMPAIGN          = 419, ///< 7.0.3
    QUEST_SORT_MAGE_CAMPAIGN          = 420, ///< 7.0.3
    QUEST_SORT_PRIEST_CAMPAIGN        = 421, ///< 7.0.3
    QUEST_SORT_PALADIN_CAMPAIGN       = 422, ///< 7.0.3
    QUEST_SORT_SHAMAN_CAMPAIGNG       = 423, ///< 7.0.3
    QUEST_SORT_ROGUE_CAMPAIGN         = 424, ///< 7.0.3
    QUEST_SORT_WARLOCK_CAMPAIGN       = 425, ///< 7.0.3
    QUEST_SORT_WARRIOR_CAMPAIGN       = 426, ///< 7.0.3
    QUEST_SORT_ORDER_HALL             = 427, ///< 7.0.3
    QUEST_SORT_THE_HUNT_FOR_ILLIDAN   = 429, ///< 7.1.X
    QUEST_SORT_PIRATE_DAY             = 430, ///< 7.1.X
    QUEST_SORT_ARGUS_EXPEDITION       = 431, ///< 7.3.X
    QUEST_SORT_MOONKIN_FESTIVAL       = 433, ///< 7.2.X
    QUEST_SORT_KINGS_PATH             = 434, ///< 7.2.X
    QUEST_SORT_DEATHS_OF_CHROMIE      = 435, ///< 7.2.X
    QUEST_SORT_ROCKET_CHICKEN         = 436, ///< 7.3.X
    QUEST_SORT_LIGHTFORGED_DRAENEI    = 437, ///< 7.3.X
    QUEST_SORT_HIGHMOUNTAIN_TAUREN    = 438, ///< 7.3.X
    QUEST_SORT_VOID_ELF               = 439, ///< 7.3.X
    QUEST_SORT_NIGHTBORNE             = 440, ///< 7.3.X
    QUEST_SORT_DUNGEON                = 441, ///< 7.3.X
    QUEST_SORT_RAID                   = 442, ///< 7.3.X
    QUEST_SORT_ALLIED_RACES           = 444, ///< 7.3.X
...
enum SkillCategory
{
    ...
    SKILL_CATEGORY_SECONDARY           = 9,  ///< secondary professions, racial skill
...
enum TotemCategory
{
    ...
    TC_JEWELERS_KIT                = 238,
    TC_ULTIMATE_GNOMISH_ARMY_KNIFE = 250, ///< 7.0.3
};
...
enum UnitDynFlags
{
    ...
    UNIT_DYNFLAG_NO_INTERACT                = 0x0001,
...
enum PetDiet
{
    ...
    PET_DIET_RAW_MEAT        = 7,
    PET_DIET_RAW_FISH        = 8,
    PET_DIET_MECHANICAL_BITS = 9, ///< 7.0.3
...
enum DiminishingGroup : uint16
{
    ...
    DIMINISHING_DISARM           = 5,
    DIMINISHING_SILENCE          = 6,
    DIMINISHING_AOE_KNOCKBACK    = 7,
    DIMINISHING_TAUNT            = 8,
    DIMINISHING_LIMITONLY        = 9,
...
enum SummonType
{
    ...
    SUMMON_TYPE_TRANSCENDENCE   = 17, ///< Monk Transcendence
    SUMMON_TYPE_WAR_BANNER      = 18, ///< Warrior War Banners
    SUMMON_TYPE_19              = 19,
    SUMMON_TYPE_20              = 20,
    SUMMON_TYPE_21              = 21,
    SUMMON_TYPE_23              = 23,
...
/// Last update 7.1.5 23420
/// indexes of BattlemasterList.db2
enum BattlegroundTypeId : uint32
{
    ...
    BATTLEGROUND_BE                    = 5,   ///< Blade's Edge Arena - Not in use anymore
    ...
    BATTLEGROUND_SVSTM                 = 789, ///< Brawl Southshore vs. Tarren Mill
    BATTLEGROUND_SBD                   = 803, ///< Small Battleground D
    BATTLEGROUND_BRH                   = 808, ///< Black Rook Hold Arena
    BATTLEGROUND_NA2                   = 809, ///< Nagrand Arena New map for NA in 7.1.5 NYI
    BATTLEGROUND_AF                    = 816, ///< Ashamane's Fall
    BATTLEGROUND_BEA                   = 844, ///< Blade's Edge Arena Revamp
    BATTLEGROUND_SEETHING_SHORE        = 894, ///< 7.3.5

    /// NYI
    BATTLEGROUND_BRAWL_UNK             = 846, ///< Comment say : "Brawl ?"
    BATTLEGROUND_AB_WINTER             = 847, ///< Brawl Arathi Bassin Blizzard
    BATTLEGROUND_BRAWL_6               = 849, ///< Brawl
    BATTLEGROUND_TP_SHOWDOWN           = 853, ///< Shado-Pan Brawl
    BATTLEGROUND_BFBM                  = 857, ///< Unreleased on retail
    BATTLEGROUND_BRAWL_3               = 858, ///< Brawl
    BATTLEGROUND_BRAWL_4               = 859, ///< Brawl
    BATTLEGROUND_BRAWL_9               = 861, ///< Brawl
    BATTLEGROUND_BRAWL_7               = 862, ///< Brawl
    BATTLEGROUND_BRAWL_AA              = 866, ///< All Arenas Brawl
    BATTLEGROUND_RUINS_OF_LORDAERON    = 868, ///< MaxPlayer = 15
    BATTLEGROUND_DALARAN_SEWERS        = 869, ///< MaxPlayer = 15
    BATTLEGROUND_TOLVIRON_ARENA        = 870, ///< MaxPlayer = 15
    BATTLEGROUND_THE_TIGERS_PEAK       = 871, ///< MaxPlayer = 15
    BATTLEGROUND_BLACK_ROOK_HOLD_ARENA = 872, ///< MaxPlayer = 15
    BATTLEGROUND_NAGRAND_ARENA         = 873, ///< MaxPlayer = 15
    BATTLEGROUND_ASHAMANES_FALL        = 874, ///< MaxPlayer = 15
    BATTLEGROUND_BLADES_EDGE_ARENA     = 875, ///< MaxPlayer = 15
    BATTLEGROUND_BRAWL_11              = 879, ///< Brawl
    BATTLEGROUND_ARATHI_BASSIN         = 880, ///< Brawl
    BATTLEGROUND_DEEPWING_GORGE        = 881, ///< Brawl
    BATTLEGROUND_EYE_OF_THE_STORM      = 882, ///< Brawl
    BATTLEGROUND_SILVERSHARD_MINES     = 883, ///< Brawl
    BATTLEGROUND_TEMPLE_OF_KOTMOGU     = 884, ///< Brawl
    BATTLEGROUND_THE_BATTLE_OF_GILNEAS = 885, ///< Brawl
    BATTLEGROUND_WARSONG_GLUCH         = 886, ///< Brawl
    BATTLEGROUND_COOKING_IMPOSSIBLE    = 887, ///< Marked as "TEMP" in description
    BATTLEGROUND_SEETHING_STRAND       = 890, ///< 7.3.5
...
enum SpellFamilyNames
{
    ...
    SPELLFAMILY_HOLIDAY         = 1, ///< events, holidays
    ...
    SPELLFAMILY_SILENCE_RESIST  = 12, ///< 3 spells (silence resistance and pure awesome)
    SPELLFAMILY_POTION          = 13,

    SPELLFAMILY_DEATHKNIGHT     = 15,

    SPELLFAMILY_PET             = 17,
    SPELLFAMILY_BOTANIST        = 50, ///< Used in quest like plant VS Zombie from NPC 49176
    SPELLFAMILY_MONK            = 53,

    SPELLFAMILY_WARLOCK_PET     = 57, ///< Special Ability
    SPELLFAMILY_WAR_SERPENT     = 66,
    SPELLFAMILY_MELON           = 71,
    SPELLFAMILY_BOSS_ZHAOJIN    = 78,
    SPELLFAMILY_BOSS_GARAJAL    = 91,
    SPELLFAMILY_SMOKE_BOMB      = 100, ///< used in ToT map scenario
    SPELLFAMILY_DEMONHUNTER     = 107,
    SPELLFAMILY_REMOVE_INSIGNA  = 110, ///< Spell 22027 & 247422 "Remove Insigna"
...
enum SpellWheight
{
    ...
    SPELL_WEIGHT_ARCHEOLOGY_KEYSTONES = 0x00
};
...
enum InstanceWorldStates
{
    ...
    NightholdNotReleased    = 21794,
    ToSNotReleased          = 22639,
    KilJaedensAchievement   = 22287,
    ArgusAchievement        = 24123
};

enum eRTKWorldStates
{
    OperaWikket = 20685,
    OperaWestfall = 20686,
    OperaBeautifulBeast = 20687
};
...
enum GarrItemLevelUpgradeOperation
{
    SetWeapon       = 1,
    SetArmor        = 2,
    IncreaseWeapon  = 2,
...
#define k_LegendaryBadLuckProtectionCap 80

enum MercenarySpells : uint32
{
    MercenaryContractHorde         = 193472,
    MercenaryContractAlliance      = 193475,
    MercenaryHorde1                = 193864,
    MercenaryHorde2                = 195838,
    MercenaryAlliance1             = 193863,
    MercenaryAlliance2             = 195843
};

enum ChallengeLevels : uint32
{
    Max = 35
};

static void LockIfNeed(std::atomic<bool>& bLock, std::recursive_mutex& mLock)
{
    if (bLock)
        std::lock_guard<std::recursive_mutex> guard(mLock);
}

static void LockIfNeed(std::atomic<bool> const& bLock, std::recursive_mutex& mLock)
{
    if (bLock)
        std::lock_guard<std::recursive_mutex> guard(mLock);
}
