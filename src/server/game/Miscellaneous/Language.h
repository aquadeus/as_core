...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_ARENA_2_HEALERS_3v3            = 773,
    // Room for BG/ARENA                = 774-784, 788-799 not used
    ...
    // Seething Shore
    LANG_BG_SS_START_TWO_MINUTES                = 1365,
    LANG_BG_SS_START_ONE_MINUTE                 = 1366,
    LANG_BG_SS_START_HALF_MINUTE                = 1367,
    LANG_BG_SS_HAS_BEGUN                        = 1368,
    LANG_BG_SS_AZERITE_FISSURES_BEGIN_ERUPT     = 1369,
    ...
    LANG_SCENARIO                       = 5039,
    LANG_NPCINFO_UNIT_NPC_FIELD_FLAGS   = 5040,
    LANG_NPCINFO_UNIT_NPC_FIELD_FLAGS2  = 5041,
    // Room for more Trinity strings      5042-6603
    ...
    /// Dragon Soul Heroic Mode
    LANG_DS_HEROIC_MODE                     = 13102,
    ...
    WorldQuestPvPFlagWarn,

    /// Custom
    WarnRaidTests = 20000,
    CharXPRateWarn,
    EasterEventLoyaltyPoints,
    EasterEventBunny,
    EasterEventFirestormPoints,
    EasterEventBadLuck,
    WarnUnequipItems,
    WarnClassHall,
    CharXPRateGossip = 20008,
    ...
    /// Misc
    LANG_NOT_ENOUGH_CURRENCY                = 30029,
    NoLogRecordsFound,
    ItemLogEntriesFound,
    ItemLogEntry,
    ...
    /// Cosmetic System
    AlreadyOwnedAura                        = 300010,
    AlreadyOwnedMorph,
    NotEnoughPoints,
    PurchasedCosmeticFor,
    ConfirmBuyCosmetic,
    BuyCosmeticLootBox                      = 300020,
    BuyCosmeticLootBoxes,
    ConfirmBuyCosmeticLootBox,
    PurchasedCosmeticLootboxFor,
    ReceivedCosmetic,
    ReceivedCosmeticAlreadyOwned,

    /// Garrison Addon
    GarrisonAddonMissing                    = 300050,

    /// Word Flter
    LANG_WORD_FILTER_FOUND_BAD_WORD_IN_CHAT = 300100,
    LANG_WORD_FILTER_FOUND_BAD_WORD_IN_MAIL = 300101,
    LANG_WORD_FILTER_SUCCESS_ADD_WORD       = 300102,
    LANG_WORD_FILTER_FAILED_ADD_WORD        = 300103,
    LANG_WORD_FILTER_SUCCESS_REMOVE_WORD    = 300104,
    LANG_WORD_FILTER_FAILED_REMOVE_WORD     = 300105,
    MessageNotSendBecauseFlood              = 300106,
    NextWarningIsAMute                      = 300107,
    MutedForXSeconds                        = 300108,
    MessageNotSendBecauseMute               = 300109,

    LANG_CURRENT_ART_KNOWLEDGE_LEVEL        = 300200,
    LANG_NO_ART_KNOWLEDGE_LEVEL             = 300201

    // NOT RESERVED IDS                   300202-399999
    // Addon Strings                      400000-499999
    // NOT RESERVED IDS                   500000-1999999999
