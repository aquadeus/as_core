...
class GmTicket
{
    public:
        ...
        void SetLocale(LocaleConstant p_Locale) { m_Locale = p_Locale; }
        LocaleConstant const GetLocale() const { return m_Locale; }
...
class TicketMgr
{
    ...
    public:
        ...
        void ShowList(ChatHandler& p_Handler, bool p_OnlineOnly, LocaleConstant p_Locale = LocaleConstant::LOCALE_None) const;
