...
class OutdoorPvPMgr
{
    ...
    public:
        ...
        /// Called when a player changes an outdoor pvp area
        void HandlePlayerUpdateArea(Player* p_Player, uint32 p_OldAreaID, uint32 p_NewAreaID);
        ...
        // handle custom (non-exist in db2) spell if registered
        ...
        void HandleLootReleased(Player* p_Player, uint64 p_GUID);
