...
namespace WorldPackets
{
    namespace Garrison
    {
        ...
        class GarrisonRequestUpgreadle final : public ClientPacket
        {
            public:
                GarrisonRequestUpgreadle(WorldPacket& packet) : ClientPacket(CMSG_GARRISON_CHECK_UPGRADEABLE, packet) { }
        ...
        {
            public:
                GarrisonIsUpgradeableResult() : ServerPacket(SMSG_GARRISON_IS_UPGRADEABLE_RESULT, 4 + 4) { }
        ...
        {
            public:
                GetGarrisonInfo(WorldPacket& packet) : ClientPacket(CMSG_GET_GARRISON_INFO, packet) { }
        ...
        struct GarrisonInfo
        {
            ...
            std::vector<GarrisonMissionAreaBonus> MissionAreaBonuses;
        ...
        {
            public:
                GarrisonPurchaseBuilding(WorldPacket& packet) : ClientPacket(CMSG_GARRISON_PURCHASE_BUILDING, packet) { }
        ...
        {
            public:
                GarrisonCancelConstruction(WorldPacket& packet) : ClientPacket(CMSG_GARRISON_CANCEL_CONSTRUCTION, packet) { }
        ...
        {
            public:
                GarrisonRequestBlueprintAndSpecializationData(WorldPacket& packet) : ClientPacket(CMSG_GARRISON_REQUEST_BLUEPRINT_AND_SPECIALIZATION_DATA, packet) { }
        ...
        {
            public:
                GarrisonGetBuildingLandmarks(WorldPacket& packet) : ClientPacket(CMSG_GARRISON_GET_BUILDING_LANDMARKS, packet) { }
