...
namespace WorldPackets
{
    namespace Scenario
    {
        ...
        {
        public:
            QueryScenarioPOI(WorldPacket& packet) : ClientPacket(CMSG_QUERY_SCENARIO_POI, packet) { }
        ...
        {
        public:
            NullSMsg(Opcodes opcode) : ServerPacket(opcode) { }
        ...
        public:
            ...
            std::vector<WorldPackets::Achievement::CriteriaProgress> Progress;
