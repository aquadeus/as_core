...
ByteBuffer& operator<<(ByteBuffer& data, WorldPackets::Garrison::GarrisonInfo const& garrison)
{
    ...
    for (WorldPackets::Garrison::GarrisonMission mission : garrison.Missions)
        data << mission;
    ...
    for (WorldPackets::Garrison::GarrisonMissionAreaBonus areaBonus : garrison.MissionAreaBonuses)
        data << areaBonus;
    ...
    for (WorldPackets::Garrison::GarrisonBuildingInfo building : garrison.Buildings)
        data << building;
    ...
    for (WorldPackets::Garrison::GarrisonFollower follower : garrison.Followers)
        data << follower;
