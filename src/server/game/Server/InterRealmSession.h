...
class InterRealmSession: public ACE_Based::Runnable
{
    public:
        ...
        void SendRegisterRated(GroupPtr group, uint32 personalRating, uint32 matchmakerRating);
        void SendRegisterPlayer(Player* player, uint32 bgInstanceId, uint64 bgGuid, uint32 bgTypeId, uint8 role, uint32* blacklist);
        void SendRegisterGroup(GroupPtr group, uint32 bgInstanceId, uint64 bgGuid, uint32 bgTypeId, uint8 role, uint32* blacklist);
        ...
        void Handle_BattlegroundInvited(WorldPacket& p_Packet);
        void Handle_BattlegroundLeaveQueue(WorldPacket& p_Packet);
        ...
        void Handle_RAFEvent(WorldPacket& p_Packet);
        ...
        void SendSummonPlayer(uint64 playerGuid, WorldLocation const& p_Location);
    ...
    private:
        void BuildAccountDatasBlock(Player* player, ByteBuffer& packet);
