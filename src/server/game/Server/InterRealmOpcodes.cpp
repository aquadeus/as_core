...
#define DEFINE_IR_OPCODE_HANDLER(opcode, handler) \
    ...
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_BATTLEGROUND_INVITED, &InterRealmSession::Handle_BattlegroundInvited);
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_BATTLEGROUND_LEAVE_QUEUE, &InterRealmSession::Handle_BattlegroundLeaveQueue);

    DEFINE_IR_OPCODE_HANDLER(IR_CMSG_RAF_EVENT, &InterRealmSession::Handle_ClientSide);
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_RAF_EVENT, &InterRealmSession::Handle_RAFEvent);
