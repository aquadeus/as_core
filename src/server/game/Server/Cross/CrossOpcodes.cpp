...
#define DEFINE_IR_OPCODE_HANDLER(opcode, handler) \
    ...
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_BATTLEGROUND_INVITED,      &InterRealmClient::Handle_ServerSide);
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_BATTLEGROUND_LEAVE_QUEUE,  &InterRealmClient::Handle_ServerSide);

    DEFINE_IR_OPCODE_HANDLER(IR_CMSG_RAF_EVENT,                 &InterRealmClient::Handle_RAFEvent);
    DEFINE_IR_OPCODE_HANDLER(IR_SMSG_RAF_EVENT,                 &InterRealmClient::Handle_ServerSide);
