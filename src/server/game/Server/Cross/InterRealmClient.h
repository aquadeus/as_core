...
class InterRealmClient
{
    public:
        ...
        void SendInvitedForBattlegroundQueueType(uint64 playerGUID, uint32 p_QueueID, uint32 bgQueueTypeId);

        void SendBattlegroundLeaveQueue(uint64 p_PlayerGUID, int32 p_RatingChange = 0, int32 p_MMRChange = 0, uint8 p_Slot = 0, bool p_Deserter = true);
