...
namespace MS { namespace Garrison { namespace GDraenor
{
    ...
    namespace ShipyardUIWorldMapAreaSwaps
    {
    ...
    namespace PurchaseBuildingResults
    {
        enum Type
        {
            ...
            InvalidPlot         = 1,
            InvalidBuildingID   = 2,
            InvalidPlotBuilding = 7,
            NoBuilding          = 8,
            SpecializationKnown = 19,
            BlueprintKown       = 21,
            RequireBluePrint    = 22,
            BuildingExists      = 24,
    ...
    /// UIWorldMapAreaSwap : See WorldMapArea.dbc
    enum
    {
        UI_WORLD_MAP_AREA_SWAP_GARRISON_FF_HORDE_TIER_1     = 980,
        UI_WORLD_MAP_AREA_SWAP_GARRISON_FF_HORDE_TIER_2     = 990,
        UI_WORLD_MAP_AREA_SWAP_GARRISON_FF_HORDE_TIER_3     = 981,
        UI_WORLD_MAP_AREA_SWAP_GARRISON_SMV_ALLIANCE_TIER_1 = 973,
        UI_WORLD_MAP_AREA_SWAP_GARRISON_SMV_ALLIANCE_TIER_2 = 991,
        UI_WORLD_MAP_AREA_SWAP_GARRISON_SMV_ALLIANCE_TIER_3 = 974
    };
