...
class MailSender
{
    public:                                                 // Constructors
        ...
        MailSender(AuctionEntryPtr sender);
        MailSender(BMAuctionEntryPtr sender);
...
class MailDraft
{
    ...
    public:                                                 // Accessors
        ...
        static void NormalizeMessage(std::string &body, std::string &subject);
