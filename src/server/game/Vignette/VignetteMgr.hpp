...
namespace Vignette
{
    using VignetteContainer = std::unordered_map<uint64, Vignette::Entity*>;
    ...
    class Manager
    {
        public:
            ...
            */
            template<class T>
            void OnWorldObjectAppear(T const* p_Target); ///< Inline function 'Vignette::Manager::OnWorldObjectAppear<WorldObject>' is not defined
            ...
            */
            template<class T>
            void OnWorldObjectDisappear(T const* p_Target); ///< Inline function 'Vignette::Manager::OnWorldObjectDisappear<WorldObject>' is not defined
        ...
        private:
            ...
            */
            ...
            ACE_RW_Thread_Mutex          m_VignettesLock;
            std::set<uint64>             m_RemovedCount;            ///< Contains all the removed vignettes to send to client at the next SMSG_VIGNETTE_UPDATE
            std::set<uint64>             m_AddedCount;              ///< Contains all the added vignettes to send to client at the next SMSG_VIGNETTE_UPDATE
