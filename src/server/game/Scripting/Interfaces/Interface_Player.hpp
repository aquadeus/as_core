...
class FormulaScript : public ScriptObjectImpl<false>
{
    ...
    public:
        ...
        virtual void OnBaseGainCalculation(uint32& p_Gain, uint8 p_PlayerLevel, uint8 p_MobLevel)
        {
            UNUSED(p_Gain);
            UNUSED(p_PlayerLevel);
            UNUSED(p_MobLevel);
...
class PlayerScript : public ScriptObjectImpl<false>
{
    ...
    public:
        ...
        /// @p_Killer : Killer instance
        /// @p_Killed : Killed instance
        /// @p_BeforeAurasRemoved : true if auras hasn't been removed yet
        virtual void OnKill(Player* p_Killer, Unit* p_Killed, bool p_BeforeAuraRemoved)
        {
            UNUSED(p_Killer);
            UNUSED(p_Killed);
            UNUSED(p_BeforeAuraRemoved);
        }

        /// Called when a Unit is killed
        /// @p_Killed : Unit instance
        /// @p_Attacker : Unit instance
        virtual void OnKillReward(Unit* p_Killed, Unit* p_Attacker)
        {
            UNUSED(p_Killed);
            UNUSED(p_Attacker);
        }
        ...
        virtual void OnMeleeHitRedirect(Unit* p_NewVictim, Unit* p_OldVictim, Aura* p_RedirectAura)
        {
            UNUSED(p_NewVictim);
            UNUSED(p_OldVictim);
            UNUSED(p_RedirectAura);
        }

        /// Called when a player finishes a non-taxi move spline
        /// @p_Player : Player instance
        virtual void OnMoveSplineDone(Player* p_Player)
        {
            UNUSED(p_Player);
        }
        ...
        virtual void OnSpellFinished(Player* p_Player, Spell* p_Spell, bool ok)
        {
            UNUSED(p_Player);
            UNUSED(p_Spell);
            UNUSED(ok);
        ...
        /// @p_Player : Player instance
        virtual void OnSummonPet(Player* p_Player)
        {
            UNUSED(p_Player);
        }
        ...
        virtual void OnMinionDespawn(Player* p_Player, Minion* p_Minion)
        {
            UNUSED(p_Player);
            UNUSED(p_Minion);
        }
        ...
        virtual void OnModifyCharges(Player* p_Player, uint32 p_CategoryChargeEntryID)
        {
            UNUSED(p_Player);
            UNUSED(p_CategoryChargeEntryID);
        }
        ...
        /// @p_Player : Player instance
        /// @p_Value  : New value
        virtual void OnModifyHealth(Player* p_Player, int64 p_Value, int64 p_OldValue)
        {
            UNUSED(p_Player);
            UNUSED(p_Value);
            UNUSED(p_OldValue);
        ...
        /// @p_Player : Player
        /// @p_SpellID : SpellID
        virtual void OnTeleport(Player* p_Player, const SpellInfo* p_SpellInfo, bool p_WorldPort)
        {
            UNUSED(p_Player);
            UNUSED(p_SpellInfo);
            UNUSED(p_WorldPort);
        ...
        virtual void OnChat(Player* p_Player, uint32 p_Type, uint32 p_Lang, std::string& p_Message, GroupPtr p_Group)
        {
            UNUSED(p_Player);
            UNUSED(p_Type);
            UNUSED(p_Lang);
        ...
        virtual void OnPlayerChoiceResponse(Player* p_Player, uint32 p_ChoiceID, uint32 p_ResponseID)
        {
            UNUSED(p_Player);
            UNUSED(p_ChoiceID);
            UNUSED(p_ResponseID);
        ...
        /// @p_Player    : Player instance
        /// @p_Spell     : Casted spell
        virtual void OnSpellInterrupt(Player* p_Player, Spell* p_Spell, Spell* p_InterruptingSpell, uint32 p_InterruptingSpellID)
        {
            UNUSED(p_Player);
            UNUSED(p_Spell);
            UNUSED(p_InterruptingSpell);
            UNUSED(p_InterruptingSpellID);
        }
        ...
        /// @p_Spell     : Casted spell
        /// @p_SkipCheck : Skipped checks
        virtual void AfterSpellCast(Player* p_Player, Spell* p_Spell, bool p_SkipCheck)
        {
            UNUSED(p_Player);
            UNUSED(p_Spell);
            UNUSED(p_SkipCheck);
        ...
        /// @p_Player  : Player instance
        /// @p_SpellID : Learned spell ID
        virtual void OnSpellRemoved(Player* p_Player, uint32 p_SpellID)
        {
            UNUSED(p_Player);
            UNUSED(p_SpellID);
        }
        ...
        /// Called when a player leave a map
        /// @p_Player : Player instance
        virtual void OnMapLeave(Player* p_Player)
        {
            UNUSED(p_Player);
        }

        /// Called when a player enter in a new map
        /// @p_Player : Player instance
        virtual void OnMapEnter(Player* p_Player)
        {
            UNUSED(p_Player);
        }
        ...
        virtual void OnBindToInstance(Player* p_Player, Difficulty p_Difficulty, uint32 p_MapID, bool p_Permanent, uint8 p_ExtendState)
        {
            UNUSED(p_Player);
            UNUSED(p_Difficulty);
            UNUSED(p_MapID);
            UNUSED(p_Permanent);
            UNUSED(p_ExtendState);
        }
        ...
        /// @p_Player : Player instance
        virtual void OnUpdateMovement(Player* p_Player, uint16 p_OpcodeID)
        {
            UNUSED(p_Player);
            UNUSED(p_OpcodeID);
        }
        ...
        virtual void OnDismount(Player* p_Player)
        {
            UNUSED(p_Player);
        }
        ...
        virtual void OnTakeDamage(Player* p_Player, Unit* p_Origin, DamageEffectType p_DamageEffectType, uint32 p_Damage, SpellSchoolMask p_SchoolMask, CleanDamage const* p_CleanDamage)
        {
            UNUSED(p_Origin);
            UNUSED(p_Player);
        ...
        /// @p_Damage          : Amount of damage taken
        /// @p_SchoolMask      : school mask of the damage
        virtual void OnDealDamage(Player* p_Player, Unit* p_Target, DamageEffectType p_DamageEffectType, uint32 p_Damage, SpellSchoolMask p_SchoolMask, CleanDamage const* p_CleanDamage)
        {
            UNUSED(p_Target);
            UNUSED(p_Player);
            UNUSED(p_DamageEffectType);
        ...
        virtual void OnMovieComplete(Player* p_Player, uint32 p_MovieId)
        {
            UNUSED(p_Player);
            UNUSED(p_MovieId);
        }
        ...
        virtual void OnBracketWin(Player* p_Player, BattlegroundBracketType p_Bracket)
        {
            UNUSED(p_Player);
            UNUSED(p_Bracket);
        }

        virtual void OnModifyCurrency(Player* p_Player, uint32 p_CurrencyID, int32& p_Count, bool p_IgnoreMultipliers)
        {
            UNUSED(p_Player);
            UNUSED(p_CurrencyID);
            UNUSED(p_Count);
            UNUSED(p_IgnoreMultipliers);
        }

        virtual void OnAfterUnequipItem(Player* p_Player, Item const* p_Item)
        {
            UNUSED(p_Player);
            UNUSED(p_Item);
        }

        virtual void OnAddRelicTalent(Player* p_Player)
        {
            UNUSED(p_Player);
        }

        virtual void OnActivateArgusTaxi(Player* p_Player, uint32 p_TaxiNodeId)
        {
            UNUSED(p_Player);
            UNUSED(p_TaxiNodeId);
        }

        virtual void OnGarrisonMissionComplete(Player* p_Player, uint32 p_MissionId, bool p_Succeeded)
        {
            UNUSED(p_Player);
            UNUSED(p_MissionId);
            UNUSED(p_Succeeded);
        ...
        virtual void OnAchievementComplete(Player* p_Player, AchievementEntry const* p_Achievement)
        {
            UNUSED(p_Player);
            UNUSED(p_Achievement);
        }
        ...
        virtual void OnPhaseUpdate(Player* p_Player, uint32 p_Quest, bool p_Accept)
        {
            UNUSED(p_Player);
            UNUSED(p_Quest);
            UNUSED(p_Accept);
