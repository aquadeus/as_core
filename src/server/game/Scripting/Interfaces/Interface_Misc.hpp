...
class ServerScript : public ScriptObjectImpl<false>
{
    ...
    public:
        ...
        virtual void OnPacketReceive(WorldPacket& p_Packet, WorldSession* p_Session)
        {
            UNUSED(p_Packet);
            UNUSED(p_Session);
        }
...
class SceneTriggerScript : public ScriptObjectImpl<true>
{
    protected:
        SceneTriggerScript(const char* p_Name);
    ...
    public:
        ...
        virtual bool OnTrigger(Player* p_Player, SpellScene const* p_Trigger, const std::string& p_Triggername)
        {
            UNUSED(p_Player);
            UNUSED(p_Trigger);
            UNUSED(p_Triggername);
...
{
    protected:
        EventObjectScript(const char* p_Name);

    public:

        bool IsDatabaseBound() const { return true; }

        virtual bool OnTrigger(Player* p_Player, EventObject* p_Trigger)
        {
            UNUSED(p_Player);
            UNUSED(p_Trigger);
            return false;
...
class AuctionHouseScript : public ScriptObjectImpl<false>
{
    ...
    public:
        ...
        virtual void OnAuctionAdd(AuctionHouseObject * p_AuctionHouseObject, AuctionEntryPtr p_Entry)
        {
        ...
        virtual void OnAuctionRemove(AuctionHouseObject * p_AuctionHouseObject, AuctionEntryPtr p_Entry)
        {
            UNUSED(p_AuctionHouseObject);
            UNUSED(p_Entry);
        }
        ...
        virtual void OnAuctionSuccessful(AuctionHouseObject * p_AuctionHouseObject, AuctionEntryPtr p_Entry)
        {
            UNUSED(p_AuctionHouseObject);
            UNUSED(p_Entry);
        }
        ...
        virtual void OnAuctionExpire(AuctionHouseObject * p_AuctionHouseObject, AuctionEntryPtr p_Entry)
        {
            UNUSED(p_AuctionHouseObject);
            UNUSED(p_Entry);
        }
