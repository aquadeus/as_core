...
/// Instance map script interface
class OutdoorPvEMapScript : public ScriptObjectImpl<true>, public MapScript<Map>
{
    protected:
        /// Constructor
        /// @p_Name  : Script name
        OutdoorPvEMapScript(const char* p_Name, uint32 p_MapID);

    public:
        /// Gets an OutdoorPvEScript object for this map.
        /// @p_Map : Context map
        virtual OutdoorPvEScript* GetOutdoorPvEScript(Map* p_Map) const
        {
            UNUSED(p_Map);
