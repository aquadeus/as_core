...
class GroupScript : public ScriptObjectImpl<false>
{
    ...
    public:
        ...
        virtual void OnAddMember(GroupPtr p_Group, uint64 p_Guid)
        {
            UNUSED(p_Group);
            UNUSED(p_Guid);
        }
        ...
        virtual void OnInviteMember(GroupPtr p_Group, uint64 p_GUID)
        {
            UNUSED(p_Group);
            UNUSED(p_GUID);
        }
        ...
        virtual void OnRemoveMember(GroupPtr p_Group, uint64 p_GUID, RemoveMethod p_Method, uint64 p_KickerGUID, const char * p_Reason)
        {
            UNUSED(p_Group);
            UNUSED(p_GUID);
            UNUSED(p_Method);
        ...
        virtual void OnChangeLeader(GroupPtr p_Group, uint64 p_NewLeaderGUID, uint64 p_OldLeaderGUID)
        {
            UNUSED(p_Group);
        ...
        /// @p_Group : Group Instance
        virtual void OnDisband(GroupPtr p_Group)
        {
            UNUSED(p_Group);
        }
