...
class AreaTriggerEntityScript : public ScriptObjectImpl<true>
{
    ...
    public:
        ...
        virtual void OnSetCreatePosition(AreaTrigger* p_AreaTrigger, Unit* p_Caster, Position& p_SourcePosition, Position& p_DestinationPosition, std::vector<G3D::Vector3>& p_PathToLinearDestination)
        {
            UNUSED(p_AreaTrigger);
            UNUSED(p_Caster);
        ...
        /// Procs before AreaTrigger is created
        virtual void BeforeCreate(AreaTrigger* p_AreaTrigger)
        {
            UNUSED(p_AreaTrigger);
        }
        ...
        /// Called when AreaTrigger can bounce
        virtual bool OnAreaTriggerBounce(AreaTrigger* p_AreaTrigger)
        {
            UNUSED(p_AreaTrigger);
            return true;
        }

        virtual bool OnAddTarget(AreaTrigger* p_Areatrigger, Unit* p_Target)
        {
            UNUSED(p_Areatrigger);
            UNUSED(p_Target);
        ...
        virtual bool OnRemoveTarget(AreaTrigger* p_Areatrigger, Unit* p_Target)
        {
            UNUSED(p_Areatrigger);
            UNUSED(p_Target);
        ...
        virtual void OnMoveAreaTrigger(AreaTrigger* p_AreaTrigger, uint32 p_ArrivalTime)
        {
            UNUSED(p_AreaTrigger);
            UNUSED(p_ArrivalTime);
        }
