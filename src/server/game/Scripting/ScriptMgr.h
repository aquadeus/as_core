...
class ScriptMgr
{
    ...
    public:
        ...
        /// Proc before AreaTrigger is created
        /// /!\ Map is not initialized yet, be careful!
        void BeforeCreateAreaTriggerEntity(AreaTrigger* p_AreaTrigger);
        ...
        void OnSetCreatePositionEntity(AreaTrigger* p_AreaTrigger, Unit* p_Caster, Position& p_SourcePosition, Position& p_DestinationPosition, std::vector<G3D::Vector3>& p_PathToLinearDestination);
        ...
        /// Called when AreaTrigger is ready to bounce
        bool OnAreaTriggerBounce(AreaTrigger* p_AreaTrigger);

        /// Called when a target enters the areatrigger
        bool OnSpellAreaTriggerAddTarget(AreaTrigger* p_AreaTrigger, Unit* p_Target);

        /// Called when a target exits the areatrigger
        bool OnSpellAreaTriggerRemoveTarget(AreaTrigger* p_AreaTrigger, Unit* p_Target);

        /// Called when the AreaTrigger is moved
        void OnMoveAreaTrigger(AreaTrigger* p_AreaTrigger, uint32 p_ArrivalTime);
    ...
    public:
        ...
        bool OnSceneTrigger(Player* p_Player, SpellScene const* p_Trigger, const std::string& p_Triggername);
    ...
    public:
        ...
        /// Called when a player closes a gossip window
        /// @p_Player   : Source player instance
        /// @p_Creature : Target creature instance
        void OnCloseGossip(Player* p_Player, Creature* p_Creature);
    ...
    public:
        ...
        void OnGroupAddMember(GroupPtr p_Group, uint64 p_Guid);
        /// Called when a member is invited to join a group.
        /// @p_Group : Group Instance
        /// @p_GUID  : Invited member GUID
        void OnGroupInviteMember(GroupPtr p_Group, uint64 p_Guid);
        ...
        void OnGroupRemoveMember(GroupPtr p_Group, uint64 p_GUID, RemoveMethod p_Method, uint64 p_KickerGUID, char const* p_Reason);

        /// Called when the leader of a group is changed.
        /// @p_Group         : Group Instance
        /// @p_NewLeaderGUID : New group leader GUID
        /// @p_OldLeaderGUID : Old group leader GUID
        void OnGroupChangeLeader(GroupPtr p_Group, uint64 p_NewLeaderGUID, uint64 p_OldLeaderGUID);

        /// Called when a group is disbanded.
        /// @p_Group : Group Instance
        void OnGroupDisband(GroupPtr p_Group);
    ...
    public:
        ...
        /// @p_Sender     : Sender menu
        /// @p_Action     : Action
        bool OnGossipSelect(Player* p_Player, Item* p_Item, uint32 p_Sender, uint32 p_Action);

        bool OnItemCreate(Player* p_Player, const ItemTemplate* p_ItemTemplate, Item* p_Item);
    ...
    public:
        ...
        void OnPacketReceive( WorldPacket p_Packet, WorldSession* p_Session = nullptr);
    ...
    public:
        ...
        void OnAuctionAdd(AuctionHouseObject* p_AuctionHouseObject, AuctionEntryPtr p_Entry);

        /// Called when an auction is removed from an auction house.
        /// @p_AuctionHouseObject : Auction House Object Instance
        /// @p_Entry              : Auction to remove
        void OnAuctionRemove(AuctionHouseObject* p_AuctionHouseObject, AuctionEntryPtr p_Entry);
        /// Called when an auction was successfully completed.
        /// @p_AuctionHouseObject : Auction House Object Instance
        /// @p_Entry              : Auction instance
        void OnAuctionSuccessful(AuctionHouseObject* p_AuctionHouseObject, AuctionEntryPtr p_Entry);
        /// Called when an auction expires.
        /// @p_AuctionHouseObject : Auction House Object Instance
        /// @p_Entry              : Auction who expired
        void OnAuctionExpire(AuctionHouseObject* p_AuctionHouseObject, AuctionEntryPtr p_Entry);
    ...
    public:
        ...
        void OnBaseGainCalculation(uint32& p_Gain, uint8 p_PlayerLevel, uint8 p_MobLevel);
    ...
    public:
        ...
        /// @p_Killer : Killer instance
        /// @p_Killed : Killed instance
        void OnKill(Player* p_Killer, Unit* p_Killed, bool p_BeforeAurasRemoved = false);
        ...
        void OnModifyCharges(Player* p_Player, uint32 p_CategoryChargeEntryID);
        ...
        /// @p_Player : Player instance
        /// @p_Value  : New value
        void OnModifyHealth(Player* p_Player, int64 p_Value, int64 p_oldValue);
        ...
        /// @p_Player : Player
        /// @p_SpellID : SpellID
        void OnTeleport(Player* p_Player, SpellInfo const* p_SpellInfo, bool p_WorldPort);
        ...
        void OnPlayerChat(Player* p_Player, uint32 p_Type, uint32 p_Lang, std::string& p_Message, GroupPtr p_Group);
        ...
        void OnPlayerChoiceResponse(Player* p_Player, uint32 p_ChoiceID, uint32 p_ResponseID);
        ...
        /// @p_Player               : Player instance
        /// @p_Spell                : Casted spell
        /// @p_InterruptingSpell    : Interupting Spell
        /// @p_InterruptingSpellId  : In Case Interrupting spell is nullptr
        ...
        /// @p_Spell     : Casted spell
        /// @p_SkipCheck : Skipped checks
        void AfterPlayerSpellCast(Player* p_Player, Spell* p_Spell, bool p_SkipCheck);
        ...
        void OnPlayerBindToInstance(Player* p_Player, Difficulty p_Difficulty, uint32 p_MapID, bool p_Permanent, uint8 p_ExtendState);
        ...
        /// @p_Player : Player instance
        void OnPlayerUpdateMovement(Player* p_Player, uint16 p_OpcodeID);
        ...
        /// @p_Player : Player instance
        void OnPlayerDismount(Player* p_Player);
        ...
        /// @p_Player          : Player instance
        /// @p_SceneInstanceID : Standalone scene instance ID
        void OnSceneComplete(Player* p_Player, uint32 p_SceneInstanceIDd);

        /// Called when a player completes a movie
        /// @p_Player          : Player instance
        /// @p_MovieId         : Movie ID
        void OnMovieComplete(Player* p_Player, uint32 p_MovieId);
        ...
        void OnPlayerTakeDamage(Player* p_Player, Unit* p_Origin, DamageEffectType p_DamageEffectType, uint32 p_Damage, SpellSchoolMask p_SchoolMask, CleanDamage const* p_CleanDamage);
        ...
        /// @p_DamageEffectTyp : Damage type
        /// @p_Damage          : Amount of damage taken
        void OnPlayerDealDamage(Player* p_Player, Unit* p_Target, DamageEffectType p_DamageEffectType, uint32 p_Damage, SpellSchoolMask p_SchoolMask, CleanDamage const* p_CleanDamage);
        ...
        void OnPlayerBracketWin(Player* p_Player, BattlegroundBracketType p_Bracket);

        void OnPlayerModifyCurrency(Player* p_Player, uint32 p_CurrencyID, int32& p_Count, bool p_IgnoreMultipliers);

        void OnPlayerAfterUnequipItem(Player* p_Player, Item const* p_Item);

        void OnAddRelicTalent(Player* p_Player);

        void OnActivateArgusTaxi(Player* p_Player, uint32 p_TaxiNodeId);

        void OnGarrisonMissionComplete(Player* p_Player, uint32 p_MissionId, bool p_Succeeded);

        void OnAchievementComplete(Player* p_Player, AchievementEntry const* p_Achievement);

        /// Called in Player::AddQuest and Player::RewardQuest
        void OnPhaseUpdate(Player* p_Player, uint32 p_Quest, bool p_Accept);
    ...
    public:
        ...
        /// @p_Data : Outdoor PvE Data
        OutdoorPvEScript* CreateOutdoorPvE(Map* p_Map);
    ...
    public:
        ...
        void OnCreateBaseMap(Map* p_Map, uint32 p_ZoneID);

        /// Called just after any worldobject is created
        /// @p_WorldObject  : WorldObject that have just been created
        void OnWorldObjectCreate(WorldObject const* p_WorldObject);
        ...
        void OnUpdateWorldQuests(Player* p_Player, uint32 p_OldAreaID, uint32 p_NewAreaID);

        /// Called when a POI appears for everyone
        /// @p_AreaPOI      : POI that just appeared
        void OnPOIAppears(AreaPOI const& p_AreaPOI);

        /// Called when a POI disappears for everyone
        /// @p_AreaPOI      : POI that just appeared
        void OnPOIDisappears(AreaPOI const& p_AreaPOI);

        void OnNextPOISelect(uint32 p_GroupId, std::set<uint32>& p_AvailableNextPOIs);

    /// ContributionScript
    public:
        /// Called when a Contribution change of state
        /// @p_Contribution : Contribution that has changed of state
        void OnContributionChangeState(Contribution const* p_Contribution);

        /// Called when ContriutionMgr Updates
        void UpdateContributions(uint32 const p_GameTime);

        /// Called when command .reload quest_template is used
        void OnReloadQuestTemplates();

        /// Called when a player contributes
        /// @p_Player           : Contributing Player
        /// @p_p_Contribution   : Concerned contribution
        void OnPlayerContribute(Player* p_Player, Contribution const* p_Contribution);
    ...
    public:
        ...
        /// @p_Player      : Player instance
        bool EvalPlayerConditionScript(uint32 p_ConditionID, PlayerConditionEntry const* p_Condition, Unit const* p_Unit);
    ...
    /// EventObject scripts
    public:
        bool OnEventObject(Player* p_Player, EventObject* p_Event);
