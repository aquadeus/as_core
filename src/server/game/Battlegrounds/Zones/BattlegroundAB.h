...
class BattlegroundAB : public Battleground
{
    public:
        ...
        /* Scorekeeping */
        virtual void UpdatePlayerScore(Player* p_Source, Player* p_Victim, uint32 p_Type, uint32 p_Value, bool p_DoAddHonor = true, MS::Battlegrounds::RewardCurrencyType::Type p_RewardType = MS::Battlegrounds::RewardCurrencyType::Type::None) override;
        ...
        uint32 GetZoneId() override { return BATTLEGROUND_AB_ZONEID; }

    private:
        virtual void PostUpdateImpl(uint32 diff) override;
