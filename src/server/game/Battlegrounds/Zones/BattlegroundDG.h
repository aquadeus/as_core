...
class BattlegroundDG : public Battleground
{
    public:
        ...
        void HandleAreaTrigger(Player* player, uint32 trigger, bool p_Enter) override;
        ...
        uint32 GetMaxScore() const override { return BG_DG_MAX_VICTORY_POINTS; }
        bool IsScoreIncremental() const override { return true; }

        uint32 GetZoneId() override { return BATTLEGROUND_DG_ZONEID; }
