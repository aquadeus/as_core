    ...
    namespace Battlegrounds
    {
        namespace BattlegroundMasks
        {
            ...
            enum
            {
                ...
                DeepwindGorge = 0x400,
                SeethingShore = 0x800,
                AllBattlegrounds = 0xFFF,
                /// Arenas.
                Arena1v1 = 0x1000,
                Arena2v2 = 0x2000,
                Arena3v3 = 0x4000,
                Arena5v5 = 0x8000,
                AllArenas = Arena1v1 | Arena2v2 | Arena3v3 | Arena5v5,
                /// Skirmish Arenas.
                ArenaSkirmish1v1 = 0x10000,
                ArenaSkirmish2v2 = 0x20000,
                ArenaSkirmish3v3 = 0x40000,
                AllSkirmishArenas = ArenaSkirmish1v1 | ArenaSkirmish2v2 | ArenaSkirmish3v3,
                All = 0xFFFFF
            };
        }
