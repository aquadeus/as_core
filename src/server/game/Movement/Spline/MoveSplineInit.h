...
namespace Movement
{
    enum AnimType
    {
        ToGround    = 0, // 460 = ToGround, index of AnimationData.db2
    ...
    public:
        ...
        /// Starts rotation move
        void LaunchRotate(float p_Orientation);
        ...
        /* Enables SmoothGroundPath spline interpolation mode(makes path smooth on ground)
         * Also enables Steering flag
         */
        void SetGroundSmooth();
        ...
        void SetSpellEffectExtraData(SplineSpellEffectExtraData const& spellEffectExtraData);
        void SetMonsterSplineFilters(MonsterSplineFilter const& p_SplineFilter);
    ...
    inline void MoveSplineInit::SetGroundSmooth() { args.flags.EnableGroundSmooth(); }
    ...
    inline void MoveSplineInit::SetCustomFlags(uint32 p_Flags) { args.flags |= p_Flags; }
    ...
    inline void MoveSplineInit::SetSpellEffectExtraData(SplineSpellEffectExtraData const& p_SpellEffectExtraData)
    {
        args.m_SpellEffectExtraData.emplace();
        args.m_SpellEffectExtraData = p_SpellEffectExtraData;
    }

    inline void MoveSplineInit::SetMonsterSplineFilters(MonsterSplineFilter const& p_SplineFilter)
    {
        args.m_MonsterSplineFilter.emplace();
        args.m_MonsterSplineFilter = p_SplineFilter;
    }
}
