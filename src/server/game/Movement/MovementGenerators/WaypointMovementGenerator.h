...
{
    public:
        WaypointMovementGenerator(uint32 _path_id = 0, bool _repeating = true, int32 p_RandomX = 0, int32 p_RandomY = 0)
            : i_nextMoveTime(0), m_isArrivalDone(false), path_id(_path_id), repeating(_repeating), m_RandomX(p_RandomX), m_RandomY(p_RandomY), i_recalculateSpeed(false) { }
    ...
    public PathMovementBase<Player, TaxiPathNodeList>
{
    ...
    private:
        ...
        float _endGrixZ;                            //! Z coord of last node location
