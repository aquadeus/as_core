...
enum WorldBoolConfigs
{
    ...
    CONFIG_DISABLE_RARE_MOUNTS_ACCOUNT_WIDE,
    ...
    CONFIG_CREATURE_RESPAWN_DYNAMIC,
    CONFIG_ENABLE_ASHRAN_PVP_ZONE,
    CONFIG_ENABLE_MAX_XP_BEFORE_WOD,
    CONFIG_SAVE_DEV_REALM_LOGIN_DATA,
    CONFIG_ENABLE_LEGION_LEGENDARIES,
    CONFIG_ENABLE_LEGION_LEGENDARY_TOKENS,
    CONFIG_ENABLE_ASHRAN_LOG,
    CONFIG_ENABLE_CREATURE_UPDATE_MOVEMENT_FLAGS,
    CONFIG_ENABLE_UNSAFE_SPELL_AURA_HOOK_STACK_TRACE,
    CONFIG_CHALLENGE_ENABLED,
    CONFIG_ENABLE_SLACK_MESSAGE_LATENCY,
    CONFIG_WORD_FILTER_ENABLE,
    CONFIG_IGNORE_MAP_LOG,
    CONFIG_USE_VMAP_LOAD_LOCK,
    CONFIG_INSTANCE_FORCE_UNLOADING_ENABLE,
    CONFIG_SILENTLY_JOIN_LEAVE_TO_CHANNEL,
    CONFIG_PROCESS_SESSIONS_CALLBACK_MT,
    CONFIG_TOURNAMENT_ENABLE,
    CONFIG_ENABLE_MULTIPLE_PACKETS,
    CONFIG_USE_OTHER_ITEM_LEVEL_FOR_CLASSHALL_CHEST,
    CONFIG_ENABLE_MT_UPDATE_OBJECT_SENDING,
    CONFIG_ENABLE_MT_VISIBILITY_UPDATE,
    CONFIG_ENABLE_RAF,
    CONFIG_ENABLE_MIGRATIONS,
    CONFIG_ENABLE_INTERREALM,
    CONFIG_ENABLE_PTR_CONTENT,
    CONFIG_ENABLE_FILE_GMLOG,
    CONFIG_ENABLE_BROADCAST_MESSAGE_BATCH,
    CONFIG_IS_TEST_SERVER,
    CONFIG_FAST_LOADING_FOR_TEST,
    CONFIG_MOVE_WORLD_PORT_ACK_TEST,
...
enum WorldFloatConfigs
{
    ...
    CONFIG_CREATURE_RESPAWN_DYNAMIC_COEF,
    CONFIG_CREATURE_RESPAWN_MAX_PCT_DOWN,
    CONFIG_LOOT_WARFORGE_BASE_CHANCE,
    CONFIG_LOOT_WARFORGE_NEXT_TRY_CHANCE,
...
enum WorldIntConfigs
{
    ...
    CONFIG_CHARACTER_CREATING_MIN_LEVEL_FOR_HEROIC_CHARACTER_DK,
    CONFIG_CHARACTER_CREATING_MIN_LEVEL_FOR_HEROIC_CHARACTER_DH,
    ...
    CONFIG_DK_LEVEL_REQ_DIFF,
    CONFIG_DH_LEVEL_REQ_DIFF,
    CONFIG_ALLIED_RACE_LEVEL_REQ_DIFF,
    ...
    CONFIG_INTERVAL_REAL_UPDATE_TIME,
    ...
    CONFIG_ANTICHEAT_REPORTS_INGAME_NOTIFICATION_TELEPORTHACKDETECTION,
    ...
    CONFIG_ONLY_MAP,
    CONFIG_CREATURE_RESPAWN_SEARCHER_RANGE,
    CONFIG_CREATURE_RESPAWN_DYNAMIC_MINIUM,
    CONFIG_SLACK_LOCAL,
    CONFIG_MAP_PLAYERS_PER_ZONE_INSTANCE,
    CONFIG_MAX_ARTIFACT_KNOWLEDGE,
    CONFIG_MAX_ARTIFACT_LEVEL,
    CONFIG_CLASSHALL_CHEST_MAX_ITEM_LEVEL,
    CONFIG_UPDATE_SESSIONS_MAX_TIME_ALLOWED,
    CONFIG_UPDATE_MAX_MAP_TASK_PER_TICK,
    CONFIG_AUCTION_HOUSE_BOT_ACCOUNT,
    CONFIG_CHALLENGE_KEY_RESET,
    CONFIG_WORD_FILTER_MUTE_DURATION,
    CONFIG_INSTANCE_FORCE_UNLOADING_PERIOD_RECORDING,
    CONFIG_INSTANCE_FORCE_UNLOADING_REQ_DELAYS,
    CONFIG_INSTANCE_FORCE_UNLOADING_REQ_DELAY_DIFF,
    CONFIG_INSTANCE_FORCE_UNLOADING_REQ_AVG_DELAY_THRESHOLD,
    CONFIG_CREATURE_SKIP_UPDATE_MAX,
    CONFIG_PLAYER_SKIP_UPDATE_MAX,
    CONFIG_PLAYER_GLOBAL_UPDATE_TIMEOUT,
    CONFIG_SESSION_GLOBAL_UPDATE_TIMEOUT,
    CONFIG_SESSION_UPDATE_TIMEOUT,
    CONFIG_ARTIFACT_KNOWLEDGE_WEEKLY_PROGRESS_START_TIME,
    CONFIG_PORT_INSTANCE,
    CONFIG_PORT_PROXY_INSTANCE,
    CONFIG_MAP_THREAD_POOL_COUNT,
    CONFIG_PACKET_BROADCAST_MT_MAP_DELAY_THRESHOLD,
    CONFIG_ON_LOGIN_LFG_CHANNEL_LOCALE,
    CONFIG_GC_TIMER,
    CONFIG_ASYNC_WORLD_FEATURES_MASK,
    CONFIG_COLOR_FAKE_PROTECTION_ENABLED,
    CONFIG_PLAYER_COMMAND_COOLDOWN,
...
enum Rates
{
    ...
    RATE_HONOR_PREMIUM,
    RATE_MAX_XP_BEFORE_WOD,
    RATE_MAX_XP_GLOBAL,
    RATE_GAIN_ARTIFACT_KNOWLEDGE,
    MAX_RATES
};
...
/// Type of server, this is values from second column of Cfg_Configs.db2
enum RealmType
{
    REALM_TYPE_NORMAL = 0,
    REALM_TYPE_PVP = 1,
...
enum WorldStates
{
    ...
    WS_DAILY_WORLD_QUEST_RESET              = 20009,    ///< World quest reset

    WS_CHALLENGE_KEY_RESET_TIME             = 20015,    ///< Reset time for Challenge key
    WS_CHALLENGE_WEEKLY_AFFIXE_INDEX        = 20016,    ///< Challenge Weekly Affixe index

    WS_VIOLET_HOLD_WEEKLY_ROTATION          = 50000,    ///< Violet Hold bosses rotation is weekly
    WS_NEXT_AUCTION_HOUSE_BOT_UPDATE        = 50001,
    WS_DRAGONS_OF_NIGHTMARE_WEEKLY_ROTATION = 50002,
    WS_RETURN_TO_KARAZHAN                   = 50003
};
...
enum ScriptCommands
{
    ...
    // Firestorm only
    SCRIPT_COMMAND_SET_ANIMKIT           = 100               // source = Creature, datalong = AnimKitID
};

enum AsyncWorldFeature
{
    ASYNC_AUCTION_ENABLE       = 0x00000001,
    ASYNC_TRANSFER_ENABLE      = 0x00000002,
    ASYNC_SESSION_ENABLE       = 0x00000004,
    ASYNC_WEATHER_ENABLE       = 0x00000008,
    ASYNC_AUTOBROADCAST_ENABLE = 0x00000010,
    ASYNC_BATTLEGROUND_ENABLE  = 0x00000020,
    ASYNC_PET_BATTLE_ENABLE    = 0x00000040,
    ASYNC_LFG_ENABLE           = 0x00000080,
    ASYNC_CALLBACKS_ENABLE     = 0x00000100,
    ASYNC_LFGLIST_ENABLE       = 0x00000200,
    ASYNC_WORLD_QUEST_ENABLE   = 0x00000400,
    ASYNC_GAME_EVENT_ENABLE    = 0x00000800,
    ASYNC_GUILD_ENABLE         = 0x00001000,
    ASYNC_BLACKMARKET_ENABLE   = 0x00002000,
    ASYNC_MIGRATION_ENABLE     = 0x00004000,
    ASYNC_POI_ENABLE           = 0x00008000,
    ASYNC_CONTRIBUTION_ENABLE  = 0x00010000,
    ASYNC_INSTANCE_SAVE_ENABLE = 0x00020000,
    ASYNC_RAF_ENABLE           = 0x00040000,
};
...
class World
{
    public:
...
#ifdef  CROSS
        WorldSession* FindCrossSession(uint32 p_Id) const;
#endif //  CROSS
        void AddSession(WorldSession* s);
        bool RemoveSession(uint32 id);
        void AddInstanceSocket(WorldSocket* sock, uint64 connectToKey);
        ...
        ACE_RW_Thread_Mutex& GetSessionsLock() { return m_SessionsLock; }
        uint32 GetActiveAndQueuedSessionCount() const
        {
            ACE_Read_Guard<ACE_RW_Thread_Mutex> l_Guard(m_SessionsLock);
            return uint32(m_sessions.size() * getRate(RATE_ONLINE));
        }
        uint32 GetActiveSessionCount() const
        {
            ACE_Read_Guard<ACE_RW_Thread_Mutex> l_Guard(m_SessionsLock);
            return uint32((m_sessions.size() - m_QueuedPlayer.size()) * getRate(RATE_ONLINE));
        }
        ...
        void AddCharacterInfo(uint32 guid, std::string const& name, uint32 accountId, uint8 gender, uint8 race, uint8 playerClass, uint8 level, uint32 p_LoginFlags);
        ...
        void UpdateCharacterInfoGuild(uint32 guid, uint32 guildId);
        void SetCharacterInfoLoginFlag(uint32 p_Guid, uint32 p_LoginFlag);
        void RemoveCharacterInfoLoginFlag(uint32 p_Guid, uint32 p_LoginFlag);
        ...
        void HandleOnlineArenaDecay();
        void HandleOfflineArenaDecay(PreparedQueryResult&& p_Result2s, PreparedQueryResult&& p_Result3s);
        ...
        LocaleConstant GetDefaultDb2Locale() const { return m_defaultDbcLocale; }

        /// Get the path where data (db2, maps) are stored on disk
        ...
        void SendGlobalGMMessage(WorldPacket* packet, WorldSession* self = nullptr, uint32 team = 0, AccountTypes p_Rank = AccountTypes::SEC_GAMEMASTER);
        ...
        bool IsAsyncFeatureEnable(AsyncWorldFeature p_Feature)
        {
            return (m_int_configs[CONFIG_ASYNC_WORLD_FEATURES_MASK] & (uint32)p_Feature) != 0;
        }
        ...
        std::string const& GetRAFSalt() { return m_RAFSalt; }
        ...
        time_t GetNextBossLootResetTime() const { return m_NextBossLootedReset; }

        uint32 GetAccountSecurity(uint32 p_AccountID) const
        {
            auto l_Itr = m_AccountSecurity.find(p_AccountID);
            if (l_Itr == m_AccountSecurity.end())
                return 0;

            return l_Itr->second;
        }

        void RegisterAccountSecurity(uint32 p_Account, uint32 p_GmLevel) { m_AccountSecurity[p_Account] = p_GmLevel; }
        void ClearAccountSecurity() { m_AccountSecurity.clear(); }

        void SetAccountLocale(uint32 p_AccountId, LocaleConstant p_Locale);
        LocaleConstant GetAccountLocale(uint32 p_AccountId) const;

        uint32 GetCurrentArtifactKnowledge();

        ACE_INET_Addr const& GetInstanceAddress() const { return m_InstanceAddress; };
        ACE_INET_Addr const& GetInstanceProxyAddress() const { return m_InstanceProxyAddress; };
    ...
    private:
        ...
        mutable ACE_RW_Thread_Mutex m_SessionsLock;
        ...
        bool AddSession_(WorldSession* s);
        ...
        ACE_INET_Addr m_InstanceAddress;
        ACE_INET_Addr m_InstanceProxyAddress;
        ...
        LocaleConstant m_defaultDbcLocale;                     // from config for one from loaded DB2 locales
        uint32 m_availableDbcLocaleMask;                       // by loaded DB2
        void DetectDB2Lang();
        ...
        uint32 m_AccountSecurityScanTimer;
        ACE_Based::LockedMap<uint32, uint32> m_AccountSecurity;

        std::unordered_map<uint32, LocaleConstant> m_AccountLocales;

        void ProcessLinkInstanceSocket(std::pair<WorldSocket*, uint64> linkInfo);
        ACE_Based::LockedQueue<std::pair<WorldSocket*, uint64>, ACE_Thread_Mutex> _linkSocketQueue;

        PreparedQueryResultFuture m_ArenaDecay2sCallback;
        PreparedQueryResultFuture m_ArenaDecay3sCallback;
