...
class GameEventMgr
{
    ...
    private:
        ...
        typedef std::vector<ACE_Based::LockedMap<uint32, std::set<uint64>>> GameEventSpawnedGobs;
        typedef std::vector<ACE_Based::LockedMap<uint32, std::set<uint64>>> GameEventSpawnedCreatures;
    ...
    public:
        ...
        GameEventSpawnedGobs m_GameEventSpawnedGobGuids;
        std::recursive_mutex m_SpawnedGobGuidsLock;

        GameEventSpawnedCreatures m_GameEventSpawnedCreatureGuids;
        std::recursive_mutex m_SpawnedCreatureGuidsLock;
};
