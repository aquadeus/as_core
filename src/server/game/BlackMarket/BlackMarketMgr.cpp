...
void BlackMarketMgr::LoadAuctions()
{
    ...
    do
    {
        ...
        BMAuctionEntryPtr auction = std::make_shared<BMAuctionEntry>(BMAuctionEntry());
...
void BlackMarketMgr::Update()
{
    ...
    {
        BMAuctionEntryPtr auction = itr->second;
...
void BlackMarketMgr::BuildBlackMarketAuctionsPacket(WorldPacket& p_Data, uint32 p_GuidLow)
{
    ...
    {
        BMAuctionEntryPtr l_Auction = l_Iter->second;
...
void BlackMarketMgr::UpdateAuction(BMAuctionEntryPtr auction, uint64 newPrice, Player* newBidder)
{
    SQLTransaction trans = CharacterDatabase.BeginTransaction();
...
void BlackMarketMgr::SendAuctionOutbidded(BMAuctionEntryPtr p_Auction, uint64 /*p_NewPrice*/, Player* /*p_NewBidder*/, SQLTransaction& p_Transaction)
{
...
void BlackMarketMgr::SendAuctionWon(BMAuctionEntryPtr p_Auction, SQLTransaction& p_Transaction)
{
