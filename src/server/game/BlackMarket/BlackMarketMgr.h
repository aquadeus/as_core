...
using BMAuctionEntryPtr = std::shared_ptr<BMAuctionEntry>;
...
class BlackMarketMgr
{
    ...
    private:
        ...
        typedef ACE_Based::LockedMap<uint32, BMAuctionEntryPtr> BMAuctionEntryMap;
    ...
    public:
        ...
        BMAuctionEntryPtr GetAuction(uint32 id) const
        {
        ...
        // Auction messages
        void SendAuctionWon(BMAuctionEntryPtr auction, SQLTransaction& trans);
        void SendAuctionOutbidded(BMAuctionEntryPtr auction, uint64 newPrice, Player* newBidder, SQLTransaction& trans);
        ...
        void UpdateAuction(BMAuctionEntryPtr auction, uint64 newPrice, Player* newBidder);
