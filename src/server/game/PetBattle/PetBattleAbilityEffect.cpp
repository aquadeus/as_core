...
int32 PetBattleAbilityEffect::CalculateDamage(int32 p_Damage)
{
    ...
    if (BattlePetTypeDamageModEntry const* l_DamageModInfo = g_BattlePetTypeDamageModEntry.LookupEntry(l_AbilityPetType))
        l_ModPetTypeDamagePercent += l_DamageModInfo->m_RawValues[l_TargetPetType] * 100;
