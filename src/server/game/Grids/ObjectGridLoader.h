...
class ObjectGridLoader
{
    ...
    public:
        ObjectGridLoader(NGridType &grid, Map* map, const Cell &cell)
            : i_cell(cell), i_grid(grid), i_map(map), i_gameObjects(0), i_creatures(0), i_corpses(0), i_eventobject(0), i_areatrigger(0)
            {}
        ...
        void Visit(EventObjectMapType &) const {}
    ...
    private:
        ...
        uint32 i_eventobject;
        uint32 i_corpses;
        uint32 i_areatrigger;
};
