...
typedef TYPELIST_7(Player, Creature/*pets*/, Corpse/*resurrectable*/, DynamicObject/*farsight target*/, AreaTrigger, Conversation, EventObject) AllWorldObjectTypes;
typedef TYPELIST_7(GameObject, Creature/*except pets*/, DynamicObject, Corpse/*Bones*/, AreaTrigger, Conversation, EventObject) AllGridObjectTypes;
...
typedef GridRefManager<EventObject>     EventObjectMapType;
