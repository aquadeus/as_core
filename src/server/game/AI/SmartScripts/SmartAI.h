...
class SmartAI : public CreatureAI
{
    public:
        ...
        void DamageDealt(Unit* doneTo, uint32& damage, DamageEffectType /*damagetype*/, SpellInfo const* /*p_SpellInfo*/);
        ...
        void SetInvincibilityHpLevel(uint64 level) { mInvincibilityHpLevel = level; }
        ...
        void sOnAuraAddedToTarget(Unit* p_Unit, uint32 p_SpellId);
        void sOnAuraRemovedFromTarget(Unit* p_Unit, uint32 p_SpellId);
