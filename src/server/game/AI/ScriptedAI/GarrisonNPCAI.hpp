...
class GarrisonNPCAI : public MS::AI::CosmeticAI
{
    public:
        ...
        void SetupActionSequence(MS::Garrison::GDraenor::SequencePosition* p_CoordTable, uint8* p_SequenceTable, uint32 p_SequenceSize, uint32 p_FirstMovePointID);
        ...
        /// @p_SummonType : Summon type
        Creature* SummonRelativeCreature(uint32 p_Entry, MS::Garrison::GDraenor::SequencePosition p_Position, TempSummonType p_SummonType);
    ...
    private:
        Player* m_Owner;
        MS::Garrison::GDraenor::SequencePosition* m_CoordTable;
