...
class CasterAI : public CombatAI
{
    public:
        ...
        void InitializeAI();
        void AttackStart(Unit* victim, bool p_Melee = true) { AttackStartCaster(victim, m_attackDist); }
        void UpdateAI(const uint32 diff);
        void EnterCombat(Unit* /*who*/);
...
struct TurretAI : public CreatureAI
{
    public:
        ...
        void AttackStart(Unit* who, bool p_Melee);
        void UpdateAI(const uint32 diff);
...
struct BodyGuardAI : public CreatureAI
{
    public:
        explicit BodyGuardAI(Creature* c);
        void InitializeAI();
        void Reset();
        ...
        void AttackStart(Unit* who, bool p_Melee);
        void UpdateAI(const uint32 diff);
        void OwnerDamagedBy(Unit* p_Attacker);

        static int Permissible(const Creature*);
    protected:
        EventMap    m_Events;
        SpellVct    spells;
        SpellVct    m_HealSpells;
        uint32      m_MountId;
};
