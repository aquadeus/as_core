...
class GameObjectAI
{
    ...
    public:
        ...
        virtual bool OnCheckOpening(Unit* p_Who, SpellInfo const* p_SpellInfo)
        {
            UNUSED(p_Who);
            UNUSED(p_SpellInfo);
        ...
        virtual void OnLockOpened(Player* p_Player)
        {
            UNUSED(p_Player);
        }

        virtual void OnLootReleased(Player* p_Player)
        {
            UNUSED(p_Player);
        }

        virtual void OnBuildDynFlags(uint16& p_DynFlags, Player* p_Player)
        {
            UNUSED(p_DynFlags);
            UNUSED(p_Player);
        }

        virtual void OnBuildDisplayId(uint32& p_DisplayId, Player* p_Player)
        {
            UNUSED(p_DisplayId);
            UNUSED(p_Player);
        }

        virtual void HandleCustomLoot(Player* p_Player)
        {
            UNUSED(p_Player);
        }
