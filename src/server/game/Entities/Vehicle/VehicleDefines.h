...
enum VehicleFlags
{
    ...
    VEHICLE_FLAG_CUSTOM_PITCH                   = 0x00000040,           // If set use pitchMin and pitchMax from DB2, otherwise pitchMin = -pi/2, pitchMax = pi/2
    ...
    VEHICLE_FLAG_HAS_HIGH_PORIORITY_ANIM        = 0x00010000,
    ...
    VEHICLE_FLAG_NO_TRAJECTORY_LINGERING        = 0x00800000,
    VEHICLE_FLAG_TRAJECTORY_TURN_LINGERING      = 0x01000000,
    VEHICLE_FLAG_TRAJECTORY_PITCH_LINGERING     = 0x02000000,
    VEHICLE_FLAG_TRAJECTORY_MOUSE_LINGERING     = 0x04000000,
