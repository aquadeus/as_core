...
enum OBJECT_UPDATE_FLAGS
{
    ...
    UPDATEFLAG_HAS_MOVEMENT_UPDATE      = 0x00000008,
    UPDATEFLAG_HAS_TRANSPORT_POSITION   = 0x00000010,
    UPDATEFLAG_HAS_POSITION             = 0x00000020,
    UPDATEFLAG_HAS_COMBAT_VICTIM        = 0x00000040,
    UPDATEFLAG_HAS_SERVER_TIME          = 0x00000080,
    UPDATEFLAG_HAS_VEHICLE_CREATE       = 0x00000100,
    UPDATEFLAG_HAS_ANIMKITS_CREATE      = 0x00000200,
    UPDATEFLAG_HAS_ROTATION             = 0x00000400,
    UPDATEFLAG_HAS_AREATRIGGER          = 0x00000800,
    UPDATEFLAG_HAS_GAMEOBJECT           = 0x00001000,
    UPDATEFLAG_SMOOTH_PHASING           = 0x00002000,
    UPDATEFLAG_THIS_IS_YOU              = 0x00004000,
    UPDATEFLAG_SCENE_OBJECT             = 0x00008000,
    UPDATEFLAG_PLAYER_CREATE_INFO       = 0x00010000,
};

class UpdateData
{
    public:
        UpdateData() : m_map(0), m_blockCount(0) {}
        ...
        void Clear();
        void SetMap(uint32 p_MapId) { m_map = p_MapId; }
