...
enum Gossip_Option
{
    ...
    GOSSIP_OPTION_LEARNDUALSPEC         = 18,                   //UNIT_NPC_FLAG_TRAINER             (16) (bonus option for GOSSIP_OPTION_TRAINER) /// dosent exist anymore 7.0.3
    ...
    GOSSIP_OPTION_ARTIFACT_RESPEC       = 22,                   //UNIT_NPC_FLAG_ARTIFACT_POWER_RESPEC
    GOSSIP_OPTION_MAX
};
...
enum GossipOptionIcon
{
    ...
    GOSSIP_ICON_WORKORDER           = 28,                   ///< Scroll
    GOSSIP_ICON_ADVENTURE_MAP       = 31,
    GOSSIP_ICON_UNK_32              = 32,
    GOSSIP_ICON_UNK_33              = 33,
    GOSSIP_ICON_TRANSMOGRIFY        = 34,
    GOSSIP_ICON_MAX                                         ///< 7.3.5
};
...
class GossipMenu
{
    public:
        ...
        void AddMenuItem(int32 menuItemId, uint8 icon, uint32 p_BroadcastTextId, LocaleConstant p_Locale, uint32 sender, uint32 action, std::string const& boxMessage, uint32 boxMoney, bool coded = false);
