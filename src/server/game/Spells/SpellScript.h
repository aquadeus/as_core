...
enum SpellScriptHookType
{
    ...
    SPELL_SCRIPT_HOOK_TAKE_POWERS,
    SPELL_SCRIPT_HOOK_CALCULATE_THREAT,
    SPELL_SCRIPT_HOOK_INTERRUPT,
...
class SpellScript : public _SpellScript
{
    ...
    public:
        #define SPELLSCRIPT_FUNCTION_TYPE_DEFINES(CLASSNAME) \
            ...
            typedef void(CLASSNAME::*SpellTakePowersFnType)(Powers, int32&); \
            typedef void(CLASSNAME::*SpellCalculateThreatFnType)(Unit*, float&); \
            typedef void(CLASSNAME::*SpellInterruptFnType)(uint32); \
        ...
        class TakePowersHandler
        {
            public:
                TakePowersHandler(SpellTakePowersFnType takePowersHandlerScript);
                void Call(SpellScript* spellscript, Powers p_PowerType, int32& p_PowerCost);
            private:
                SpellTakePowersFnType _takePowersHandlerScript;
        };

        class CalculateThreatHandler
        {
            public:
                CalculateThreatHandler(SpellCalculateThreatFnType calculateThreatHandlerScript);
                void Call(SpellScript* spellscript, Unit* p_Target, float& p_Threat);
            private:
                SpellCalculateThreatFnType _calculateThreatHandlerScript;
        };

        class InterruptHandler
        {
            public:
                InterruptHandler(SpellInterruptFnType interruptHandlerScript);
                void Call(SpellScript* spellscript, uint32 p_Time);
            private:
                SpellInterruptFnType _interruptHandlerScript;
        };
        ...
        class TakePowersHandlerFunction             : public SpellScript::TakePowersHandler             { public: TakePowersHandlerFunction(SpellTakePowersFnType _takePowersHandlerScript)                                                                             : SpellScript::TakePowersHandler((SpellScript::SpellTakePowersFnType)_takePowersHandlerScript) {} }; \
        class CalculateThreatHandlerFunction        : public SpellScript::CalculateThreatHandler        { public: CalculateThreatHandlerFunction(SpellCalculateThreatFnType _calculateThreatHandlerScript)                                                              : SpellScript::CalculateThreatHandler((SpellScript::SpellCalculateThreatFnType)_calculateThreatHandlerScript) {} }; \
        class InterruptHandlerFunction              : public SpellScript::InterruptHandler              { public: InterruptHandlerFunction(SpellInterruptFnType _interruptHandlerScript)                                                                                : SpellScript::InterruptHandler((SpellScript::SpellInterruptFnType)_interruptHandlerScript) {} }; \
    ...
    public:
        ...
        bool IsInTakePowersHook() const;
        bool IsInCalculateThreatHook() const;
        bool IsInInterruptHook() const;
    ...
    public:
        ...
        // example: OnTakePowers += SpellTakePowersFn(Power);
        // where function is void function(Powers p_PowerType, int32& p_PowerCost)
        HookList<TakePowersHandler> OnTakePowers;
        #define  SpellTakePowersFn(F) TakePowersHandlerFunction(&F)

        // example: OnCalculateThreat += SpellCalculateThreatFn()
        // where function is void function(Unit* p_Target, float& p_Amount)
        HookList<CalculateThreatHandler> OnCalculateThreat;
        #define SpellCalculateThreatFn(F) CalculateThreatHandlerFunction(&F)

        // example: OnInterrupt += SpellInterruptFn()
        // where function is void function(uint32 p_Time)
        HookList<InterruptHandler> OnInterrupt;
        #define SpellInterruptFn(F) InterruptHandlerFunction(&F)
        ...
        // 4a. OnCheckCast - allows to override result of CheckCast function
        // 4b. OnTakePowers - allows to modify power cost (needs to be checked in OnCheckCast Too)
        ...
        // 15. OnCalculateThreat - executed just before the threat is added, therefore it can be modified in this hook
        // 16. OnInterrupt - exectuted when the spell is interrupted
        ...
        // you can determine if spell requires explicit targets by db2 columns:
        ...
        int32 GetHitDamage();
        int32 GetHitDamageForLeechEffect();
        int32 GetBaseHitDamage();
        int32 GetAbsorbedDamage();
        void SetHitDamage(int32 damage);
        void SetHitDamageForLeechEffect(int32 p_Damage);
...
enum AuraScriptHookType
{
    ...
    AURA_SCRIPT_HOOK_CALC_PPM,
    AURA_SCRIPT_HOOK_CALC_PROC_CHANCE,
...
class AuraScript : public _SpellScript
{
    ...
    #define AURASCRIPT_FUNCTION_TYPE_DEFINES(CLASSNAME) \
        ...
        typedef void(CLASSNAME::*AuraEffectSplitDamageFnType)(AuraEffect*, DamageInfo &, uint32 &); \
        ...
        typedef void(CLASSNAME::*AuraProcChanceFnType)(float&, ProcEventInfo &); \
        typedef void(CLASSNAME::*AuraProcPerMinuteFnType)(float&, ProcEventInfo &); \
        ...
        typedef bool(CLASSNAME::*AuraCanRefreshProcFnType)(bool); \
        ...
        {
            public:
                CalcMaxDurationHandler(AuraCalcMaxDurationFnType p_HandlerScript);
                void Call(AuraScript* p_AuraScript, int32& p_MaxDuration);
            private:
                AuraCalcMaxDurationFnType m_HandlerScript;
        };
        ...
        class EffectSplitDamageHandler : public EffectBase
        {
        public:
            EffectSplitDamageHandler(AuraEffectSplitDamageFnType _pEffectHandlerScript, uint8 _effIndex);
            void Call(AuraScript* auraScript, AuraEffect* aurEff, DamageInfo & dmgInfo, uint32 & splitAmount);
        private:
            AuraEffectSplitDamageFnType pEffectHandlerScript;
        };
        ...
        class AuraProcPerMinuteHandler
        {
            public:
                AuraProcPerMinuteHandler(AuraProcPerMinuteFnType p_HandlerScript);
                void Call(AuraScript* p_AuraScript, float & p_ProcPerMinute, ProcEventInfo & p_EventInfo);
            private:
                AuraProcPerMinuteFnType _HandlerScript;
        };
        class AuraProcChanceHandler
        {
            public:
                AuraProcChanceHandler(AuraProcChanceFnType p_HandleScript);
                void Call(AuraScript* p_AuraScript, float & p_Chance, ProcEventInfo & p_EventInfo);
            private:
                AuraProcChanceFnType _HandlerScript;
        };
        ...
        class CanRefreshProcHandler
        {
            public:
                ...
                bool Call(AuraScript* auraScript, bool p_Decrease);
            private:
...
#define AURASCRIPT_FUNCTION_CAST_DEFINES(CLASSNAME) \
        ...
        class CalcMaxDurationHandlerFunction : public AuraScript::CalcMaxDurationHandler { public: CalcMaxDurationHandlerFunction(AuraCalcMaxDurationFnType p_HandlerScript) : AuraScript::CalcMaxDurationHandler((AuraScript::AuraCalcMaxDurationFnType)p_HandlerScript) { } }; \
        ...
        class EffectSplitDamageFunction : public AuraScript::EffectSplitDamageHandler { public: EffectSplitDamageFunction(AuraEffectSplitDamageFnType _pEffectHandlerScript, uint8 _effIndex) : AuraScript::EffectSplitDamageHandler((AuraScript::AuraEffectSplitDamageFnType)_pEffectHandlerScript, _effIndex) {} }; \
        ...
        class AuraProcChanceFunction : public AuraScript::AuraProcChanceHandler { public: AuraProcChanceFunction(AuraProcChanceFnType _pEffectHandlerScript) : AuraScript::AuraProcChanceHandler((AuraScript::AuraProcChanceFnType)_pEffectHandlerScript) {} }; \
        class AuraProcPerMinuteFunction : public AuraScript::AuraProcPerMinuteHandler { public: AuraProcPerMinuteFunction(AuraProcPerMinuteFnType p_HandlerScript) : AuraScript::AuraProcPerMinuteHandler((AuraScript::AuraProcPerMinuteFnType)p_HandlerScript) {} }; \
    ...
    public:
        ...
        /// Executed when aura calculates duration
        /// Example: DoCalcMaxDuration += AuraCalcMaxDurationFn(class::function);
        /// Where function is: void function (int32& p_MaxDuration);
        ...
        // example: AfterEffectAbsorb += AuraEffectAbsorbFn(class::function, EffectIndexSpecifier, EffectAuraNameSpecifier);
        // where function is: void function (AuraEffect* aurEff, DamageInfo& dmgInfo, uint32& absorbAmount);
        ...
        // executed when split damage aura effect is going to reduce damage
        // example: OnEffectSplitDamage += AuraEffectSplitDamageFn(class::function, EffectIndexSpecifier);
        // where function is: void function (AuraEffect* aurEff, DamageInfo& dmgInfo, uint32& splitAmount);
        HookList<EffectSplitDamageHandler> OnEffectSplitDamage;
        #define AuraEffectSplitDamageFn(F, I) EffectSplitDamageFunction(&F, I)
        ...
        // executed when the proc per minute of aura is calculated
        // example: DoCalcPPM += AuraProcPerMinuteFn(class::function);
        // where function is void function (float & p_PPM, ProcEventInfo& p_EventInfo);
        HookList<AuraProcPerMinuteHandler> DoCalcPPM;
        #define AuraProcPerMinuteFn(F) AuraProcPerMinuteFunction(&F)

        // executed when the proc chance of aura is calculated
        // example: DoProcCalcChance += AuraCheckEffectProcFn(class::function);
        // where function is void function (float & p_Chance, ProcEventInfo& p_EventInfo);
        HookList<AuraProcChanceHandler> DoCalcProcChance;
        #define AuraProcChanceFn(F) AuraProcChanceFunction(&F)
        ...
        /// Real Healing Done after Calculation in HandlePeriodicHeal for the last tick (only to be used in AfterEffectPeriodic Hook)
        uint32 GetPeriodicHealDone() const;
